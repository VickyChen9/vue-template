...
(function () {
  window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function () {
    var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
      ...
      basePath: function () {
        ...
        if (!c) for (var b = document.getElementsByTagName("script"), d = 0; d < b.length; d++) {
        ...
        define: function (c, b) {
          ...
          function h(f, a, e, h) {
            f = {
              ...
              data: a, listenerData: k, stop: e, cancel: h, removeListener: m
            };
          ...
          if (0 > f.getListenerIndex(b)) {
            ...
            h.fn = b;
            h.priority = e;
            for (var p = f.length - 1; 0 <= p; p--) if (f[p].priority <= e) return f.splice(p + 1, 0, h), {removeListener: m};
            f.unshift(h)
          }
          ...
          return function (e, h, m) {
            ...
            if (f) {
              var p = f.listeners;
              if (p.length) for (var p = p.slice(0), q, v = 0; v < p.length; v++) {
                if (f.errorProof) try {
                  q = p[v].call(this, m, h, b, k)
                } catch (w) {
                } else q = p[v].call(this, m, h, b, k);
                !1 === q ? l = 1 : "undefined" != typeof q && (h = q);
                if (a || l) break
              }
            }
            h =
    ...
    b.webkit && (-1 < a.indexOf("chrome") ? b.chrome =
      !0 : b.safari = !0);
    var c = 0;
    ...
    (function () {
      CKEDITOR.domReady(function () {
        ...
        a && (CKEDITOR.status =
          "basic_ready", a && a._load ? a() : d && setTimeout(function () {
    ...
    var a = [], d = CKEDITOR.env.gecko ?
      "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, g = /</g,
      l = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
      e = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, h = function (a, f) {
        return "#" == f[0] ? String.fromCharCode(parseInt(f.slice(1), 10)) : e[f]
      };
    ...
    CKEDITOR.tools = {
      ...
      getIndex: function (a, f) {
        for (var e =
          0; e < a.length; ++e) if (f(a[e])) return e;
        return -1
      },
      clone: function (a) {
        var f;
        if (a && a instanceof Array) {
          f = [];
          for (var e = 0; e < a.length; e++) f[e] = CKEDITOR.tools.clone(a[e]);
          return f
        }
      ...
      extend: function (a) {
        var f = arguments.length, e, b;
        "boolean" == typeof(e = arguments[f - 1]) ? f-- : "boolean" == typeof(e = arguments[f - 2]) && (b = arguments[f - 1], f -= 2);
        for (var h = 1; h < f; h++) {
          var c = arguments[h], g;
          for (g in c) if (!0 === e || null == a[g]) if (!b || g in b) a[g] = c[g]
        }
        return a
      },
      ...
      buildStyleHtml: function (a) {
        a = [].concat(a);
        for (var f, e = [], b = 0; b < a.length; b++) if (f = a[b]) /@import|[{}]/.test(f) ? e.push("\x3cstyle\x3e" +
          f + "\x3c/style\x3e") : e.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + f + '"\x3e');
        return e.join("")
      },
      htmlEncode: function (a) {
        return void 0 === a || null === a ? "" : String(a).replace(b, "\x26amp;").replace(c, "\x26gt;").replace(g, "\x26lt;")
      },
      ...
      transformPlainTextToHtml: function (a, f) {
        ...
        if (!e) {
          var c = /\n{2}/g;
          if (c.test(b)) var g = "\x3c" + h + "\x3e", d = "\x3c/" + h + "\x3e", b = g + b.replace(c, function () {
            return d + g
          }) + d
        }
        b = b.replace(/\n/g, "\x3cbr\x3e");
        e || (b = b.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + h + "\x3e)"), function (f) {
          return CKEDITOR.tools.repeat(f, 2)
        }));
        b = b.replace(/^ | $/g, "\x26nbsp;");
        return b = b.replace(/(>|\s) /g, function (f, a) {
          return a + "\x26nbsp;"
        }).replace(/ (?=<)/g,
          "\x26nbsp;")
      },
      ...
      throttle: function (a, f, e) {
        ...
        return {
          input: function () {
            ...
            var d = (new Date).getTime() - h;
            d < a ? b = setTimeout(c, a - d) : c()
          }, reset: function () {
            b && (clearTimeout(b), b = h = 0)
          }
        }
      },
      trim: function () {
      ...
      indexOf: function (a,
                         f) {
        if ("function" == typeof f) for (var e = 0, b = a.length; e < b; e++) {
          if (f(a[e])) return e
        } else {
      ...
      createClass: function (a) {
        var f = a.$, e = a.base, b = a.privates || a._, h = a.proto;
        a = a.statics;
        !f && (f = function () {
          e && this.base.apply(this, arguments)
        });
        if (b) var c = f, f = function () {
          var f = this._ || (this._ =
            {}), a;
          for (a in b) {
            var e = b[a];
            f[a] = "function" == typeof e ? CKEDITOR.tools.bind(e, this) : e
          }
      ...
      normalizeCssText: function (a, f) {
        var e = [], b, h = CKEDITOR.tools.parseCssText(a, !0, f);
        for (b in h) e.push(b + ":" + h[b]);
        e.sort();
        return e.length ? e.join(";") + ";" : ""
      },
      convertRgbToHex: function (a) {
        return a.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi, function (f, a, e, b) {
          f = [a, e, b];
      ...
      normalizeHex: function (a) {
        return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi, function (f, a, e, b) {
          f = a.toLowerCase();
          3 == f.length && (f = f.split(""), f = [f[0], f[0], f[1], f[1], f[2], f[2]].join(""));
          return "#" + f + b
        })
      },
      parseCssText: function (a, f, e) {
        ...
        if (!a || ";" == a) return b;
        a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, e, h) {
          f && (e = e.toLowerCase(), "font-family" == e && (h = h.replace(/\s*,\s*/g, ",")), h = CKEDITOR.tools.trim(h));
          b[e] = h
        });
        return b
      },
      ...
      enableHtml5Elements: function (a, f) {
        for (var e = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), b = e.length, h; b--;) h = a.createElement(e[b]), f && a.appendChild(h)
      },
      checkIfAnyArrayItemMatches: function (a,
                                            f) {
        for (var e = 0, b = a.length; e < b; ++e) if (a[e].match(f)) return !0;
        return !1
      },
      ...
      keystrokeToArray: function (a, f) {
        var e = f & 16711680, b = f & 65535, h = CKEDITOR.env.mac, c = [], g = [];
        e & CKEDITOR.CTRL && (c.push(h ? "⌘" : a[17]), g.push(h ? a[224] : a[17]));
        e & CKEDITOR.ALT && (c.push(h ? "⌥" : a[18]), g.push(a[18]));
        e & CKEDITOR.SHIFT &&
        (c.push(h ? "⇧" : a[16]), g.push(a[16]));
      ...
      getCookie: function (a) {
        a = a.toLowerCase();
        for (var f = document.cookie.split(";"), e, b, h = 0; h < f.length; h++) if (e = f[h].split("\x3d"), b = decodeURIComponent(CKEDITOR.tools.trim(e[0]).toLowerCase()), b === a) return decodeURIComponent(1 < e.length ?
          e[1] : "");
        return null
      },
      ...
      getCsrfToken: function () {
        ...
        if (!a || 40 != a.length) {
          ...
          for (e = 0; e < a.length; e++) var b = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[e] % 36), f = f + (.5 < Math.random() ?
            b.toUpperCase() : b);
          a = f;
      ...
      getMouseButton: function (a) {
        var f = (a = a.data) && a.$;
        return a && f ? CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? 4 === f.button ? CKEDITOR.MOUSE_BUTTON_MIDDLE : 1 === f.button ? CKEDITOR.MOUSE_BUTTON_LEFT : CKEDITOR.MOUSE_BUTTON_RIGHT : f.button : !1
      },
      ...
      convertBytesToBase64: function (a) {
        var f = "", e = a.length, b;
        for (b = 0; b < e; b += 3) {
          var h = a.slice(b, b + 3), c = h.length, g = [], d;
          if (3 > c) for (d = c; 3 > d; d++) h[d] = 0;
          g[0] = (h[0] & 252) >> 2;
          g[1] = (h[0] & 3) << 4 | h[1] >> 4;
          g[2] = (h[1] & 15) << 2 | (h[2] & 192) >> 6;
          g[3] = h[2] & 63;
          for (d = 0; 4 > d; d++) f = d <= c ? f + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(g[d]) : f + "\x3d"
        }
        return f
      },
      style: {
        parse: {
          ...
          background: function (a) {
            var f = {}, e = this._findColor(a);
            e.length && (f.color = e[0], CKEDITOR.tools.array.forEach(e, function (f) {
              a = a.replace(f, "")
            }));
          ...
          margin: function (a) {
            ...
            var e = {}, b = a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset)/g) || ["0px"];
            switch (b.length) {
              case 1:
                f([0, 0, 0, 0]);
                break;
          ...
          border: function (a) {
            ...
            CKEDITOR.tools.array.forEach(e, function (a) {
              f.style || -1 === CKEDITOR.tools.indexOf(CKEDITOR.tools.style.parse._borderStyle, a) ? !f.width && CKEDITOR.tools.style.parse._widthRegExp.test(a) && (f.width = a) : f.style = a
            });
            return f
          },
          _findColor: function (a) {
            var f = [], e = CKEDITOR.tools.array, f = f.concat(a.match(this._rgbaRegExp) || []),
              f = f.concat(a.match(this._hslaRegExp) ||
                []);
            return f = f.concat(e.filter(a.split(/\s+/), function (a) {
      ...
      array: {
        filter: function (a, f, e) {
          ...
          for (var b = [], h = 0; h < a.length; h++) b.push(f.call(e, a[h], h, a));
          return b
        }, reduce: function (a, f, e, b) {
          for (var h = 0; h < a.length; h++) e = f.call(b,
            e, a[h], h, a);
          return e
      ...
      object: {
        findKey: function (a, f) {
          ...
          var e = CKEDITOR.tools, b = e.clone(a), h = e.clone(f);
          e.array.forEach(e.objectKeys(h), function (a) {
            b[a] = "object" === typeof h[a] && "object" === typeof b[a] ? e.object.merge(b[a], h[a]) : h[a]
          });
          return b
        }
      },
    ...
    var a = CKEDITOR.tools.extend, d = function (a, f) {
        ...
        table: 1,
        ul: 1
      }, l = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, e = {"#": 1},
    ...
    3, CKEDITOR.dom.domObject = function (a) {
    a && (this.$ = a)
    ...
    return {
      getPrivate: function () {
        ...
        b[d] || (b = b[d] = a(this, d), this.$.addEventListener ? this.$.addEventListener(d, b,
          !!CKEDITOR.event.useCapture) : this.$.attachEvent && this.$.attachEvent("on" + d, b));
    ...
    a.removeCustomData = function (a) {
      var c = this.$["data-cke-expando"], c = c && d[c], g, l;
    ...
    appendTo: function (a, d) {
      ...
      function c(b) {
        if (b.type ==
          CKEDITOR.NODE_ELEMENT || b.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
    ...
    getIndex: function (a) {
      function d(a, e) {
        var h = e ? a.nextSibling : a.previousSibling;
        return h && h.nodeType == CKEDITOR.NODE_TEXT ? b(h) ? d(h, e) : h : null
      }
      ...
      for (; d;) {
        ...
        if (d.hasAttribute("contenteditable")) return "false" ==
    ...
    appendStyleSheet: function (a) {
      ...
      for (var b = this.$.documentElement, c = 0; b && c < a.length; c++) {
        var g = a[c];
        if (d) for (var l =
          -1, k = 0; k < b.childNodes.length; k++) {
          var e = b.childNodes[k];
          if (!0 !== d || 3 != e.nodeType || !e.previousSibling || 3 != e.previousSibling.nodeType) if (l++, l == g) {
            b = e;
            break
          }
  ...
  }, CKEDITOR.dom.element.prototype = new CKEDITOR.dom.node, CKEDITOR.dom.element.createFromHtml = function (a,
                                                                                                             d) {
    ...
    for (var d in a) CKEDITOR.dom.element.clearMarkers(a,
      a[d], 1)
  }, CKEDITOR.dom.element.clearMarkers = function (a, d, b) {
    var c = d.getCustomData("list_marker_names"), g = d.getCustomData("list_marker_id"), l;
    ...
    var g = document.createElement("_").classList,
      g = "undefined" !== typeof g && null !== String(g.add).match(/\[Native code\]/gi), l = /[\n\t\r]/g;
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      type: CKEDITOR.NODE_ELEMENT, addClass: g ? function (a) {
        ...
        b && a(b, e) && ((b = b.replace(new RegExp("(?:^|\\s+)" + e + "(?\x3d\\s|$)"), "").replace(/^\s+/, "")) ? this.setAttribute("class", b) : this.removeAttribute("class"));
        return this
      }, hasClass: function (e) {
        ...
        c.setEndAfter(a);
        var f = c.extractContents(!1, b || !1), g;
        c.insertNode(this.remove());
        if (CKEDITOR.env.ie && !CKEDITOR.env.edge) {
          for (c = new CKEDITOR.dom.element("div"); g = f.getFirst();) g.$.style.backgroundColor && (g.$.style.backgroundColor = g.$.style.backgroundColor), c.append(g);
          c.insertAfter(this);
          c.remove(!0)
      ...
      getComputedStyle: document.defaultView && document.defaultView.getComputedStyle ? function (a) {
        ...
        var a = this.$.tabIndex;
        return 0 !== a || CKEDITOR.dtd.$tabIndex[this.getName()] ||
      ...
      getFirst: function (a) {
        ...
        for (var a = this.getChildren(), b = 0, c = a.count(); b < c; b++) {
          var f = a.getItem(b);
          if (f.type != CKEDITOR.NODE_ELEMENT || !f.data("cke-bookmark")) if (f.type ==
      ...
      hide: function () {
        ...
        function a(b, e, f) {
          if (e && e.type == CKEDITOR.NODE_ELEMENT) {
            for (var c = []; e.data("cke-bookmark") || e.isEmptyInlineRemoveable();) if (c.push(e), e = f ? e.getNext() : e.getPrevious(), !e || e.type != CKEDITOR.NODE_ELEMENT) return;
            if (b.isIdentical(e)) {
              for (var g =
                f ? b.getLast() : b.getFirst(); c.length;) c.shift().move(b, !f);
              e.moveChildren(b, !f);
              e.remove();
        ...
        return CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks) ? function (b,
                                                                                              c) {
        ...
        if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
          ...
          for (var b = [], g = 0; g < c.length; g++) if (f) for (var d = 0; d < f.length; d++) b.push([a, c[g], f[d]].join("-")); else b.push([a, c[g]].join("-"));
        ...
        var b = 0, c = 0, f = this.getDocument(), g = f.getBody(), d = "BackCompat" == f.$.compatMode;
        if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version : 1)) {
          var k = this.$.getBoundingClientRect(),
            l = f.$.documentElement, w = l.clientTop || g.$.clientTop || 0, r = l.clientLeft || g.$.clientLeft || 0,
            u = !0;
          CKEDITOR.env.ie && (u = f.getDocumentElement().contains(this), f = f.getBody().contains(this), u = d && f || !d && u);
          u && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = g.$.scrollLeft || l.scrollLeft, c = g.$.scrollTop || l.scrollTop) : (c = d ? g.$ : l, b = c.scrollLeft, c = c.scrollTop), b = k.left + b - r, c = k.top + c - w)
        } else for (w = this, r = null; w && "body" != w.getName() && "html" != w.getName();) {
          b += w.$.offsetLeft - w.$.scrollLeft;
          c += w.$.offsetTop -
            w.$.scrollTop;
          w.equals(this) || (b += w.$.clientLeft || 0, c += w.$.clientTop || 0);
          for (; r && !r.equals(w);) b -= r.$.scrollLeft, c -= r.$.scrollTop, r = r.getParent();
          r = w;
          w = (k = w.$.offsetParent) ? new CKEDITOR.dom.element(k) : null
        }
        a && (k = this.getWindow(), w = a.getWindow(), !k.equals(w) && k.$.frameElement && (a = (new CKEDITOR.dom.element(k.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
        document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko || d || (b += this.$.clientLeft ? 1 : 0, c += this.$.clientTop ? 1 : 0);
        return {x: b, y: c}
      },
      scrollIntoView: function (a) {
        ...
        function l(f, b) {
          /body|html/.test(a.getName()) ? a.getWindow().$.scrollBy(f, b) : (a.$.scrollLeft += f, a.$.scrollTop += b)
        }
        ...
        function w(a, f) {
          ...
          c = a.getWindow();
          c.equals(f) || (c = w(CKEDITOR.dom.element.get(c.$.frameElement), f), b.x += c.x, b.y += c.y);
          return b
        }
        ...
        d = a.getWindow();
        g = w(this, d);
        var t = w(a, d), A = this.$.offsetHeight;
        f = this.$.offsetWidth;
        var x = a.$.clientHeight, z = a.$.clientWidth;
        d = g.x - r(this, "left") - t.x || 0;
        k = g.y - r(this, "top") - t.y || 0;
        f = g.x + f + r(this, "right") - (t.x + z) || 0;
        g = g.y + A + r(this, "bottom") - (t.y + x) || 0;
        ...
        for (var f = 0; f < c.length; f++) {
          var g = c[f], d = g.nodeName.toLowerCase(), k;
          if (!(d in b)) if ("checked" == d && (k = this.getAttribute(d))) a.setAttribute(d, k); else if (!CKEDITOR.env.ie || this.hasAttribute(d)) k = this.getAttribute(d), null === k && (k = g.nodeValue), a.setAttribute(d, k)
        }
      ...
      disableContextMenu: function () {
        ...
        var b = CKEDITOR.instances, c, f, g;
        a = a || void 0 === a;
        for (c in b) if (f = b[c], f.element.equals(this) && f.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO || !a && (g = f.editable()) && (g.equals(this) || g.contains(this))) return f;
        return null
      }, find: function (a) {
        var c = d(this);
        ...
        c();
        return a ? new CKEDITOR.dom.element(a) :
          null
      }, forEach: function (a, b, c) {
        if (!(c || b && this.type != b)) var f = a(this);
        if (!1 !== f) {
          c = this.getChildren();
          for (var g = 0; g < c.count(); g++) f = c.getItem(g), f.type == CKEDITOR.NODE_ELEMENT ? f.forEach(a, b) : b && f.type != b || a(f)
        }
      }
    });
    var k = {
    ...
    CKEDITOR.dom.element.prototype.setSize = function (a, b, g) {
      "number" == typeof b && (!g || CKEDITOR.env.ie && CKEDITOR.env.quirks || (b -=
    ...
    function a(a,
      ...
      var c, e = f.startContainer;
      c = f.endContainer;
      var g = f.startOffset, h = f.endOffset, d, m = this.guard, n = this.type,
      ...
      if (!a && !this._.guardLTR) {
        ...
        this._.guardLTR = function (a, b) {
          return (!b || !l.equals(a)) && (!B || !a.equals(B)) && (a.type !=
      ...
      if (a && !this._.guardRTL) {
        ...
        this._.guardRTL = function (a, b) {
          return (!b || !G.equals(a)) && (!D || !a.equals(D)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(f.root))
        }
      }
      var F = a ? this._.guardRTL : this._.guardLTR;
      d = m ? function (a, b) {
        return !1 === F(a, b) ? !1 : m(a, b)
      } : F;
      this.current ? c = this.current[k](!1, n, d) : (a ? c.type == CKEDITOR.NODE_ELEMENT && (c = 0 < h ? c.getChild(h -
        1) : !1 === d(c, !0) ? null : c.getPreviousSourceNode(!0, n, d)) : (c = e, c.type == CKEDITOR.NODE_ELEMENT && ((c = c.getChild(g)) || (c = !1 === d(e, !0) ? null : e.getNextSourceNode(!0, n, d)))), c && !1 === d(c) && (c = null));
      for (; c && !this._.end;) {
        this.current = c;
    ...
    CKEDITOR.dom.walker.bookmark = function (a, b) {
      ...
      return function (c) {
        var e, g;
        e = c && c.type != CKEDITOR.NODE_ELEMENT && (g = c.getParent()) && f(g);
        e = a ? e : e || f(c);
        return !!(b ^ e)
      }
    };
    ...
    CKEDITOR.dom.walker.invisible =
      function (a) {
        var b = CKEDITOR.dom.walker.whitespaces(), f = CKEDITOR.env.webkit ? 1 : 0;
        return function (c) {
    ...
    CKEDITOR.dom.walker.bogus = function (a) {
      ...
      return function (f) {
        var c = CKEDITOR.env.needsBrFiller ? f.is && f.is("br") : f.getText && g.test(f.getText());
        c && (c = f.getParent(), f = f.getNext(b), c = c.isBlockBoundary() &&
          (!f || f.type == CKEDITOR.NODE_ELEMENT && f.isBlockBoundary()));
        return !!(a ^ c)
      }
    };
    CKEDITOR.dom.walker.temp = function (a) {
      return function (f) {
        ...
        f = f && f.hasAttribute("data-cke-temp");
        return !!(a ^ f)
      }
    };
    var g = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, l = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(),
      e = CKEDITOR.dom.walker.temp(), h = function (a) {
    ...
    CKEDITOR.dom.walker.empty = function (a) {
      return function (f) {
        for (var b = 0, c = f.getChildCount(); b < c; ++b) if (!m(f.getChild(b))) return !!a;
        return !a
      }
    };
    var f = CKEDITOR.dom.walker.empty(),
      n = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) {
        var f = {}, b;
        for (b in a) CKEDITOR.dtd[b]["#"] && (f[b] = 1);
        return f
      }(CKEDITOR.dtd.$block), {caption: 1, td: 1, th: 1});
    CKEDITOR.dom.walker.editable = function (a) {
      return function (b) {
        b =
          m(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(n) && f(b)) ? !0 : !1;
        return !!(a ^ b)
      }
    };
    ...
    function d(a, b, c, e, g) {
      function d(a, b, f, c) {
        ...
        if (c && k) return e;
        x || c ? b.append(a.clone(!0, g), f) : (a.remove(), l && b.append(a, f));
        return e
      }

      function h() {
        var a, b, f, c = Math.min(K.length, E.length);
        for (a = 0; a < c; a++) if (b =
          K[a], f = E[a], !b.equals(f)) return a;
        return a - 1
      }

      function m() {
        var b = R - 1, c = F && I && !z.equals(C);
      ...
      a.optimizeBookmark();
      var k = 0 === b, l = 1 == b, x = 2 == b;
      b = x || l;
      var z = a.startContainer, C = a.endContainer, y = a.startOffset, B = a.endOffset, G, D, F, I, H, J;
      if (x && C.type == CKEDITOR.NODE_TEXT && (z.equals(C) || z.type === CKEDITOR.NODE_ELEMENT && z.getFirst().equals(C))) c.append(a.document.createText(C.substring(y, B))); else {
        C.type == CKEDITOR.NODE_TEXT ? x ? J = !0 : C = C.split(B) : 0 < C.getChildCount() ? B >= C.getChildCount() ? (C = C.getChild(B - 1), D = !0) : C = C.getChild(B) : I = D = !0;
        z.type == CKEDITOR.NODE_TEXT ? x ? H = !0 : z.split(y) : 0 < z.getChildCount() ?
          0 === y ? (z = z.getChild(y), G = !0) : z = z.getChild(y - 1) : F = G = !0;
        for (var K = z.getParents(), E = C.getParents(), R = h(), O = K.length - 1, S = E.length - 1, L = c, V, Z, X, da = -1, P = R; P <= O; P++) {
          Z = K[P];
          X = Z.getNext();
          for (P != O || Z.equals(E[P]) && O < S ? b && (V = L.append(Z.clone(0, g))) : G ? d(Z, L, !1, F) : H && L.append(a.document.createText(Z.substring(y))); X;) {
            if (X.equals(E[P])) {
              da = P;
              break
            }
        ...
        L = c;
        for (P = R; P <= S; P++) if (c = E[P], X = c.getPrevious(), c.equals(K[P])) b && (L = L.getChild(0)); else {
          P != S || c.equals(K[P]) && S < O ? b && (V = L.append(c.clone(0, g))) : D ? d(c,
            L, !1, I) : J && L.append(a.document.createText(c.substring(0, B)));
          if (P > da) for (; X;) X = d(X, L, !0);
          L = V
        }
        x || m()
      }
    ...
    function b() {
      ...
      return function (g) {
        return c(g) || b(g) ? !0 : e(g) && !a ? a = !0 : g.type == CKEDITOR.NODE_TEXT && (g.hasAscendant("pre") || CKEDITOR.tools.trim(g.getText()).length) || g.type == CKEDITOR.NODE_ELEMENT && !g.is(l) ? !1 : !0
      }
    }
    ...
    function c(a) {
      ...
      return function (e) {
        return c(e) || b(e) ? !0 : !a && k(e) || e.type == CKEDITOR.NODE_ELEMENT && e.is(CKEDITOR.dtd.$removeEmpty)
      }
    }
    ...
    var l = {
        ...
        u: 1,
        "var": 1
      }, k = CKEDITOR.dom.walker.bogus(), e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
      h = CKEDITOR.dom.walker.editable(), m = CKEDITOR.dom.walker.ignored(!0);
    CKEDITOR.dom.range.prototype = {
      clone: function () {
        ...
        function a(b) {
          ...
          if (f.type == CKEDITOR.NODE_ELEMENT && 0 < e) {
            a:{
              for (g = f; e--;) if (d = g.getChild(e).getIndex(!0), 0 <= d) {
                e = d;
                break a
              }
              e = -1
          ...
          if (f.type == CKEDITOR.NODE_TEXT) {
            g = f;
            for (d = 0; (g = g.getPrevious()) && g.type == CKEDITOR.NODE_TEXT;) d += g.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length;
            g = d;
        ...
        return function (c) {
          ...
          return {
            ...
            end: e ? null : d.container.getAddress(c),
        ...
        if (a.type == CKEDITOR.NODE_ELEMENT) if (g = a.getChildCount(), g > c) a = a.getChild(c); else if (1 > g) a = a.getPreviousSourceNode(); else {
          for (a = a.$; a.lastChild;) a = a.lastChild;
          a = new CKEDITOR.dom.node(a);
          a =
            a.getNextSourceNode() || a
        }
        if (b.type == CKEDITOR.NODE_ELEMENT) if (g = b.getChildCount(), g > e) b = b.getChild(e).getPreviousSourceNode(!0); else if (1 > g) b = b.getPreviousSourceNode(); else {
        ...
        var c = this.startContainer, e = this.endContainer,
        ...
        if ((!a || g) && c && c.type == CKEDITOR.NODE_TEXT) {
          if (e) if (e >= c.getLength()) e = c.getIndex() + 1, c = c.getParent(); else {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            var h = this.getCommonAncestor(), m = this.root, k, l, x, z, C, y = !1, B, G;
            B = this.startContainer;
            var D = this.startOffset;
            B.type == CKEDITOR.NODE_TEXT ? (D && (B = !CKEDITOR.tools.trim(B.substring(0, D)).length &&
              B, y = !!B), B && ((z = B.getPrevious()) || (x = B.getParent()))) : (D && (z = B.getChild(D - 1) || B.getLast()), z || (x = B));
            for (x = c(x); x || z;) {
              if (x && !z) {
                !C && x.equals(h) && (C = !0);
                if (g ? x.isBlockBoundary() : !m.contains(x)) break;
                y && "inline" == x.getComputedStyle("display") || (y = !1, C ? k = x : this.setStartBefore(x));
                z = x.getPrevious()
              }
              for (; z;) if (B = !1, z.type == CKEDITOR.NODE_COMMENT) z = z.getPrevious(); else {
                if (z.type == CKEDITOR.NODE_TEXT) G = z.getText(), e.test(G) && (z = null), B = /[\s\ufeff]$/.test(G); else if ((z.$.offsetWidth > (CKEDITOR.env.webkit ? 1 :
                  0) || b && z.is("br")) && !z.data("cke-bookmark")) if (y && CKEDITOR.dtd.$removeEmpty[z.getName()]) {
                  G = z.getText();
                  if (e.test(G)) z = null; else for (var D = z.$.getElementsByTagName("*"), F = 0, I; I = D[F++];) if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                    z = null;
                    break
                  }
                  z && (B = !!G.length)
                } else z = null;
                B && (y ? C ? k = x : x && this.setStartBefore(x) : y = !0);
                if (z) {
                  B = z.getPrevious();
                  if (!x && !B) {
                    x = z;
            ...
            B.type == CKEDITOR.NODE_TEXT ?
              CKEDITOR.tools.trim(B.substring(D)).length ? y = !0 : (y = !B.getLength(), D == B.getLength() ? (z = B.getNext()) || (x = B.getParent()) : d(B, D) && (x = B.getParent())) : (z = B.getChild(D)) || (x = B);
            for (; x || z;) {
              if (x && !z) {
                !C && x.equals(h) && (C = !0);
                if (g ? x.isBlockBoundary() : !m.contains(x)) break;
                y && "inline" == x.getComputedStyle("display") || (y = !1, C ? l = x : x && this.setEndAfter(x));
                z = x.getNext()
              }
              for (; z;) {
                B = !1;
                if (z.type == CKEDITOR.NODE_TEXT) G = z.getText(), d(z, 0) || (z = null), B = /^[\s\ufeff]/.test(G); else if (z.type == CKEDITOR.NODE_ELEMENT) {
                  if ((0 < z.$.offsetWidth ||
                    b && z.is("br")) && !z.data("cke-bookmark")) if (y && CKEDITOR.dtd.$removeEmpty[z.getName()]) {
                    G = z.getText();
                    if (e.test(G)) z = null; else for (D = z.$.getElementsByTagName("*"), F = 0; I = D[F++];) if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                      z = null;
                      break
                    }
                    z && (B = !!G.length)
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var H, J, K = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
              E = null, R = function (a) {
                if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (E) {
                  if (E.equals(a)) {
                    E = null;
                    return
                  }
                } else E = a; else if (E) return;
                var b = K(a);
                b || (H = a);
                return b
              }, g = function (a) {
            ...
            if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
              x = this.clone();
              x = new CKEDITOR.dom.walker(x);
              var O = CKEDITOR.dom.walker.whitespaces(), S = CKEDITOR.dom.walker.bookmark();
              x.evaluator = function (a) {
                return !O(a) && !S(a)
              };
              if ((x = x.previous()) && x.type == CKEDITOR.NODE_ELEMENT && x.is("br")) break
            }
            x = this.clone();
            x.collapse();
            x.setEndAt(m,
        ...
        if (!this.collapsed) {
          ...
          var d = this.clone(), h =
            this.startContainer, m = this.endContainer, k = this.startOffset, l = this.endOffset, x = c = 1;
          ...
          var d = new CKEDITOR.dom.walker(d), z = CKEDITOR.dom.walker.bookmark(), C = CKEDITOR.dom.walker.bogus();
          d.evaluator = function (b) {
            return b.type == (a == CKEDITOR.SHRINK_ELEMENT ? CKEDITOR.NODE_ELEMENT : CKEDITOR.NODE_TEXT)
          };
          var y;
          d.guard = function (b, c) {
            if (g && C(b) || z(b)) return !0;
            if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || c && b.equals(y) || !1 === e && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return !1;
        ...
        var c = this.extractContents(!1, b || !1), e = a.clone(!1, b || !1);
        c.appendTo(e);
        e.insertAfter(a);
        ...
        var b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.dom.walker.bookmark(!1);
        return function (b) {
          for (var c = this.createBookmark(), e = this[b ? "endPath" : "startPath"](), g = e.block || e.blockLimit, d; g && !g.equals(e.root) && !g.getFirst(a(g));) d = g.getParent(), this[b ? "setEndAt" : "setStartAt"](g, CKEDITOR.POSITION_AFTER_END), g.remove(1), g = d;
          this.moveToBookmark(c)
        }
      }(), startPath: function () {
        ...
        var e = b == CKEDITOR.START, g = this.clone();
        g.collapse(e);
        ...
        for (var c = 0; a;) {
          if (a.type == CKEDITOR.NODE_TEXT) {
            b && this.endContainer && this.checkEndOfBlock() && e.test(a.getText()) ? this.moveToPosition(a, CKEDITOR.POSITION_BEFORE_START) : this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START);
            c = 1;
            break
          }
          if (a.type == CKEDITOR.NODE_ELEMENT) if (a.isEditable()) this.moveToPosition(a, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_START), c = 1; else if (b && a.is("br") && this.endContainer &&
            this.checkEndOfBlock()) this.moveToPosition(a, CKEDITOR.POSITION_BEFORE_START); else if ("false" == a.getAttribute("contenteditable") && a.is(CKEDITOR.dtd.$block)) return this.setStartBefore(a), this.setEndAfter(a), !0;
          var g = a, d = c, h = void 0;
      ...
      }, getNextEditableNode: g(), getPreviousEditableNode: g(1), _getTableElement: function (a) {
        a = a || {td: 1, th: 1, tr: 1, tbody: 1, thead: 1, tfoot: 1, table: 1};
        var b = this.startContainer, c =
          this.endContainer, e = b.getAscendant("table", !0), g = c.getAscendant("table", !0);
        ...
        function a(b, c) {
          var f = CKEDITOR.tools.array.map(b, function (a) {
            return a
          }), e = new CKEDITOR.dom.range(c.root), g, d, h;
          c.startContainer instanceof CKEDITOR.dom.element && (d = 0 === c.startOffset && c.startContainer.hasAttribute("data-widget"));
          c.endContainer instanceof CKEDITOR.dom.element && (h = (h = c.endOffset === (c.endContainer.getChildCount ?
            c.endContainer.getChildCount() : c.endContainer.length)) && c.endContainer.hasAttribute("data-widget"));
          d && e.setStart(c.startContainer.getParent(), c.startContainer.getIndex());
          ...
          if (e = CKEDITOR.tools.array.map(e, function (a) {
            ...
            CKEDITOR.tools.array.map(e, function (a) {
              var b;
            ...
            function b(e) {
              CKEDITOR.tools.array.forEach(f, function (b, g) {
                var d = CKEDITOR.tools.objectCompare(a[e], b);
                d || (d = CKEDITOR.tools.objectCompare(a.widgetRect, b));
                d && (Array.prototype.splice.call(f,
                  g, a.length - e, a.widgetRect), c = !0)
              });
        ...
        function c(a, b, f) {
          ...
          b && (a = CKEDITOR.tools.getAbsoluteRectPosition(f.document.getWindow(), a));
        ...
        return void 0 !== this.document.getSelection ? function (e) {
          var g = this.root.getDocument().$.createRange(), d;
          g.setStart(this.startContainer.$, this.startOffset);
          g.setEnd(this.endContainer.$, this.endOffset);
          d = g.getClientRects();
          d = a(d, this);
          d.length || (d = b(d, g, this));
          return CKEDITOR.tools.array.map(d, function (a) {
            return c(a, e, this)
          }, this)
        } : function (a) {
        ...
        var c = this.getCommonAncestor(), e = this.getBoundaryNodes(), g = [], d, h, m, k;
        if (c && c.find) for (h = c.find(a), d = 0; d < h.count(); d++) if (c = h.getItem(d), b || !c.isReadOnly()) m =
          c.getPosition(e.startNode) & CKEDITOR.POSITION_FOLLOWING || e.startNode.equals(c), k = c.getPosition(e.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED || e.endNode.equals(c), m && k && g.push(c);
        return g
      }
    };
    CKEDITOR.dom.range.mergeRanges = function (a) {
      return CKEDITOR.tools.array.reduce(a, function (a, b) {
        var c = a[a.length - 1], f = !1;
        b = b.clone();
        b.enlarge(CKEDITOR.ENLARGE_ELEMENT);
        if (c) {
          var e = new CKEDITOR.dom.range(b.root), f = new CKEDITOR.dom.walker(e), g = CKEDITOR.dom.walker.whitespaces();
          e.setStart(c.endContainer,
            c.endOffset);
    ...
    function b(a, c, e, g) {
      ...
      if ((h = CKEDITOR.filter.instances[g.element.data("cke-filter")]) &&
        !h.check(c)) return b(a, c, e, g.remaining);
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          d = w.startPath();
          var r = w.endPath(), u = !w.collapsed && c(w, d.block), t = !w.collapsed && c(w, r.block, 1);
          w.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
          u && w.setStartAt(d.block, CKEDITOR.POSITION_BEFORE_END);
          t && w.setEndAt(r.block, CKEDITOR.POSITION_AFTER_START);
          d = w.endContainer.hasAscendant("pre", !0) || w.startContainer.hasAscendant("pre", !0);
          w.enlarge(this.forceBrBreak && !d || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
          w.collapsed || (d = new CKEDITOR.dom.walker(w.clone()), r = CKEDITOR.dom.walker.bookmark(!0, !0), d.evaluator = r, this._.nextNode = d.next(), d = new CKEDITOR.dom.walker(w.clone()), d.evaluator = r, d = d.previous(), this._.lastNode = d.getNextSourceNode(!0, null, w.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (r = this.range.clone(), r.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), r.checkEndOfBlock() &&
          (r = new CKEDITOR.dom.elementPath(r.endContainer, r.root), this._.lastNode = (r.block || r.blockLimit).getNextSourceNode(!0))), this._.lastNode && w.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = w.document.createText(""), this._.lastNode.insertAfter(d)), w = null);
          this._.started = 1;
          d = w
        }
        r = this._.nextNode;
        ...
        for (this._.nextNode = null; r;) {
          var u = 0, t = r.hasAscendant("pre"), A = r.type != CKEDITOR.NODE_ELEMENT, x = 0;
          if (A) r.type == CKEDITOR.NODE_TEXT && g.test(r.getText()) && (A = 0); else {
            var z = r.getName();
            if (CKEDITOR.dtd.$block[z] && "false" == r.getAttribute("contenteditable")) {
              f = r;
              b(this, a, f);
              break
            } else if (r.isBlockBoundary(this.forceBrBreak && !t && {br: 1})) {
              if ("br" == z) A = 1; else if (!d && !r.getChildCount() && "hr" != z) {
                f = r;
                k = r.equals(w);
                break
              }
              d && (d.setEndAt(r, CKEDITOR.POSITION_BEFORE_START), "br" != z && (this._.nextNode = r));
              u = 1
            } else {
              if (r.getFirst()) {
                d || (d = this.range.clone(), d.setStartAt(r, CKEDITOR.POSITION_BEFORE_START));
                r = r.getFirst();
                continue
              }
              A = 1
          ...
          A && !d && (d = this.range.clone(), d.setStartAt(r, CKEDITOR.POSITION_BEFORE_START));
          k = (!u || A) && r.equals(w);
          if (d && !u) for (; !r.getNext(e) && !k;) {
            z = r.getParent();
            if (z.isBlockBoundary(this.forceBrBreak && !t && {br: 1})) {
              u = 1;
              A = 0;
              k || z.equals(w);
              d.setEndAt(z, CKEDITOR.POSITION_BEFORE_END);
              break
            }
            r = z;
            A = 1;
          ...
          A && d.setEndAt(r, CKEDITOR.POSITION_AFTER_END);
          r = this._getNextSourceNode(r, x, w);
          if ((k = !r) || u && d) break
        }
        if (!f) {
          ...
          u = {div: 1, th: 1, td: 1};
          f = f.block;
          !f && r && !this.enforceRealBlocks && u[r.getName()] && d.checkStartOfBlock() && d.checkEndOfBlock() && !r.equals(d.root) ? f = r : !f || this.enforceRealBlocks && f.is(h) ? (f = this.range.document.createElement(a), d.extractContents().appendTo(f), f.trim(), d.insertNode(f), q = v = !0) : "li" != f.getName() ? d.checkStartOfBlock() && d.checkEndOfBlock() || (f = f.clone(!1), d.extractContents().appendTo(f), f.trim(), v = d.splitBlock(), q = !v.wasStartOfBlock, v = !v.wasEndOfBlock, d.insertNode(f)) : k || (this._.nextNode = f.equals(w) ? null : this._getNextSourceNode(d.getBoundaryNodes().endNode,
            1, w))
        }
        q && (q = f.getPrevious()) && q.type == CKEDITOR.NODE_ELEMENT && ("br" == q.getName() ? q.remove() : q.getLast() && "br" == q.getLast().$.nodeName.toLowerCase() && q.getLast().remove());
        v && (q = f.getLast()) && q.type == CKEDITOR.NODE_ELEMENT && "br" == q.getName() && (!CKEDITOR.env.needsBrFiller || q.getPrevious(l) || q.getNext(l)) && q.remove();
        this._.nextNode || (this._.nextNode = k || f.equals(w) || !w ? null : this._getNextSourceNode(f, 1, w));
        return f
    ...
    function a(a, b, c, f, e) {
      ...
      for (g in b) {
        ...
        for (l in J) {
          h[l] = k(h[l],
            m) || null;
          var n = h, r = K[l], z = k(h[K[l]], m), x = h[l], E = [], p = !0, t = void 0;
          z ? p = !1 : z = {};
          for (t in x) "!" == t.charAt(0) && (t = t.slice(1), E.push(t), z[t] = !0, p = !1);
          for (; t = E.pop();) x[t] = x["!" + t], delete x["!" + t];
          n[r] = (p ? !1 : z) || null
        }
      ...
      for (f = a.length; c < f; ++c) {
        ...
        for (l in K) {
          ...
          z = [];
          x = void 0;
          for (x in r) -1 < x.indexOf("*") ? z.push(new RegExp("^" +
            x.replace(/\*/g, ".*") + "$")) : z.push(x);
          r = z;
          r.length && (h[m] = r, n = !1)
        }
        h.nothingRequired = n;
        h.noProperties = !(h.attributes || h.classes || h.styles);
        if (!0 === g.elements || null === g.elements) e[d ? "unshift" : "push"](g); else for (y in h = g.elements, delete g.elements, h) if (b[y]) b[y][d ? "unshift" : "push"](g); else b[y] = [g]
      }
    }

    function d(a, c, f, g) {
      if (!a.match || a.match(c)) if (g || e(a, c)) if (a.propertiesOnly || (f.valid = !0), f.allAttributes || (f.allAttributes = b(a.attributes, c.attributes, f.validAttributes)), f.allStyles || (f.allStyles = b(a.styles,
        c.styles, f.validStyles)), !f.allClasses) {
        a = a.classes;
        c = c.classes;
        g = f.validClasses;
        if (a) if (!0 === a) a = !0; else {
          for (var d = 0, h = c.length, m; d < h; ++d) m = c[d], g[m] || (g[m] = a(m));
          a = !1
        } else a = !1;
        f.allClasses = a
      }
    ...
    function c(a, b, c) {
      if (!a.match || a.match(b)) {
        ...
        b = b.classes;
        if (a) {
          for (var f = !1, e = !0 === a, d = b.length; d--;) if (e || a(b[d])) b.splice(d, 1), f = !0;
          a = f
        } else a = !1;
    ...
    function e(a, b) {
      ...
      var c, f, e, g;
      if (e = a.requiredClasses) for (g = b.classes, c = 0; c < e.length; ++c) if (f = e[c], "string" == typeof f) {
    ...
    function h(a, b) {
      if (!b) return !0;
      for (var c = 0, f; c < b.length; ++c) if (f = b[c], "string" ==
      typeof f) {
        if (!(f in a)) return !1
    ...
    function f(a) {
      var b, c, f, e, g = {}, d = 1;
      for (a = I(a); b = a.match(E);) (c = b[2]) ? (f = n(c, "styles"), e = n(c, "attrs"), c = n(c, "classes")) : f = e = c = null, g["$" + d++] = {
        elements: b[1],
        classes: c,
        styles: f,
        attributes: e
    ...
    function q(a, b, f, e) {
      ...
      if (e.doCallbacks && a.elementCallbacks) {
        a:{
          ...
          for (var m = 0, k = h.length, l; m < k; ++m) if (l = h[m](b)) {
            h = l;
            break a
          }
          h = void 0
      ...
      if (e.doTransform && (h = a._.transformations[b.name])) {
        p(b);
        for (m = 0; m < h.length; ++m) z(a, b, h[m]);
        w(b)
      }
      if (e.doFilter) {
        a:{
          m =
            b.name;
          k = a._;
          a = k.allowedRules.elements[m];
          h = k.allowedRules.generic;
          m = k.disallowedRules.elements[m];
          k = k.disallowedRules.generic;
          l = e.skipRequired;
          var n = {
            valid: !1,
            validAttributes: {},
          ...
          if (a || h) {
            p(b);
            if (m) for (x = 0, E = m.length; x < E; ++x) if (!1 === c(m[x], b, n)) {
              a = null;
              break a
            }
            if (k) for (x = 0, E = k.length; x < E; ++x) c(k[x], b, n);
            if (a) for (x = 0, E = a.length; x < E; ++x) d(a[x], b, n, l);
            if (h) for (x =
        ...
        var t = a.validStyles;
        h = a.validClasses;
        var m = b.attributes, u = b.styles, k = b.classes;
        l = b.classBackup;
        var K = b.styleBackup, y, v, C = [], n = [], D = /^data-cke-/;
        x = !1;
        delete m.style;
        delete m["class"];
        delete b.classBackup;
        delete b.styleBackup;
        if (!a.allAttributes) for (y in m) E[y] || (D.test(y) ? y == (v = y.replace(/^data-cke-saved-/, "")) || E[v] || (delete m[y], x = !0) : (delete m[y], x = !0));
        if (!a.allStyles || a.hadInvalidStyle) {
          for (y in u) a.allStyles ||
          t[y] ? C.push(y + ":" + u[y]) : x = !0;
          C.length && (m.style = C.sort().join("; "))
        } else K && (m.style = K);
        if (!a.allClasses || a.hadInvalidClass) {
          for (y = 0; y < k.length; ++y) (a.allClasses || h[k[y]]) && n.push(k[y]);
          n.length && (m["class"] = n.sort().join(" "));
          l && n.length < l.split(/\s+/).length && (x = !0)
        } else l && (m["class"] = l);
        x && (g = 1);
        if (!e.skipFinalValidation && !r(b)) return f.push(b), 1
      }
    ...
    function x(a, b, c) {
      var f = a.name;
      if (D.$empty[f] || !a.children.length) "hr" == f && "br" == b ? a.replaceWith(t()) : (a.parent && c.push({
        check: "it",
        el: a.parent
      }), a.remove()); else if (D.$block[f] || "tr" == f) if ("br" == b) a.previous && !A(a.previous) && (b = t(), b.insertBefore(a)), a.next && !A(a.next) && (b = t(), b.insertAfter(a)), a.replaceWithChildren(); else {
        var f = a.children, e;
        b:{
          e = D[b];
          for (var g = 0, d = f.length, h; g < d; ++g) if (h = f[g], h.type == CKEDITOR.NODE_ELEMENT &&
          !e[h.name]) {
            e = !1;
            break b
          }
        ...
        if (e) a.name = b, a.attributes = {}, c.push({check: "parent-down", el: a}); else {
          e = a.parent;
          for (var g = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, m, k, d = f.length; 0 < d;) h = f[--d], g && (h.type == CKEDITOR.NODE_TEXT || h.type == CKEDITOR.NODE_ELEMENT && D.$inline[h.name]) ? (m || (m = new CKEDITOR.htmlParser.element(b), m.insertAfter(a), c.push({
            check: "parent-down",
            el: m
          })), m.add(h, 0)) : (m = null, k = D[e.name] || D.span, h.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || h.type != CKEDITOR.NODE_ELEMENT ||
          k[h.name] || c.push({check: "el-up", el: h}));
          a.remove()
        }
      } else f in {style: 1, script: 1} ? a.remove() : (a.parent && c.push({
        check: "it",
        el: a.parent
    ...
    function z(a, b, c) {
      var f, e;
      for (f = 0; f < c.length; ++f) if (e = c[f], !(e.check && !a.check(e.check, !1) || e.left && !e.left(b))) {
        e.right(b, L);
        break
      }
    }
    ...
    function C(a, b) {
      var c = b.getDefinition(), f = c.attributes, e = c.styles, g, d, h, m;
      if (a.name != c.element) return !1;
      for (g in f) if ("class" == g) for (c = f[g].split(/\s+/), h = a.classes.join("|"); m = c.pop();) {
        if (-1 == h.indexOf(m)) return !1
      } else if (a.attributes[g] !=
        f[g]) return !1;
      for (d in e) if (a.styles[d] != e[d]) return !1;
      return !0
    }
    ...
    function y(a, b) {
      ...
      return [{
        element: c, left: f, right: function (a, c) {
          c.transform(a, b)
        }
      }]
    }
    ...
    var D = CKEDITOR.dtd, F = CKEDITOR.tools.copy, I = CKEDITOR.tools.trim, H = ["", "p", "br", "div"];
    ...
    CKEDITOR.filter.prototype = {
      allow: function (b, c, e) {
        ...
        if ("string" == typeof b) b = f(b); else if (b instanceof CKEDITOR.style) {
          ...
          for (g = 0; g < b.length; ++g) d = this.allow(b[g], c, e);
          return d
        }
        ...
        var e = this, g = [], d = this.editor && this.editor.config.protectedSource, h, m = !1, k = {
          doFilter: !c,
        ...
        a.forEach(function (a) {
          if (a.type == CKEDITOR.NODE_ELEMENT) {
            ...
            if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (h = q(e, a, g, k), h & 1) m = !0; else if (h & 2) return !1
            ...
            a:{
              ...
              c = [];
              var l, n, r;
              if (d) for (n = 0; n < d.length; ++n) if ((r = f.match(d[n])) &&
                r[0].length == f.length) {
                c = !0;
                break a
              }
              f = CKEDITOR.htmlParser.fragment.fromHtml(f);
              1 == f.children.length && (l = f.children[0]).type == CKEDITOR.NODE_ELEMENT && q(e, l, c, k);
              c = !c.length
            }
            c || g.push(a)
          }
        ...
        for (; l = a.pop();) if (c = l.el, c.parent) switch (n = D[c.parent.name] || D.span, l.check) {
          case "it":
            D.$removeEmpty[c.name] && !c.children.length ? x(c, f, a) : r(c) ||
              x(c, f, a);
            break;
          case "el-up":
        ...
        if (!this.disabled && a) {
          ...
          if (e) {
            for (b = 0; b < a.length; ++b) f.push(y(a[b], e));
        ...
        var b, c;
        if (!this.disabled && a) {
          var f = this._.transformations, e;
          for (e = 0; e < a.length; ++e) {
            b = a[e];
            var g = void 0, d = void 0, h = void 0, m = void 0, k = void 0, l = void 0;
            c = [];
            for (d = 0; d < b.length; ++d) h = b[d], "string" == typeof h ? (h = h.split(/\s*:\s*/), m = h[0], k = null, l = h[1]) : (m = h.check, k = h.left,
              l = h.right), g || (g = h, g = g.element ? g.element : m ? m.match(/^([a-z0-9]+)/i)[0] : g.left.getDefinition().element), k instanceof CKEDITOR.style && (k = B(k)), c.push({
              check: m == g ? null : m,
              left: k,
        ...
        if ("string" == typeof a) {
          ...
          g = e
        } else e = a.getDefinition(), g = e.styles, h = e.attributes || {}, g && !CKEDITOR.tools.isEmpty(g) ? (g = F(g), h.style = CKEDITOR.tools.writeCssText(g, !0)) : g = {}, g = {
          name: e.element,
          attributes: h,
        ...
        var h =
          CKEDITOR.tools.clone(g), k = [], l;
        if (!1 !== b && (l = this._.transformations[g.name])) {
          for (e = 0; e < l.length; ++e) z(this, g, l[e]);
          w(g)
        }
        q(this, h, k, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
        ...
        return function (c, f) {
          ...
          for (f || (e = e.reverse()); g = e.pop();) if (this.check(g)) return b[g];
    ...
    var J = {styles: 1, attributes: 1, classes: 1},
      K = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"},
      E = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i,
      R = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, O = /^cke:(object|embed|param)$/,
      S = /^(object|embed|param)$/, L;
    L = CKEDITOR.filter.transformationsTools = {
      sizeToStyle: function (a) {
        ...
        if (!(c in a.attributes)) {
          var f = a.styles[b], e = f && f.match(/^(\d+)(?:\.\d*)?px$/);
          e ? a.attributes[c] = e[1] : "cke-test" == f && (a.attributes[c] = "cke-test")
        }
        delete a.styles[b]
        ...
        if ("string" == typeof b) a.name = b; else {
          var c = b.getDefinition(), f = c.styles, e = c.attributes, g, d, h, m;
          a.name = c.element;
          for (g in e) if ("class" == g) for (c =
                                                a.classes.join("|"), h = e[g].split(/\s+/); m = h.pop();) -1 == c.indexOf(m) && a.classes.push(m); else a.attributes[g] = e[g];
    ...
    var a, d = function (b) {
      b = b.data;
      var g = b.getKeystroke(), d = this.keystrokes[g], k = this._.editor;
    ...
    CKEDITOR.lang = {
      languages: {
        ...
        d = d || navigator.userLanguage || navigator.language ||
          a;
        var c = d.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), g = c[1], c = c[2];
    ...
    return {
      load: function (b, c, g, l) {
        ...
        k && (b = [b]);
        g || (g = CKEDITOR);
        var e = b.length, h = [], m = [], f = function (a) {
          c && (k ? c.call(g, a) : c.call(g, h, m))
        };
        if (0 === e) f(!0); else {
          var n = function (a, b) {
            (b ? h : m).push(a);
    ...
    add: function (a, d) {
      ...
      CKEDITOR.scriptLoader.load(l, function (a, f) {
        ...
        for (var g = 0; g < a.length; g++) for (var h = k[a[g]], m = 0; m < h.length; m++) {
          var l = h[m];
          e[l] = this.get(l);
          c[l] = 1
        }
      ...
      return function (b, c, g) {
        var l = {}, k = function (b) {
          a.call(this, b, function (a) {
            ...
            var b = [], f;
            for (f in a) {
              var e = a[f], p = e && e.requires;
              if (!d[f]) {
                if (e.icons) for (var q = e.icons.split(","), v = q.length; v--;) CKEDITOR.skin.addIcon(q[v], e.path + "icons/" + (CKEDITOR.env.hidpi && e.hidpi ? "hidpi/" : "") + q[v] + ".png");
                d[f] = 1
              }
              if (p) for (p.split && (p = p.split(",")), e = 0; e < p.length; e++) l[p[e]] || b.push(p[e])
            }
    ...
    add: function (a, d, b) {
      ...
      var d = this.items[a], b = d && this._.handlers[d.type], c = d && d.command && this.editor.getCommand(d.command),
    ...
    function a(a, f, g) {
      ...
      CKEDITOR.tools.setTimeout(function () {
        "destroyed" !== this.status ? e(this, a) : CKEDITOR.warn("editor-incorrect-destroy")
      }, 0, this)
    }
    ...
    function n(a) {
      ...
      var c = a.config, f = b(c.plugins), e = b(c.extraPlugins), g = b(c.removePlugins);
      if (e) var d = new RegExp("(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), f = f.replace(d, ""),
        f = f + ("," + e);
      if (g) var h = new RegExp("(?:^|,)(?:" + g.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), f = f.replace(h,
        "");
      ...
      CKEDITOR.plugins.load(f.split(","), function (b) {
        ...
        a.plugins = b;
        for (var d in b) {
          var m = b[d], k = m.lang, l = null, n = m.requires, x;
          CKEDITOR.tools.isArray(n) && (n = n.join(","));
          if (n && (x = n.match(h))) for (; n = x.pop();) CKEDITOR.error("editor-plugin-required", {
            plugin: n.replace(",", ""),
            requiredBy: d
          });
          k && !a.lang[d] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? l = a.langCode : (l = a.langCode.replace(/-.*/, ""), l = l != a.langCode && 0 <= CKEDITOR.tools.indexOf(k,
            l) ? l : 0 <= CKEDITOR.tools.indexOf(k, "en") ? "en" : k[0]), m.langEntries && m.langEntries[l] ? (a.lang[d] = m.langEntries[l], l = null) : g.push(CKEDITOR.getUrl(m.path + "lang/" + l + ".js")));
          e.push(l);
          f.push(m)
        }
        CKEDITOR.scriptLoader.load(g, function () {
          for (var b = ["beforeInit", "init", "afterInit"], g = 0; g < b.length; g++) for (var d = 0; d < f.length; d++) {
            var h = f[d];
            0 === g && e[d] && h.lang && h.langEntries && (a.lang[h.name] = h.langEntries[e[d]]);
            if (h[b[g]]) h[b[g]](a)
          }
          a.fireOnce("pluginsLoaded");
          c.keystrokes && a.setKeystroke(a.config.keystrokes);
          for (d = 0; d < a.config.blockedKeystrokes.length; d++) a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[d]] = 1;
          a.status = "loaded";
          a.fireOnce("loaded");
    ...
    function q(a, b) {
      ...
      for (var e = new CKEDITOR.dom.documentFragment, g, d, h, m = 0; m < a.length; m++) {
        var k = a[m], l = k.startContainer.getAscendant("tr", !0);
        c(k) ? (g || (g = l.getAscendant("table").clone(), g.append(l.getAscendant({
            thead: 1,
            tbody: 1,
            tfoot: 1
          }).clone()), e.append(g), g = g.findOne("thead, tbody, tfoot")), d && d.equals(l) || (d = l, h = l.clone(), g.append(h)), h.append(f(k))) :
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      addCommand: function (a, b) {
        ...
        var c = this, f = c.element, e = new CKEDITOR.dom.element(f.$.form);
        f.is("textarea") && e && (e.on("submit", a), b(e.$.submit) && (e.$.submit = CKEDITOR.tools.override(e.$.submit, function (b) {
          return function () {
            a();
        ...
        var c = this.getCommand(a), f = {name: a, commandData: b || {}, command: c};
        return c && c.state != CKEDITOR.TRISTATE_DISABLED && !1 !== this.fire("beforeCommandExec",
        ...
        "string" != typeof a && (a = (a =
          this.element) && this.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE ? a.is("textarea") ? a.getValue() : a.getHtml() : "");
        return a
        ...
        var c = this.editable(), f = this.getSelection().getRanges(), e = new CKEDITOR.dom.documentFragment, g;
        if (!c || 0 === f.length) return null;
        for (g = 0; g < f.length; g++) e.append(c.extractHtmlFromRange(f[g], b));
      ...
      updateElement: function () {
        ...
        for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, f, e = b.length; e--;) c = b[e], f = 0, CKEDITOR.tools.isArray(c) && (f = c[1], c = c[0]), f ? a[c] = f : delete a[c]
      }, getCommandKeystroke: function (a) {
        if (a = "string" === typeof a ? this.getCommand(a) : a) {
          var b = CKEDITOR.tools.object.findKey(this.commands, a), c = this.keystrokeHandler.keystrokes, f;
      ...
      CKEDITOR.htmlParser.prototype = {
        onTagOpen: function () {
          ...
          for (var c, g, l = 0, k; c = this._.htmlPartsRegex.exec(b);) {
            ...
            if (g = c[1]) if (g = g.toLowerCase(), k && CKEDITOR.dtd.$cdata[g] && (this.onCDATA(k.join("")), k = null), !k) {
              this.onTagClose(g);
              continue
            }
            if (k) k.push(c[0]); else if (g = c[3]) {
              if (g = g.toLowerCase(), !/="/.test(g)) {
                ...
                if (m) for (; h = a.exec(m);) {
                  ...
                  h = h[2] || h[3] || h[4] || "";
                  e[f] = !h && d[f] ? f : CKEDITOR.tools.htmlDecodeAttr(h)
                }
                this.onTagOpen(g, e, c);
    ...
    CKEDITOR.htmlParser.node.prototype = {
      remove: function () {
        ...
        var d = this.parent.children,
          b = CKEDITOR.tools.indexOf(d, this), c = a.previous = this.previous, g = a.next = this.next;
        c && (c.next = a);
        g && (g.previous = a);
        d[b] = a;
        ...
        var d = a.parent.children, b = CKEDITOR.tools.indexOf(d, a), c = a.next;
        d.splice(b + 1, 0, this);
        this.next = a.next;
        this.previous = a;
        a.next = this;
    ...
    CKEDITOR.htmlParser.text.prototype =
      CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
        type: CKEDITOR.NODE_TEXT, filter: function (a, d) {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (l, k, e) {
      function h(a) {
        ...
        if (0 < r.length) for (var c = 0; c < r.length; c++) {
          var f = r[c], e = f.name, g = CKEDITOR.dtd[e], d = t.name && CKEDITOR.dtd[t.name];
          d && !d[e] || a && g && !g[a] && CKEDITOR.dtd[a] ? e == t.name && (n(t, t.parent, 1), c--) : (b || (m(), b = 1), f = f.clone(), f.parent = t, t = f, r.splice(c, 1), c--)
        }
      }

      function m() {
        for (; u.length;) n(u.shift(), t)
      }

      function f(a) {
        if (a._.isBlockLike && "pre" != a.name && "textarea" != a.name) {
          var b =
            a.children.length, c = a.children[b - 1], f;
      ...
      function n(b, c, g) {
        c = c || t || w;
        var d = t;
        void 0 === b.previous && (p(c, b) && (t = c, v.onTagOpen(e, {}), b.returnPoint = c = t), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (x = !1), "textarea" == b.name && (A = !1));
        b.returnPoint ? (t = b.returnPoint, delete b.returnPoint) : t = g ? c : d
      }

      function p(a, b) {
        if ((a == w || "body" == a.name) && e && (!a.name || CKEDITOR.dtd[a.name][e])) {
          var c, f;
      ...
      v.onTagOpen =
        function (f, e, g, k) {
          ...
          if (a(e)) r.push(e); else {
            ...
            if ("br" == f) u.push(e); else {
              for (; !(k = (g = t.name) ? CKEDITOR.dtd[g] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || t.isUnknown || k[f]);) if (t.isOptionalClose) v.onTagClose(g); else if (f in b && g in b) g = t.children, (g = g[g.length - 1]) && "li" == g.name || n(g = new CKEDITOR.htmlParser.element("li"),
                t), !e.returnPoint && (e.returnPoint = t), t = g; else if (f in CKEDITOR.dtd.$listItem && !q(f, g)) v.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (g in d && !q(f, g)) !e.returnPoint && (e.returnPoint = t), t = t.parent; else if (g in CKEDITOR.dtd.$inline && r.unshift(t), t.parent) n(t, t.parent, 1); else {
                e.isOrphan = 1;
                break
              }
              h(f);
      ...
      v.onTagClose = function (a) {
        ...
        for (var c = [], f = [], g = t; g != w && g.name != a;) g._.isBlockLike || f.unshift(g), c.push(g),
      ...
      v.onText = function (a) {
        if (!(t._.hasInlineStarted && !u.length || x || A) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
        var b = t.name, f = b ? CKEDITOR.dtd[b] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
        if (!A && !f["#"] && b in d) v.onTagOpen(g[b] || ""), v.onText(a); else {
          m();
          h();
          x || A || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
          a =
            new CKEDITOR.htmlParser.text(a);
          if (p(t, a)) this.onTagOpen(e, {}, 0, 1);
          t.add(a)
        }
      };
    ...
    CKEDITOR.htmlParser.fragment.prototype = {
      type: CKEDITOR.NODE_DOCUMENT_FRAGMENT, add: function (a, b) {
        ...
        if (!1 !== g) {
          c = this.children;
          for (var d = 0; d < c.length; d++) g = c[d], g.type == CKEDITOR.NODE_ELEMENT ? g.forEach(a,
            b) : b && g.type != b || a(g)
        }
      }, getFilterContext: function (a) {
        return a || {}
    ...
    function d(b, c, g, d) {
      var k, e;
      for (k in c) (e = b[k]) || (e = b[k] = new a), e.add(c[k], g, d)
    }
    ...
    CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
      ...
      proto: {
        addRules: function (a, c) {
          ...
          for (var g = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], d, k = 0; 3 > k; k++) if (d = g[k]) {
            d =
              d.exec(a, c, this);
            if (!1 === d) return null;
    ...
    a.prototype =
      {
        add: function (a, c, g) {
          this.rules.splice(this.findIndex(c), 0, {value: a, priority: c, options: g})
        }, addMany: function (a, c, g) {
          for (var d = [this.findIndex(c), 0], k = 0, e = a.length; k < e; k++) d.push({
            value: a[k],
            priority: c,
            options: g
          });
          ...
          var g = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
            d = Array.prototype.slice.call(arguments, 1), k = this.rules,
            e = k.length, h, m, f, n;
          for (n = 0; n < e; n++) if (g && (h = c.type, m = c.name), f = k[n], !(a.nonEditable && !f.options.applyToAll || a.nestedEditable && f.options.excludeNestedEditable)) {
            f = f.value.apply(null, d);
            if (!1 === f || g && f && (f.name != m || f.type != h)) return f;
            null != f && (d[0] = c = f)
          }
          return c
        }, execOnName: function (a, c) {
          for (var g = 0, d = this.rules, k = d.length, e; c && g < k; g++) e = d[g], a.nonEditable && !e.options.applyToAll || a.nestedEditable && e.options.excludeNestedEditable || (c = c.replace(e.value[0], e.value[1]));
          return c
        }
      }
  }(),function () {
    function a(a,
      ...
      function d(a, f) {
        return function (g) {
          if (g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var d = [], m = b(g), k, x;
            if (m) for (h(m, 1) && d.push(m); m;) l(m) && (k = c(m)) && h(k) && ((x = c(k)) && !l(x) ? d.push(k) : (e(n).insertAfter(k), k.remove())), m = m.previous;
            for (m = 0; m < d.length; m++) d[m].remove();
            if (d = !a || !1 !== ("function" == typeof f ? f(g) : f)) n || CKEDITOR.env.needsBrFiller || g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ?
              n || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || g.name in CKEDITOR.dtd.tr || g.name in CKEDITOR.dtd.$listItem) ? (d = b(g), d = !d || "form" == g.name && "input" == d.name) : d = !1 : d = !1;
            d && g.add(e(a))
          }
        }
      }
      ...
      var m = {elements: {}}, n = "html" == f, E = CKEDITOR.tools.extend({}, x), p;
      for (p in E) "#" in t[p] || delete E[p];
        ...
        return function (b) {
          if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            ...
            if ("data-cke-bogus" in f || "data-cke-eol" in f) delete f["data-cke-bogus"]; else {
              ...
              var d = c(b);
              !f && l(b.parent) ? k(b.parent,
                e(a)) : l(f) && d && !l(d) && e(a).insertBefore(f)
            }
          }
        }
      }(n);
    ...
    function f(a, b) {
      return a.replace(b, function (a, b, c) {
        0 === a.indexOf("\x3ctextarea") && (a = b + q(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e");
    ...
    function w(a, b) {
      var c = [], f = b.config.protectedSource, e = b._.dataStore || (b._.dataStore =
          {id: 1}), g = /<\!--\{cke_temp(comment)?\}(\d*?)--\x3e/g,
      ...
      for (var d = 0; d < f.length; d++) a = a.replace(f[d], function (a) {
      ...
      return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, f, e) {
        return "\x3c" + c + f + "\x3e" + v(q(e), b) + "\x3c/" + c + "\x3e"
      })
    }
    ...
    CKEDITOR.htmlDataProcessor = function (b) {
      ...
      b.on("toHtml", function (a) {
        a = a.data;
        var c = a.dataValue, e, c = w(c, b), c = f(c, H), c = m(c), c = f(c, I), c = c.replace(K, "$1cke:$2"),
      ...
      b.on("toDataFormat", function (a) {
        var c = a.data.dataValue, f = g.writer;
        f.reset();
    ...
    CKEDITOR.htmlDataProcessor.prototype = {
      toHtml: function (a, b, c, f) {
        ...
        return e.fire("toHtml", {
          ...
          filter: d || e.filter, enterMode: h || e.enterMode, protectedWhitespaces: m
        }).dataValue
    ...
    var r = /(?:&nbsp;|\xa0)$/, u = "{cke_protected}", t = CKEDITOR.dtd,
      A = "caption colgroup col thead tfoot tbody".split(" "), x = CKEDITOR.tools.extend({}, t.$blockLimit,
      t.$block), z = {elements: {input: e, textarea: e}}, C = {
        ...
        elements: {
          $: function (a) {
            ...
            if (b) {
              ...
              for (var c = ["name", "href", "src"], f, e = 0; e < c.length; e++) f = "data-cke-saved-" + c[e], f in b && delete b[c[e]]
            }
            return a
          },
          table: function (a) {
            a.children.slice(0).sort(function (a, b) {
              var c, f;
              a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(A, a.name), f = CKEDITOR.tools.indexOf(A, b.name));
              -1 < c && -1 < f && c != f || (c = a.parent ? a.getIndex() : -1, f = b.parent ? b.getIndex() : -1);
              return c > f ? 1 : -1
            })
          }, param: function (a) {
            a.children = [];
    ...
    var G = /<(a|area|img|input|source)\b([^>]*)>/gi, D = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,
      F = /^(href|src|name)$/i, I = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
      H = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, J = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
      K = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
      E = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, R = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
  }(),
    ...
    var d = {};
    ((a instanceof
    CKEDITOR.htmlParser.element ? a.attributes.style : a) || "").replace(/&quot;/g, '"').replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, c, g) {
    ...
    CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
      type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
        ...
        for (; ;) {
          k = d.name;
          if (!(e =
            a.onElementName(b, k))) return this.remove(), !1;
          d.name = e;
        ...
        var h, m;
        for (h in k) {
          for (e = k[h]; ;) if (m = a.onAttributeName(b, h)) if (m != h) delete k[h], h = m; else break; else {
            delete k[h];
            break
          }
          m && (!1 === (e = a.onAttribute(b, d, m, e)) ? delete k[m] : k[m] = e)
        }
        d.isEmpty || this.filterChildren(a, !1,
          b);
        return !0
      }, filterChildren: b.filterChildren, writeHtml: function (a, b) {
        b && this.filter(b);
        var l = this.name, k = [], e = this.attributes, h, m;
        a.openTag(l, e);
        for (h in e) k.push([h, e[h]]);
        a.sortAttributes && k.sort(d);
        h = 0;
        for (m = k.length; h < m; h++) e = k[h], a.attribute(e[0], e[1]);
      ...
      getFirst: function (b) {
        ...
        for (var g = 0, d = this.children.length; g < d; ++g) if (b(this.children[g])) return this.children[g];
        return null
      }, getHtml: function () {
        ...
        for (k = 0; k < this.children.length; k++) {
          ...
          "function" == typeof a && a(e) ? d.push(e) : "string" == typeof a && e.name === a && d.push(e);
          b && e.find && (d = d.concat(e.find(a,
            b)))
        }
        return d
      }, addClass: function (a) {
    ...
    CKEDITOR.inlineAll = function () {
      var a, d, b;
      for (b in CKEDITOR.dtd.$editable) for (var c = CKEDITOR.document.getElementsByTag(b), g = 0, l = c.count(); g < l; g++) a = c.getItem(g), "true" == a.getAttribute("contenteditable") && (d = {
        element: a,
        config: {}
    ...
    function a(a,
      ...
      a = CKEDITOR.dom.element.get(a);
      if (a.getEditor()) throw'The editor instance "' + a.getEditor().name + '" is already attached to the provided element.';
      var e = new CKEDITOR.editor(g, a, k);
    ...
    function b(a) {
      var b = a.name, d = a.element, k = a.elementMode, e = a.fire("uiSpace", {
          space: "top",
          html: ""
    ...
    CKEDITOR.editor.prototype.setMode = function (a, b) {
      ...
      if (a != d.mode && k && k[a]) {
        ...
        if (d.mode) {
          var e = d.checkDirty(), k = d._.previousModeData, h, m = 0;
          d.fire("beforeModeUnload");
          d.editable(0);
          d._.previousMode = d.mode;
          d._.previousModeData = h = d.getData(1);
          "source" == d.mode && k == h && (d.fire("lockSnapshot", {forceUpdate: !0}), m = 1);
    ...
    CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
      var e = this.container, h = this.ui.space("contents"),
    ...
    function a(a) {
      var b = a.editor, f = a.data.path, e = f.blockLimit, g = a.data.selection,
        h = g.getRanges()[0], m;
      if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (g = d(g, f)) g.appendBogus(), m = CKEDITOR.env.ie;
      k(b, f.block, e) && h.collapsed && !h.getCommonAncestor().isReadOnly() && (f = h.clone(), f.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), e = new CKEDITOR.dom.walker(f), e.guard = function (a) {
        return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
      }, !e.checkForward() || f.checkStartOfBlock() && f.checkEndOfBlock()) && (b = h.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller ||
    ...
    function d(a, b) {
      ...
      var f = b.block || b.blockLimit, e = f && f.getLast(c);
      if (!(!f || !f.isBlockBoundary() || e && e.type == CKEDITOR.NODE_ELEMENT && e.isBlockBoundary() || f.is("pre") || f.getBogus())) return f
    }
    ...
    function m(a, b, c) {
      ...
      for (b = a = c ? b : a; (a = a.getParent()) && !f.equals(a) && 1 == a.getChildCount();) b = a;
      b.remove()
    }

    var f, n, p, q, v, w, r, u, t, A;
    CKEDITOR.editable = CKEDITOR.tools.createClass({
      base: CKEDITOR.dom.element, $: function (a, b) {
        ...
        focus: function () {
          ...
          f.focus();
          f.fire("saveSnapshot");
          var e = f.activeEnterMode, f = f.getSelection(), g = a.getName(), g = CKEDITOR.dtd.$block[g];
          b || (b = f.getRanges()[0]);
          ...
          var c = this.editor, f = c.config.enterMode, e = a.getName(), g = CKEDITOR.dtd.$block[e];
          ...
          b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({
            ...
            thead: 1,
            tfoot: 1
          }) ? r(b) : b.startContainer.is(CKEDITOR.dtd.$list) && u(b));
          var d, h;
          if (g) for (; (d = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[d.getName()]) && (!h || !h[e]);) d.getName() in CKEDITOR.dtd.span ? b.splitElement(d) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(d), b.collapse(!0), d.remove()) : b.splitBlock(f == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
          b.insertNode(a);
          return !0
        }, setData: function (a,
                              b) {
        ...
        fixInitialSelection: function () {
          function a() {
            var b = c.getDocument().$, f = b.getSelection(), e;
            a:if (f.anchorNode && f.anchorNode == c.$) e = !0; else {
              if (CKEDITOR.env.webkit && (e = c.getDocument().getActive()) && e.equals(c) && !f.anchorNode) {
                e = !0;
                break a
              }
              e = void 0
          ...
          function b() {
            var a = c.getDocument().$, f = a.selection, e = c.getDocument().getActive();
            "None" ==
          ...
          var c = A, f = {range: a, doc: a.document}, e = this.getHtmlFromRange(a);
          ...
          if (b) {
            ...
            if (f = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) {
              a:{
                var f = c.block.getElementsByTag("span"), g = 0, d;
                if (f) for (; d = f.getItem(g++);) if (!n(d)) {
                  f = !0;
                  break a
                }
                f = !1
          ...
          if (!this.is("textarea")) {
            ...
            if (h) {
              var d = g.getHead(), k = d.getCustomData("stylesheet");
              k ? h != k.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? k.$.styleSheet.cssText = h : k.setText(h)) : (h = g.appendStyleText(h), h = new CKEDITOR.dom.element(h.ownerNode || h.owningElement), d.setCustomData("stylesheet", h), h.data("cke-temp", 1))
            }
            ...
            this.attachListener(a, "key", function (b) {
              ...
              if (0 !== b.getRanges().length) {
                if (c in n) {
                  var g, d = b.getRanges()[0], h = d.startPath(), m, k, p, c = 8 == c;
                  CKEDITOR.env.ie &&
            ...
            CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
              ...
              if (c in n && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                var c = 8 == c, f = b.getRanges()[0];
                b = f.startPath();
                if (f.collapsed) a:{
                  var e = b.block;
                  if (e && f[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && f.moveToClosestEditablePosition(e, !c) && f.collapsed) {
                    ...
                    f = f.startPath().block;
                    if (!f || f && f.contains(e)) b = void 0; else {
                      a.fire("saveSnapshot");
                      var d;
    ...
    w = function () {
      ...
      function b(c, f) {
        var e, g, d, h, m = [], k = f.range.startContainer;
        e = f.range.startPath();
        for (var k = n[k.getName()], l = 0, p = c.getChildren(), r = p.count(), t = -1, u = -1, v = 0, q = e.contains(n.$list); l < r; ++l) e = p.getItem(l), a(e) ? (d = e.getName(), q && d in CKEDITOR.dtd.$list ?
          m = m.concat(b(e, f)) : (h = !!k[d], "br" != d || !e.data("cke-eol") || l && l != r - 1 || (v = (g = l ? m[l - 1].node : p.getItem(l + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && n.$block[g.getName()]), -1 != t || h || (t = l), h || (u = l), m.push({
            isElement: 1,
            isLineBreak: v,
            ...
            name: d,
            allowed: h
          }), g = v = 0)) : m.push({isElement: 0, node: e, allowed: 1});
        -1 < t && (m[t].firstNotAllowed = 1);
        -1 < u && (m[u].lastNotAllowed = 1);
        return m
      }

      function f(b, c) {
        var e = [], g = b.getChildren(), d = g.count(), h, m = 0, k = n[c], l = !b.is(n.$inline) || b.is("br");
        for (l && e.push(" "); m < d; m++) h = g.getItem(m), a(h) && !h.is(k) ? e = e.concat(f(h, c)) : e.push(h);
        l && e.push(" ");
        return e
      }
      ...
      function h(b, c, f, e) {
        ...
        (d = (new CKEDITOR.dom.walker(g)).next()) && a(d) && l[d.getName()] && (m = d.getPrevious()) && a(m) && !m.getParent().equals(b.startContainer) && f.contains(m) &&
        e.contains(d) && d.isIdentical(m) && (d.moveChildren(m), d.remove(), h(b, c, f, e))
      }
      ...
      var n = CKEDITOR.dtd,
        ...
        p = {
          ...
          h6: 1
        }, r = CKEDITOR.tools.extend({}, n.$inline);
      delete r.br;
      return function (l, E, t, u) {
        var v = l.editor, q = !1;
        "unfiltered_html" == E && (E = "html", q = !0);
        if (!u.checkReadOnly()) {
          var A = (new CKEDITOR.dom.elementPath(u.startContainer, u.root)).blockLimit || u.root;
          l = {
            type: E,
            dontFilter: q,
            editable: l,
          ...
          u = l.mergeCandidates;
          var w, I;
          "text" == l.type && E.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (w = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e",
            E.document), E.insertNode(w), E.setStartAfter(w));
          q = new CKEDITOR.dom.elementPath(E.startContainer);
          l.endPath = A = new CKEDITOR.dom.elementPath(E.endContainer);
          if (!E.collapsed) {
            var v = A.block || A.blockLimit, da = E.getCommonAncestor();
            v && !v.equals(da) && !v.contains(da) && E.checkEndOfBlock() && l.zombies.push(v);
            E.deleteContents()
          }
          for (; (I = g(E)) && a(I) && I.isBlockBoundary() && q.contains(I);) E.moveToPosition(I, CKEDITOR.POSITION_BEFORE_END);
          h(E, l.blockLimit, q, A);
          w && (E.setEndBefore(w), E.collapse(), w.remove());
          w = E.startPath();
          if (v = w.contains(d, !1, 1)) E.splitElement(v), l.inlineStylesRoot = v, l.inlineStylesPeak = w.lastElement;
          w = E.createBookmark();
          (v = w.startNode.getPrevious(c)) && a(v) && d(v) && u.push(v);
          (v = w.startNode.getNext(c)) && a(v) && d(v) && u.push(v);
          for (v = w.startNode; (v = v.getParent()) && d(v);) u.push(v);
          E.moveToBookmark(w);
          if (w = t) {
            w = l.range;
            if ("text" == l.type && l.inlineStylesRoot) {
              ...
              for (u = l.inlineStylesRoot.getParent(); !I.equals(u);) E = E.appendTo(I.clone()), I = I.getParent();
              t = E.getOuterHtml().split("{cke-peak}").join(t)
            }
            ...
            t = l.editor.dataProcessor.toHtml(t, {
              context: null,
              fixForBody: !1,
            ...
            I = w.document.createElement("body");
            I.setHtml(t);
            P && (I.getFirst().remove(), I.getLast().remove());
            if ((P = w.startPath().block) && (1 !=
              ...
              if (1 == I.getChildCount() && a(Q = I.getFirst()) && Q.is(p) && !Q.hasAttribute("contenteditable")) {
                ...
                w = 0;
                for (u = P.count(); w < u; w++) if (E = P.getItem(w), !E.is(r)) break a;
          ...
          if (w) {
            ...
            var W, aa;
            E = Q.startContainer;
            var q = l.endPath.elements[0], ba, A = q.getPosition(E),
              da = !!q.getCommonAncestor(E) && A != CKEDITOR.POSITION_IDENTICAL && !(A &
            ...
            for (m(E, Q); u < E.length; u++) {
              ...
              if (M = A.isLineBreak) {
                M = Q;
                W = I;
                var Y = void 0, ca = void 0;
                A.hasBlockSibling ? M = 1 : (Y = M.startContainer.getAscendant(n.$block, 1)) && Y.is({
                  div: 1,
                  p: 1
              ...
              if (M) t = 0 < u; else {
                M = Q.startPath();
                !A.isBlock && k(l.editor, M.block, M.blockLimit) && (N =
                  e(l.editor)) && (N = w.createElement(N), N.appendBogus(), Q.insertNode(N), CKEDITOR.env.needsBrFiller && (U = N.getBogus()) && U.remove(), Q.moveToPosition(N, CKEDITOR.POSITION_BEFORE_END));
                if ((M = Q.startPath().block) && !M.equals(T)) {
                  if (U = M.getBogus()) U.remove(), P.push(M);
                  T = M
                }
                A.firstNotAllowed && (v = 1);
                if (v && A.isElement) {
                  M = Q.startContainer;
                  for (W = null; M && !n[M.getName()][A.name];) {
                    if (M.equals(I)) {
                      M = null;
                      break
                    }
                  ...
                  if (M) W && (aa = Q.splitElement(W), l.zombies.push(aa), l.zombies.push(W)); else {
                    W = I.getName();
                    ba =
                      !u;
                    M = u == E.length - 1;
                ...
                A.lastNotAllowed && u < E.length - 1 && ((aa = da ? q : aa) && Q.setEndAt(aa, CKEDITOR.POSITION_AFTER_START), v = 0);
                Q.collapse()
              }
            }
            1 != E.length ? U = !1 : (U = E[0], U = U.isElement && "false" == U.node.getAttribute("contenteditable"));
            U && (t = !0, M = E[0].node, Q.setStartAt(M, CKEDITOR.POSITION_BEFORE_START), Q.setEndAt(M, CKEDITOR.POSITION_AFTER_END));
            l.dontMoveCaret = t;
          ...
          if (aa) for (; T = aa.pop();) CKEDITOR.env.needsBrFiller ? T.appendBogus() : T.append(U.document.createText(" "));
          for (; T = l.mergeCandidates.pop();) T.mergeSiblings();
          U.moveToBookmark(ba);
          if (!l.dontMoveCaret) {
            for (T =
                   g(U); T && a(T) && !T.is(n.$empty);) {
              if (T.isBlockBoundary()) U.moveToPosition(T, CKEDITOR.POSITION_BEFORE_END); else {
                if (d(T) && T.getHtml().match(/(\s|&nbsp;)$/g)) {
                  ga = null;
                  break
                }
                ga = U.clone();
    ...
    r = function () {
      ...
      return function (f) {
        var e = f.startContainer, g = e.getAscendant("table", 1), d = !1;
        c(g.getElementsByTag("td"));
        c(g.getElementsByTag("th"));
        g = f.clone();
        g.setStart(e, 0);
        g = a(g).lastBackward();
        g || (g = f.clone(), g.setEndAt(e, CKEDITOR.POSITION_BEFORE_END),
          g = a(g).lastForward(), d = !0);
        g || (g = e);
        g.is("table") ? (f.setStartAt(g, CKEDITOR.POSITION_BEFORE_START), f.collapse(!0), g.remove()) : (g.is({
          tbody: 1,
          thead: 1,
          tfoot: 1
        }) && (g = b(g, "tr", d)), g.is("tr") && (g = b(g, g.getParent().is("thead") ? "th" : "td", d)), (e = g.getBogus()) && e.remove(), f.moveToPosition(g, d ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END))
      }
    }();
    u = function () {
      function a(b) {
      ...
      return function (b) {
        var c = b.startContainer, f = !1, e;
        e = b.clone();
        e.setStart(c, 0);
        e = a(e).lastBackward();
        e || (e = b.clone(), e.setEndAt(c, CKEDITOR.POSITION_BEFORE_END), e = a(e).lastForward(), f = !0);
        e || (e = c);
        e.is(CKEDITOR.dtd.$list) ? (b.setStartAt(e, CKEDITOR.POSITION_BEFORE_START), b.collapse(!0), e.remove()) : ((c = e.getBogus()) && c.remove(), b.moveToPosition(e, f ? CKEDITOR.POSITION_AFTER_START :
    ...
    t = {
      eol: {
        detect: function (a, b) {
          var c = a.range, f = c.clone(), e = c.clone(), g = new CKEDITOR.dom.elementPath(c.startContainer, b),
          ...
          var c = b.getDocument(), f;
          a.appendEolBr && (f =
            this.createEolBr(c), a.fragment.append(f));
          !a.prependEolBr || f && !f.getPrevious() || a.fragment.append(this.createEolBr(c), 1)
        ...
        rebuild: function (a, b) {
          var c = a.range, f = c.getCommonAncestor(), e = new CKEDITOR.dom.elementPath(f, b),
            g = new CKEDITOR.dom.elementPath(c.startContainer, b),
            c = new CKEDITOR.dom.elementPath(c.endContainer, b), d;
          ...
          for (var e; c && !c.equals(b) && f(c);) e = c.clone(0, 1), a.fragment.appendTo(e), a.fragment = e, c = c.getParent()
        }
      }, cell: {
        shrink: function (a) {
          a = a.range;
          var b = a.startContainer, c = a.endContainer, f = a.startOffset, e = a.endOffset;
      ...
      return {
        list: {
          detectMerge: function (a, b) {
            var f = c(b, a.bookmark), e = f.startPath(), g = f.endPath(), d = e.contains(CKEDITOR.dtd.$list),
            ...
            if (a.mergeListBookmark) {
              var f = a.mergeListBookmark.startNode, e = a.mergeListBookmark.endNode,
                g = new CKEDITOR.dom.elementPath(f, c), d = new CKEDITOR.dom.elementPath(e, c);
              if (a.mergeList) {
                var h = g.contains(CKEDITOR.dtd.$list), m = d.contains(CKEDITOR.dtd.$list);
                h.equals(m) || (m.moveChildren(h), m.remove())
              }
              a.mergeListItems && (g = g.contains(CKEDITOR.dtd.$listItem),
                d = d.contains(CKEDITOR.dtd.$listItem), g.equals(d) || b(d, f, e));
              f.remove();
              e.remove()
            }
          }
          ...
          detectMerge: function (a, b) {
            ...
            if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
              var f = a.mergeBlockBookmark.startNode, e = a.mergeBlockBookmark.endNode,
                g = new CKEDITOR.dom.elementPath(f, c), d = new CKEDITOR.dom.elementPath(e,
                c), g = g.block, d = d.block;
          ...
          function a(c) {
            var e = [], g, d = new CKEDITOR.dom.walker(c), h = c.startPath().contains(f), m = c.endPath().contains(f),
              k = {};
            d.guard = function (a, d) {
              if (a.type == CKEDITOR.NODE_ELEMENT) {
                var l = "visited_" + (d ? "out" : "in");
                if (a.getCustomData(l)) return;
                CKEDITOR.dom.element.setMarker(k, a, l, 1)
              }
              if (d && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(g); else if (!d && m && a.equals(m)) g = c.clone(), g.setStartAt(m,
                CKEDITOR.POSITION_AFTER_START), e.push(g); else {
                if (l = !d) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(f) && (!h || b(a, h)) && (!m || b(a, m));
                if (!l && (l = d)) if (a.is(f)) var l = h && h.getAscendant("table", !0),
                  n = m && m.getAscendant("table", !0), p = a.getAscendant("table", !0),
                  l = l && l.contains(p) || n && n.contains(p); else l = void 0;
          ...
          function b(a, c) {
            var f = CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED, e = a.getPosition(c);
          ...
          return {
            detectPurge: function (a) {
              ...
              if (1 < e) {
                ...
                c && g && b.checkBoundaryOfElement(c, CKEDITOR.START) && b.checkBoundaryOfElement(g, CKEDITOR.END) && (b = a.range.clone(), b.setStartBefore(c),
                  b.setEndAfter(g), a.purgeTableBookmark = b.createBookmark())
              }
            }, detectRanges: function (e, g) {
              var d = c(g, e.bookmark), h = d.clone(), m, k, l = d.getCommonAncestor();
              ...
              l = l.contains("table");
              k = k.contains("table");
              if (l || k) l && k && b(l, k) ? (e.tableSurroundingRange = h, h.setStartAt(l, CKEDITOR.POSITION_AFTER_END), h.setEndAt(k, CKEDITOR.POSITION_BEFORE_START),
    ...
    function d(b, c) {
      ...
      if (f) return !1;
      for (e = 0; e < b.length; e++) if (f = b[e]._getTableElement(), !f) return !1;
      return !0
    }
    ...
    function c(a) {
      a = b(a);
      var c = "", f = [], e, g;
      for (g = 0; g < a.length; g++) e && !e.equals(a[g].getAscendant("tr")) ? (c += f.join("\t") + "\n", e = a[g].getAscendant("tr"), f = []) : 0 === g && (e = a[g].getAscendant("tr")), f.push(a[g].getText());
      return c += f.join("\t")
    }

    function g(a) {
      var b = this.root.editor, f = b.getSelection(1);
      this.reset();
      x = !0;
    ...
    function l() {
      ...
      if (b) {
        ...
        if (!(f = !c) && (f = !c.isHidden())) {
          ...
          if (a(f.getSelectedElement())) f = !1; else {
            var n = 1 === e.length && e[0].collapsed, g = d(e, !!CKEDITOR.env.webkit) && d(g);
            h = h && m ? h.equals(m) || m.contains(h) : !1;
            h && (n || g) ? (k && !l && f.selectRanges(e), f = !0) : f = !1
          }
          f = !f
        }
        f && (b.reset(), b = 0)
    ...
    function k() {
      C = !0;
      z || (e.call(this), z = CKEDITOR.tools.setTimeout(e, 200, this))
    }
    ...
    function m(a) {
      ...
      var c = a.startContainer, f = a.getPreviousNode(h, null, c), e = a.getNextNode(h, null, c);
      return b(f) || b(e, 1) || !(f || e || c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary() && c.getBogus()) ? !0 : !1
    }
    ...
    function n(a, b) {
      ...
      if (c) {
        if (!1 !== b) {
          var f = a.getDocument().getSelection().getNative(), e = f && "None" != f.type && f.getRangeAt(0),
            g = t.length;
          if (c.getLength() > g && e && e.intersectsNode(c.$)) {
            var d = [{node: f.anchorNode, offset: f.anchorOffset}, {node: f.focusNode, offset: f.focusOffset}];
            f.anchorNode == c.$ && f.anchorOffset > g && (d[0].offset -= g);
            f.focusNode == c.$ && f.focusOffset > g && (d[1].offset -= g)
          }
        }
        c.setText(p(c.getText(), 1));
        d && (c = a.getDocument().$, f = c.getSelection(),
          c = c.createRange(), c.setStart(d[0].node, d[0].offset), c.collapse(!0), f.removeAllRanges(), f.addRange(c), f.extend(d[1].node, d[1].offset))
      }
    }
    ...
    function q(a, b) {
      var c = b && CKEDITOR.tools.htmlEncode(b) || "\x26nbsp;",
        c = CKEDITOR.dom.element.createFromHtml('\x3cdiv data-cke-hidden-sel\x3d"1" data-cke-temp\x3d"1" style\x3d"' + (CKEDITOR.env.ie && 14 > CKEDITOR.env.version ? "display:none" : "position:fixed;top:0;left:-1000px") + '"\x3e' + c + "\x3c/div\x3e",
          a.document);
      a.fire("lockSnapshot");
      a.editable().append(c);
      var f = a.getSelection(1), e = a.createRange(), g = f.root.on("selectionchange", function (a) {
        a.cancel()
      }, null, null, 0);
    ...
    function w(a) {
      for (var b = 0; b < a.length; b++) {
        ...
        if (!c.collapsed) {
          if (c.startContainer.isReadOnly()) for (var f = c.startContainer, e; f && !((e = f.type == CKEDITOR.NODE_ELEMENT) && f.is("body") || !f.isReadOnly());) e && "false" == f.getAttribute("contentEditable") &&
          c.setStartAfter(f), f = f.getParent();
          f = c.startContainer;
          e = c.endContainer;
          var g = c.startOffset, d = c.endOffset, h = c.clone();
          ...
          f.evaluator = function (f) {
            if (f.type == CKEDITOR.NODE_ELEMENT && f.isReadOnly()) {
              ...
              f.getPosition(h.endContainer) & CKEDITOR.POSITION_CONTAINS || (e.setStartAfter(f),
    ...
    var r = "function" != typeof window.getSelection, u = 1, t = CKEDITOR.tools.repeat("​", 7),
      A = new RegExp(t + "( )?", "g"), x, z, C, y = CKEDITOR.dom.walker.invisible(1), B = function () {
        function a(b) {
          return function (a) {
        ...
        function b(a) {
          return function (b) {
            var c = b.editor, f = c.createRange(), e;
            if (!c.readOnly) return (e = f.moveToClosestEditablePosition(b.selected,
              a)) || (e = f.moveToClosestEditablePosition(b.selected, !a)), e && c.getSelection().selectRanges([f]), c.fire("saveSnapshot"), b.selected.remove(), e || (f.moveToElementEditablePosition(c.editable()), c.getSelection().selectRanges([f])), c.fire("saveSnapshot"), !1
          }
        }
    ...
    CKEDITOR.on("instanceCreated", function (a) {
      ...
      c.on("contentDom", function () {
        ...
        function f(a) {
          if (CKEDITOR.env.ie) {
            ...
            return a && "false" == b.getAttribute("contenteditable") &&
              b
          }
        }

        var e = c.document, g = CKEDITOR.document, d = c.editable(), h = e.getBody(), m = e.getDocumentElement(),
          p = d.isInline(), t, u;
        CKEDITOR.env.gecko && d.attachListener(d, "focus", function (a) {
          a.removeListener();
          0 !== t && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == d.$ && (a = c.createRange(), a.moveToElementEditStart(d), a.select())
        }, null, null, -2);
        d.attachListener(d, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
          t && CKEDITOR.env.webkit && (t = c._.previousActive && c._.previousActive.equals(e.getActive())) &&
          null != c._.previousScrollTop && c._.previousScrollTop != d.$.scrollTop && (d.$.scrollTop = c._.previousScrollTop);
          c.unlockSelection(t);
          t = 0
        }, null, null, -1);
        ...
        if (CKEDITOR.env.ie || p) r ? d.attachListener(d, "beforedeactivate", a, null, null, -1) : d.attachListener(c, "selectionCheck", a, null, null, -1), d.attachListener(d, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
          c.lockSelection(u);
          t = 1
        ...
        if (CKEDITOR.env.ie && !p) {
          ...
          d.attachListener(d, "mouseup", function (a) {
            2 == a.data.$.button && q && (c.document.$.documentElement.scrollLeft = q.x, c.document.$.documentElement.scrollTop = q.y);
            q = null
          });
          if ("BackCompat" != e.$.compatMode) {
              ...
              m.on("mousedown", function (a) {
                function b(a) {
                  ...
                  if (z) {
                    ...
                    z.setEndPoint(0 > w.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                    z.select()
                  }
                }
            ...
            if (7 <
              CKEDITOR.env.version && 11 > CKEDITOR.env.version) m.on("mousedown", function (a) {
              a.data.getTarget().is("html") && (g.on("mouseup", b), m.on("mouseup", b))
            })
          }
        }
        ...
        CKEDITOR.env.webkit && d.attachListener(e, "keydown", function (a) {
      ...
      c.on("loadSnapshot", function () {
        ...
        b && b.hasAttribute("data-cke-hidden-sel") && (b.remove(), CKEDITOR.env.gecko && (a = c.editable().getFirst(a)) && a.is("br") && a.getAttribute("_moz_editor_bogus_node") &&
        a.remove())
      }, null, null, 100);
      c.on("key", function (a) {
        if ("wysiwyg" == c.mode) {
    ...
    CKEDITOR.dom.selection = function (a) {
      ...
      a = this.getNative();
      var f, e;
      if (a) if (a.getRangeAt) f = (e = a.rangeCount && a.getRangeAt(0)) && new CKEDITOR.dom.node(e.commonAncestorContainer); else {
        try {
          e = a.createRange()
        } catch (g) {
        }
        f = e && CKEDITOR.dom.element.get(e.item && e.item(0) || e.parentElement())
      }
      if (!f || f.type != CKEDITOR.NODE_ELEMENT && f.type != CKEDITOR.NODE_TEXT || !this.root.equals(f) && !this.root.contains(f)) this._.cache.type = CKEDITOR.SELECTION_NONE,
        this._.cache.startElement = null, this._.cache.selectedElement = null, this._.cache.selectedText = "", this._.cache.ranges = new CKEDITOR.dom.rangeList;
      return this
    };
    var G = {
      img: 1,
    ...
    CKEDITOR.dom.selection.prototype = {
      getNative: function () {
        ...
        if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE; else if (1 == c.rangeCount) {
          var c = c.getRangeAt(0), f = c.startContainer;
        ...
        var a = r ? function () {
          ...
          var b = function (b, c) {
            ...
            for (var e = f.children, g, d, h = b.duplicate(), m = 0, k = e.length - 1, l = -1, n, p; m <= k;) if (l = Math.floor((m + k) / 2), g = e[l], h.moveToElementText(g), n = h.compareEndPoints("StartToStart", b), 0 < n) k = l - 1; else if (0 > n) m = l + 1; else return {
              container: f,
              offset: a(g)
            };
            if (-1 == l || l == e.length - 1 && 0 > n) {
              ...
              for (f = e.length; 0 < h && 0 < f;) d = e[--f], d.nodeType == CKEDITOR.NODE_TEXT && (p = d, h -= d.nodeValue.length);
            ...
            for (; 0 < h;) try {
              d = g[0 < n ? "previousSibling" : "nextSibling"], d.nodeType == CKEDITOR.NODE_TEXT && (h -= d.nodeValue.length, p = d), g = d
            } catch (r) {
          ...
          return function () {
            var a = this.getNative(), c = a && a.createRange(), f = this.getType();
            if (!a) return [];
            ...
            if (f == CKEDITOR.SELECTION_ELEMENT) {
              for (var f = [], e = 0; e < c.length; e++) {
                for (var g =
                  c.item(e), d = g.parentNode, h = 0, a = new CKEDITOR.dom.range(this.root); h < d.childNodes.length && d.childNodes[h] != g; h++) ;
        ...
        return function (b) {
          var c = this._.cache, f = c.ranges;
          f || (c.ranges = f = new CKEDITOR.dom.rangeList(a.call(this)));
          return b ? w(new CKEDITOR.dom.rangeList(f.slice())) : f
        }
        ...
        var b = this, c = CKEDITOR.tools.tryThese(function () {
          ...
          for (var a = b.getRanges()[0].clone(), c, f, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && G[c.getName()] && (f = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
          return f && f.$
        });
        ...
        var b = this.getNative(), b = r ? "Control" == b.type ? "" : b.createRange().text :
          b.toString();
        ...
        if (this.isLocked) {
          if (a) var b = this.getSelectedElement(), c = this.getRanges(), f = this.isFake;
          this.isLocked = 0;
          this.reset();
        ...
        var b =
          this.root.editor, c = b && b._.hiddenSelectionContainer;
        this.reset();
        if (c) for (var c = this.root, e, h = 0; h < a.length; ++h) e = a[h], e.endContainer.equals(c) && (e.endOffset = Math.min(e.endOffset, c.getChildCount()));
        if (a.length) if (this.isLocked) {
          ...
          a:{
            var p, t;
            if (1 == a.length && !(t = a[0]).collapsed && (l = t.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (t = t.clone(), t.shrink(CKEDITOR.SHRINK_ELEMENT,
              !0), (p = t.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT && (l = p), "false" == l.getAttribute("contenteditable"))) break a;
            l = void 0
          }
          if (l) this.fake(l); else if (b && b.plugins.tableselection && CKEDITOR.plugins.tableselection.isSupportedEnvironment && d(a) && !x) g.call(this, a); else {
            if (r) {
              p = CKEDITOR.dom.walker.whitespaces(!0);
              l = /\ufeff|\u00a0/;
              t = {table: 1, tbody: 1, tr: 1};
              1 < a.length && (b = a[a.length - 1], a[0].setEnd(b.endContainer, b.endOffset));
              b = a[0];
              a = b.collapsed;
              var u, v, q;
              if ((c = b.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT &&
                c.getName() in G && (!c.is("a") || !c.getText())) try {
              ...
              k ? (l = b.document.$.body.createTextRange(),
                l.moveToElementText(k.$), q.setEndPoint("EndToEnd", l), q.moveEnd("character", -1)) : (u = t.getNext(p), v = t.hasAscendant("pre"), u = !(u && u.getText && u.getText().match(l)) && (v || !t.hasPrevious() || t.getPrevious().is && t.getPrevious().is("br")), v = b.document.createElement("span"), v.setHtml("\x26#65279;"), v.insertBefore(t), u && b.document.createText("﻿").insertBefore(t));
              b.setStartBefore(t);
              t.remove();
              a ? (u ? (q.moveStart("character", -1), q.select(), b.document.$.selection.clear()) : q.select(), b.moveToPosition(v, CKEDITOR.POSITION_BEFORE_START),
                v.remove()) : (b.setEndBefore(k), k.remove(), q.select())
            } else {
              k = this.getNative();
              if (!k) return;
              this.removeAllRanges();
              for (q = 0; q < a.length; q++) {
                if (q < a.length - 1 && (u = a[q], v = a[q + 1], l = u.clone(), l.setStart(u.endContainer, u.endOffset), l.setEnd(v.startContainer, v.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), b = l.getCommonAncestor(), l = l.getEnclosedNode(), b.isReadOnly() || l && l.isReadOnly()))) {
                  v.setStart(u.startContainer, u.startOffset);
                  a.splice(q--, 1);
                  continue
                }
                b = a[q];
                v = this.document.$.createRange();
                b.collapsed && CKEDITOR.env.webkit && m(b) && (l = f(this.root), b.insertNode(l), (u = l.getNext()) && !l.getPrevious() && u.type == CKEDITOR.NODE_ELEMENT && "br" == u.getName() ? (n(this.root), b.moveToPosition(u, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
                v.setStart(b.startContainer.$, b.startOffset);
                try {
                  v.setEnd(b.endContainer.$, b.endOffset)
                } catch (w) {
                  if (0 <= w.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), v.setEnd(b.endContainer.$, b.endOffset); else throw w;
                }
                k.addRange(v)
              }
            }
        ...
        this.reset();
        q(c, b);
        var f = this._.cache, e = new CKEDITOR.dom.range(this.root);
        e.setStartBefore(a);
        e.setEndAfter(a);
    ...
    function b(c) {
      var f = c.document;
      if (c.collapsed) f = u(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
        var e = this.element, h = this._.definition, m, k = h.ignoreReadonly, l = k || h.includeReadonly;
        ...
        c.trim();
        var p = c.createBookmark(), t = p.startNode, r = p.endNode, q = t, z;
        if (!k) {
          var w =
            c.getCommonAncestor(), k = a(t, w), w = a(r, w);
          k && (q = k.getNextSourceNode(!0));
          w && (r = w)
        }
        for (q.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
          k = !1;
          if (q.equals(r)) q = null, k = !0; else {
            var A = q.type == CKEDITOR.NODE_ELEMENT ? q.getName() : null,
              w = A && "false" == q.getAttribute("contentEditable"), x = A && q.getAttribute("data-nostyle");
            if (A && q.data("cke-bookmark")) {
              q = q.getNextSourceNode(!0);
              continue
            }
            if (w && l && CKEDITOR.dtd.$block[A]) for (var y = q, B = g(y), C = void 0, G = B.length, ea = 0, y = G && new CKEDITOR.dom.range(y.getDocument()); ea <
            G; ++ea) {
              var C = B[ea], D = CKEDITOR.filter.instances[C.data("cke-filter")];
              if (D ? D.check(this) : 1) y.selectNodeContents(C), b.call(this, y)
            }
            B = A ? !n[A] || x ? 0 : w && !l ? 0 : d(q, r, h, J) : 1;
            if (B) if (C = q.getParent(), B = h, G = e, ea = m, !C || !(C.getDtd() || CKEDITOR.dtd.span)[G] && !ea || B.parentRule && !B.parentRule(C)) k = !0; else {
              if (z || A && CKEDITOR.dtd.$removeEmpty[A] && (q.getPosition(r) | J) != J || (z = c.clone(), z.setStartBefore(q)), A = q.type, A == CKEDITOR.NODE_TEXT || w || A == CKEDITOR.NODE_ELEMENT && !q.getChildCount()) {
                for (var A = q, F; (k = !A.getNext(I)) &&
                (F = A.getParent(), n[F.getName()]) && d(F, t, h, K);) A = F;
                z.setEndAfter(A)
              }
            } else k = !0;
            q = q.getNextSourceNode(x || w)
          }
          if (k && z && !z.collapsed) {
            for (var k = u(this, f), w = k.hasAttributes(), x = z.getCommonAncestor(), A = {}, B = {}, C = {}, G = {}, fa, H, ha; k && x;) {
              if (x.getName() == e) {
                for (fa in h.attributes) !G[fa] && (ha = x.getAttribute(H)) && (k.getAttribute(fa) == ha ? B[fa] = 1 : G[fa] = 1);
                for (H in h.styles) !C[H] && (ha = x.getStyle(H)) && (k.getStyle(H) == ha ? A[H] = 1 : C[H] = 1)
              }
              x = x.getParent()
            }
            ...
            w &&
            !k.hasAttributes() && (k = null);
            k ? (z.extractContents().appendTo(k), z.insertNode(k), v.call(this, k), k.mergeSiblings(), CKEDITOR.env.ie || k.$.normalize()) : (k = new CKEDITOR.dom.element("span"), z.extractContents().appendTo(k), z.insertNode(k), v.call(this, k), k.remove(!0));
            z = null
          }
        }
        c.moveToBookmark(p);
    ...
    function c(a) {
      function b() {
        for (var a = new CKEDITOR.dom.elementPath(f.getParent()), c = new CKEDITOR.dom.elementPath(l.getParent()), e = null, g = null, d = 0; d <
        a.elements.length; d++) {
          var h = a.elements[d];
      ...
      a.enlarge(CKEDITOR.ENLARGE_INLINE, 1);
      var c = a.createBookmark(), f = c.startNode, e = this._.definition.alwaysRemoveElement;
      if (a.collapsed) {
        for (var g = new CKEDITOR.dom.elementPath(f.getParent(), a.root), d, h = 0, m; h < g.elements.length &&
        (m = g.elements[h]) && m != g.block && m != g.blockLimit; h++) if (this.checkElementRemovable(m)) {
          var k;
          !e && a.collapsed && (a.checkBoundaryOfElement(m, CKEDITOR.END) || (k = a.checkBoundaryOfElement(m, CKEDITOR.START))) ? (d = m, d.match = k ? "start" : "end") : (m.mergeSiblings(), m.is(this.element) ? q.call(this, m) : w(m, x(this)[m.getName()]))
        }
        if (d) {
          e = f;
          for (h = 0; ; h++) {
            m = g.elements[h];
            if (m.equals(d)) break; else if (m.match) continue; else m = m.clone();
            m.append(e);
            e = m
          }
        ...
        var l = c.endNode,
          n = this;
        b();
        for (g = f; !g.equals(l);) d = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? q.call(this, g) : w(g, x(this)[g.getName()]), d.type == CKEDITOR.NODE_ELEMENT && d.contains(f) && (b(), d = f.getNext())), g = d
      }
      a.moveToBookmark(c);
    ...
    function e(a) {
      ...
      this._.enterMode && (c.enlargeBr =
        this._.enterMode != CKEDITOR.ENTER_BR);
      for (var f, e = a.document, g; f = c.getNextParagraph();) !f.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = u(this, e, f), m(f, g));
      a.moveToBookmark(b)
    }
    ...
    function h(a) {
      ...
      for (var f, e; f = c.getNextParagraph();) this.checkElementRemovable(f) && (f.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ?
        "p" : "div")) && f.copyAttributes(e), m(f, e)) : q.call(this, f));
      a.moveToBookmark(b)
    }
    ...
    function m(a, b) {
      ...
      var e = b && b.is("pre"), g = a.is("pre"), d = !e && g;
      if (e && !g) {
        g = b;
    ...
    function q(a, b) {
      var c = this._.definition, f = c.attributes, c = c.styles, e = x(this)[a.getName()],
        g = CKEDITOR.tools.isEmpty(f) &&
          CKEDITOR.tools.isEmpty(c), d;
      for (d in f) if ("class" != d && !this._.definition.fullMatch || a.getAttribute(d) == z(d, f[d])) b && "data-" == d.slice(0, 5) || (g = a.hasAttribute(d), a.removeAttribute(d));
      for (var h in c) this._.definition.fullMatch && a.getStyle(h) != z(h, c[h], !0) || (g = g || !!a.getStyle(h), a.removeStyle(h));
      w(a, e, B[a.getName()]);
      g && (this._.definition.alwaysRemoveElement ? r(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? r(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ?
        "p" : "div"))
    }

    function v(a) {
      for (var b = x(this), c = a.getElementsByTag(this.element), f, e = c.count(); 0 <= --e;) f = c.getItem(e), f.isReadOnly() || q.call(this, f, !0);
      for (var g in b) if (g != this.element) for (c = a.getElementsByTag(g), e = c.count() - 1; 0 <= e; e--) f = c.getItem(e), f.isReadOnly() || w(f, b[g])
    }

    function w(a, b, c) {
      if (b = b && b.attributes) for (var f = 0; f < b.length; f++) {
        var e = b[f][0], g;
        if (g = a.getAttribute(e)) {
          var d = b[f][1];
          (null === d || d.test && d.test(g) || "string" == typeof d && g == d) && a.removeAttribute(e)
        }
      }
      c || r(a)
    }
    ...
    function r(a, b) {
      if (!a.hasAttributes() ||
        b) if (CKEDITOR.dtd.$block[a.getName()]) {
        var c = a.getPrevious(H), f = a.getNext(H);
        !c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({br: 1}) || a.append("br", 1);
        !f || f.type != CKEDITOR.NODE_TEXT && f.isBlockBoundary({br: 1}) || a.append("br");
        a.remove(!0)
      } else c = a.getFirst(), f = a.getLast(), a.remove(!0), c && (c.type == CKEDITOR.NODE_ELEMENT && c.mergeSiblings(), f && !c.equals(f) && f.type == CKEDITOR.NODE_ELEMENT && f.mergeSiblings())
    }
    ...
    function t(a, b) {
      var c = b._.definition, f = c.attributes, c = CKEDITOR.style.getStyleText(c);
    ...
    function C(a, b) {
      ...
      "string" ==
      typeof a && (a = CKEDITOR.tools.parseCssText(a));
      "string" == typeof b && (b = CKEDITOR.tools.parseCssText(b, !0));
      for (var f in a) if (!(f in b) || c(b[f], f) != c(a[f], f) && "inherit" != a[f] && "inherit" != b[f]) return !1;
      return !0
    }

    function y(a, b, c) {
      var f = a.document, e = a.getRanges();
      b = b ? this.removeFromRange : this.applyToRange;
      var g, d;
      if (a.isFake && a.isInTable()) for (g = [], d = 0; d < e.length; d++) g.push(e[d].clone());
    ...
    var B = {
        ...
        audio: 1,
        video: 1
      }, D = /\s*(?:;\s*|$)/, F = /#\((.+?)\)/g, I = CKEDITOR.dom.walker.bookmark(0, 1),
      H = CKEDITOR.dom.walker.whitespaces(1);
    CKEDITOR.style = function (a, b) {
      if ("string" ==
        typeof a.type) return new CKEDITOR.style.customHandlers[a.type](a);
      var c = a.attributes;
    ...
    CKEDITOR.style.prototype = {
      apply: function (a) {
        ...
        this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? e : this.type == CKEDITOR.STYLE_OBJECT ? l : null;
        ...
        switch (this.type) {
          ...
          case CKEDITOR.STYLE_INLINE:
            for (var c = a.elements, f = 0, e; f < c.length; f++) if (e = c[f], this.type != CKEDITOR.STYLE_INLINE || e != a.block && e != a.blockLimit) {
        ...
        if ("string" == typeof this.element ? f == this.element : f in this.element) {
          ...
          if (f = c._AC) c = f; else {
            var f = {}, e = 0, g = c.attributes;
            if (g) for (var d in g) e++, f[d] = g[d];
            if (d = CKEDITOR.style.getStyleText(c)) f.style || e++, f.style = d;
            f._length = e;
            c = c._AC = f
          }
          if (c._length) {
            for (var h in c) if ("_length" !=
              h) if (f = a.getAttribute(h) || "", "style" == h ? C(c[h], f) : c[h] == f) {
              if (!b) return !0
            } else if (b) return !1;
            if (b) return !0
          } else return !0
        ...
        if (b = x(this)[a.getName()]) {
          ...
          for (c = 0; c < b.length; c++) if (f = b[c][0], f = a.getAttribute(f)) {
            var e = b[c][1];
            if (null === e) return !0;
            if ("string" == typeof e) {
              if (f == e) return !0
    ...
    CKEDITOR.style.getStyleText = function (a) {
      var b = a._ST;
      if (b) return b;
      var b = a.styles, c = a.attributes && a.attributes.style || "", f = "";
      c.length && (c = c.replace(D, ";"));
      for (var e in b) {
        var g = b[e], d = (e + ":" + g).replace(D, ";");
        "inherit" ==
        g ? f += d : c += d
      }
    ...
    attachStyleStateChange: function (a, d) {
      ...
      b || (b = this._.styleStateChangeCallbacks = [], this.on("selectionChange", function (a) {
        for (var g = 0; g < b.length; g++) {
          var d = b[g], k = d.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
          d.fn.call(this, k)
        }
      }));
      b.push({style: a, fn: d})
    ...
    for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit ||
    b in CKEDITOR.dtd.$empty || (d[b] = 1);
    CKEDITOR.dom.elementPath = function (b, g) {
      var l = null, k = null, e = [], h = b, m;
      ...
      do if (h.type == CKEDITOR.NODE_ELEMENT) {
        ...
        if (h.equals(g)) break;
        if (!k && (m = h.getName(), "true" == h.getAttribute("contenteditable") ? k = h : !l && d[m] && (l = h), a[m])) {
          if (m = !l && "div" == m) {
            a:{
              m = h.getChildren();
    ...
    compare: function (a) {
      ...
      a instanceof
      CKEDITOR.dom.element ? g = function (b) {
        return b.equals(a)
      ...
      var l = this.elements, k = l.length;
      d && (b ? c += 1 : --k);
      ...
      var d;
      return a in CKEDITOR.dtd.$block ? (d = this.contains(CKEDITOR.dtd.$intermediate) || this.root.equals(this.block) &&
        this.block || this.blockLimit, !!d.getDtd()[a]) : !0
    }, direction: function () {
    ...
    type: CKEDITOR.NODE_TEXT, getLength: function () {
      ...
      var d =
          this.$.parentNode, b = d.childNodes.length, c = this.getLength(), g = this.getDocument(),
    ...
    function a(a, c, g) {
      var d = a.serializable, k = c[g ? "endContainer" : "startContainer"], e = g ? "endOffset" : "startOffset",
        h = d ? c.document.getById(a.startNode) :
          a.startNode;
    ...
    var d = {
      createIterator: function () {
        var a = this, c = CKEDITOR.dom.walker.bookmark(), g = [], d;
        return {
          getNextRange: function (k) {
            d = void 0 === d ? 0 : d + 1;
            var e = a[d];
            if (e && 1 < a.length) {
              if (!d) for (var h = a.length - 1; 0 <= h; h--) g.unshift(a[h].createBookmark(!0));
              if (k) for (var m = 0; a[d + m + 1];) {
                var f = e.document;
                k = 0;
                h = f.getById(g[m].endNode);
                for (f = f.getById(g[m + 1].startNode); ;) {
                  h = h.getNextSourceNode(!1);
                  if (f.equals(h)) k = 1; else if (c(h) || h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary()) continue;
                  break
                }
                if (!k) break;
                m++
              }
              for (e.moveToBookmark(g.shift()); m--;) h =
                a[++d], h.moveToBookmark(g.shift()), e.setEnd(h.endContainer, h.endOffset)
            }
            return e
          }
        }
        ...
        for (var c = [], g, d = 0; d < this.length; d++) {
          ...
          for (var k = d + 1; k < this.length; k++) this[k] = a(g, this[k]), this[k] = a(g, this[k], !0)
        }
        return c
      }, createBookmarks2: function (a) {
    ...
    function d(b) {
      var c = CKEDITOR.skin["ua_" + b], e = CKEDITOR.env;
      if (c) for (var c = c.split(",").sort(function (a, b) {
        return a > b ? -1 : 1
      }), g = 0, d; g < c.length; g++) if (d = c[g], e.ie && (d.replace(/^ie/, "") == e.version || e.quirks && "iequirks" == d) && (d = "ie"), e[d]) {
        b += "_" + c[g];
        break
      }
    ...
    function c(a) {
      ...
      b || (b = a.getHead().append("style"), b.setAttribute("id",
        k), b.setAttribute("type", "text/css"));
      return b
    }

    function g(a, b, c) {
      var e, g, d;
      if (CKEDITOR.env.webkit) for (b = b.split("}").slice(0, -1), g = 0; g < b.length; g++) b[g] = b[g].split("{");
      for (var h = 0; h < a.length; h++) if (CKEDITOR.env.webkit) for (g = 0; g < b.length; g++) {
        d = b[g][1];
    ...
    CKEDITOR.skin =
      {
        path: a, loadPart: function (c, f) {
          ...
          g = g || d && d.bgsize ||
            "16px";
          a && (a = a.replace(/'/g, "\\'"));
          return a && "background-image:url('" + CKEDITOR.getUrl(a) + "');background-position:0 " + e + "px;background-size:" + g + ";"
        }
      };
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      getUiColor: function () {
        ...
        return (this.setUiColor = function (a) {
          this.uiColor = a;
          var c = CKEDITOR.skin.chameleon, d = "", m = "";
          "function" == typeof c && (d = c(this, "editor"), m = c(this, "panel"));
          a = [[h, a]];
          g([b], d, a);
          g(e, m, a)
        }).call(this, a)
      ...
      if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
        ...
        a = function (a) {
          ...
          if (!a.getById("cke_ui_color")) {
            ...
            e.push(a);
            var d = b.getUiColor();
            d && g([a], CKEDITOR.skin.chameleon(b, "panel"), [[h, d]])
          }
        };
        b.on("panelShow", a);
        b.on("menuShow", a);
    ...
    if (a = CKEDITOR._.pending) for (delete CKEDITOR._.pending, d = 0; d < a.length; d++) CKEDITOR.editor.prototype.constructor.apply(a[d][0],
      a[d][1]), CKEDITOR.add(a[d][0])
      ...
      onLoad: function () {
          ...
          labeledElement: function (b, c, f, e) {
            if (!(4 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.uiElement.call(this, b, c, f, "div", null, d, function () {
                var a = [], f = c.required ? " cke_required" : "";
            ...
            if (!(3 > arguments.length)) {
              a.call(this, c);
              var g = this, d = this._.inputId = CKEDITOR.tools.getNextId() + "_textarea", k = {};
              c.validate && (this.validate = c.validate);
              k.rows = c.rows || 5;
              k.cols = c.cols || 20;
              ...
              if (g.bidi) b.on("load",
                function () {
                  g.getInputElement().on("keyup", e)
                }, g);
              CKEDITOR.ui.dialog.labeledElement.call(this, b, c, f, function () {
                k["aria-labelledby"] = this._.labelId;
                this._.required && (k["aria-required"] = this._.required);
                var a = ['\x3cdiv class\x3d"cke_dialog_ui_input_textarea" role\x3d"presentation"\x3e\x3ctextarea id\x3d"', d, '" '],
                  b;
            ...
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.uiElement.call(this, b, c, f, "span", null, null, function () {
                var a = CKEDITOR.tools.extend({}, c, {id: c.id ? c.id + "_checkbox" : CKEDITOR.tools.getNextId() + "_checkbox"}, !0),
                  f = [], g = CKEDITOR.tools.getNextId() + "_label",
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this,
                b, c, f, function () {
                  for (var a = [], f = [], d = (c.id ? c.id : CKEDITOR.tools.getNextId()) + "_radio", l = 0; l < c.items.length; l++) {
                    var u = c.items[l], t = void 0 !== u[2] ? u[2] : u[0], A = void 0 !== u[1] ? u[1] : u[0],
                      x = CKEDITOR.tools.getNextId() + "_radio_input", z = x + "_label",
                      x = CKEDITOR.tools.extend({}, c, {id: x, title: null, type: null}, !0),
                      t = CKEDITOR.tools.extend({}, x, {title: t}, !0), C = {
                        type: "radio",
                    ...
                    e.push(new CKEDITOR.ui.dialog.uiElement(b, x, y, "input", null, C));
                    y.push(" ");
                    new CKEDITOR.ui.dialog.uiElement(b, t, y, "label", null, {id: z, "for": C.id}, u[0]);
                    a.push(y.join(""))
                  }
            ...
            if (arguments.length) {
              ...
              CKEDITOR.ui.dialog.uiElement.call(this, b, g, f, "a", null, {
                ...
                role: "button",
                "aria-labelledby": d
              }, '\x3cspan id\x3d"' + d + '" class\x3d"cke_dialog_ui_button"\x3e' +
            ...
            if (!(3 > arguments.length)) {
              a.call(this, c);
              c.validate && (this.validate = c.validate);
              var g = CKEDITOR.tools.extend({}, c), d = g.onClick;
            ...
            return function (e, g, d) {
              if (!(3 > arguments.length)) {
                ...
                if (r) {
                  var u = this.focus;
                  this.focus = function () {
                    ("function" == typeof r ? r : u).call(this);
                    this.fire("focus")
                  };
        ...
        CKEDITOR.ui.dialog.select.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, {
          getInputElement: function () {
            ...
            void 0 === c || null === c ? CKEDITOR.env.ie ? g.add(e.$) : g.add(e.$, null) : g.add(e.$, c);
            return this
          }, remove: function (a) {
        ...
        CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, c, {
          getInputElement: function () {
            ...
            var b = /^on([A-Z]\w+)/, c, e = function (a, b, c, f) {
              a.on("formLoaded", function () {
                a.getInputElement().on(c, f, a)
              })
            }, g;
            for (g in a) if (c = g.match(b)) this.eventProcessors[g] ? this.eventProcessors[g].call(this, this._.dialog, a[g]) : e(this, this._.dialog, c[1].toLowerCase(), a[g]);
            return this
          }, reset: function () {
            function a() {
              c.$.open();
            ...
            var b = this._, c = CKEDITOR.document.getById(b.frameId).getFrameDocument(), e = b.definition,
              g = b.buttons, d = this.formLoadedNumber, k = this.formUnloadNumber, l = b.dialog._.editor.lang.dir,
              r = b.dialog._.editor.langCode;
            d || (d = this.formLoadedNumber = CKEDITOR.tools.addFunction(function () {
        ...
        CKEDITOR.dialog.addUIElement("fieldset", {
          build: function (a, b, c) {
            for (var e = b.children, g, d = [], k = [], l = 0; l < e.length && (g = e[l]); l++) {
              var r = [];
              d.push(r);
              k.push(CKEDITOR.dialog._.uiElementBuilders[g.type].build(a, g, r))
            }
            return new CKEDITOR.ui.dialog[b.type](a, k, d, c, b)
          }
        })
      }
    ...
    function l(a) {
      ...
      })), c = b.getChild([0, 0, 0, 0, 0]), f = c.getChild(0), e = c.getChild(1);
    ...
    function m(a) {
      function b(c) {
        var k = a.getSize(), m = CKEDITOR.document.getWindow().getViewPaneSize(), l = c.data.$.screenX,
          n = c.data.$.screenY, t = l - f.x, r = n - f.y;
        f = {x: l, y: n};
        e.x += t;
        e.y += r;
      ...
      var f = null, e = null, g = a.getParentEditor(), d = g.config.dialog_magnetDistance,
    ...
    function f(a) {
      function b(c) {
        var n = "rtl" == g.lang.dir, t = l.width, r = l.height,
          p = t + (c.data.$.screenX - m.x) * (n ? -1 : 1) * (a._.moved ? 1 : 2),
          u = r + (c.data.$.screenY - m.y) * (a._.moved ? 1 : 2), v = a._.element.getFirst(),
          v = n && v.getComputedStyle("right"), q = a.getPosition();
        q.y + u > k.height && (u = k.height - q.y);
        (n ? v : q.x) + p > k.width && (p = k.width - (n ? v : q.x));
        if (e == CKEDITOR.DIALOG_RESIZE_WIDTH || e == CKEDITOR.DIALOG_RESIZE_BOTH) t = Math.max(f.minWidth ||
          0, p - d);
        if (e == CKEDITOR.DIALOG_RESIZE_HEIGHT || e == CKEDITOR.DIALOG_RESIZE_BOTH) r = Math.max(f.minHeight || 0, u - h);
        a.resize(t, r);
        a._.moved || a.layout();
        c.data.preventDefault()
      }
      ...
      var f = a.definition, e = f.resizable;
      if (e != CKEDITOR.DIALOG_RESIZE_NONE) {
        var g = a.getParentEditor(),
          d, h, k, m, l, n, t = CKEDITOR.tools.addFunction(function (f) {
            l = a.getSize();
            ...
            CKEDITOR.document.on("mousemove", b);
            CKEDITOR.document.on("mouseup", c);
            CKEDITOR.env.ie6Compat && (e = y.getChild(0).getFrameDocument(), e.on("mousemove", b), e.on("mouseup", c));
        ...
        a.on("load", function () {
          ...
          b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + g.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(g.lang.common.resize) +
            '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + t + ', event )"\x3e' + ("ltr" == g.lang.dir ? "◢" : "◣") + "\x3c/div\x3e");
    ...
    function p(a) {
      var b = CKEDITOR.document.getWindow(), c = a.config, f = CKEDITOR.skinName || a.config.skin,
        e = c.dialog_backgroundCoverColor || ("moono-lisa" == f ? "black" : "white"),
        f = c.dialog_backgroundCoverOpacity, g = c.baseFloatZIndex, c = CKEDITOR.tools.genKey(e, f, g), d = C[c];
      d ? d.show() :
    ...
    function q(a) {
      y && (a.focusManager.remove(y), a = CKEDITOR.document.getWindow(), y.hide(), a.removeListener("resize", z), CKEDITOR.env.ie6Compat && a.$.setTimeout(function () {
    ...
    CKEDITOR.dialog = function (b, e) {
      ...
      function k(a) {
        ...
        if (!(1 > b.length)) {
          ...
          var e = c, g = 1 < B._.pageCount;
          do {
            e += a;
            if (g && !B._.tabBarMode && (e == b.length || -1 == e)) {
              B._.tabBarMode = !0;
      ...
      function n(c) {
        if (B == CKEDITOR.dialog._.currentTop) {
          var f = c.data.getKeystroke(), e = "rtl" == b.lang.dir, g = [37, 38, 39, 40];
          A = y = 0;
          if (9 == f || f == CKEDITOR.SHIFT + 9) k(f == CKEDITOR.SHIFT + 9 ? -1 : 1), A = 1; else if (f == CKEDITOR.ALT + 121 && !B._.tabBarMode && 1 < B.getPageCount()) B._.tabBarMode = !0, B._.tabs[B._.currentTabId][0].focus(), B._.currentFocusIndex = -1, A = 1; else if (-1 != CKEDITOR.tools.indexOf(g,
            f) && B._.tabBarMode) f = -1 != CKEDITOR.tools.indexOf([e ? 39 : 37, 38], f) ? a.call(B) : d.call(B), B.selectPage(f), B._.tabs[f][0].focus(), A = 1; else if (13 != f && 32 != f || !B._.tabBarMode) if (13 == f) f = c.data.getTarget(), f.is("a", "button", "select", "textarea") || f.is("input") && "button" == f.$.type || ((f = this.getButton("ok")) && CKEDITOR.tools.setTimeout(f.click, 0, f), A = 1), y = 1; else if (27 == f) (f = this.getButton("cancel")) ? CKEDITOR.tools.setTimeout(f.click, 0, f) : !1 !== this.fire("cancel", {hide: !0}).hide && this.hide(), y = 1; else return; else this.selectPage(this._.currentTabId),
            this._.tabBarMode = !1, this._.currentFocusIndex = -1, k(1), A = 1;
          t(c)
        }
      }

      function t(a) {
        A ? a.data.preventDefault(1) : y && a.data.stopPropagation()
      }

      var p = CKEDITOR.dialog._.dialogDefinitions[e], u = CKEDITOR.tools.clone(r),
        v = b.config.dialog_buttonsOrder || "OS", q = b.lang.dir, z = {}, A, y;
      ("OS" == v && CKEDITOR.env.mac || "rtl" == v && "ltr" == q || "ltr" == v && "rtl" == q) && u.buttons.reverse();
      ...
      if (b._.removeDialogTabs && (z = b._.removeDialogTabs[e])) for (q = 0; q < z.length; q++) p.removeContents(z[q]);
      ...
      var B = this, N = function (a) {
        var b = B._.contents, c = !1, f;
        for (f in b) for (var e in b[f]) if (c = a.call(this, b[f][e])) return
      };
      this.on("ok", function (a) {
        N(function (b) {
          if (b.validate) {
            var f = b.validate(this), e = "string" == typeof f || !1 === f;
      ...
      this.on("show", function () {
        ...
        b.config.dialog_startupFocusTab && a ? (B._.tabBarMode = !0, B._.tabs[B._.currentTabId][0].focus(), B._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = a ? -1 : this._.focusList.length - 1, p.onFocus ?
      ...
      for (q = 0; q < p.contents.length; q++) (z = p.contents[q]) && this.addPage(z);
      ...
      for (q = 0; q < z.length; q++) this._.buttons[z[q].id] = z[q]
    };
    CKEDITOR.dialog.prototype = {
      destroy: function () {
        ...
        var f = this._.element.getFirst(), e = "rtl" == this._.editor.lang.dir,
        ...
        for (var c in b.contents) if (b.contents[c]) {
          var a = b.contents[c], f = this._.tabs[a.id], g = a.requiredContent, d = 0;
          if (f) {
            for (var h in this._.contents[a.id]) {
              var k = this._.contents[a.id][h];
              "hbox" != k.type && "vbox" != k.type && k.getInputElement() && (k.requiredContent && !this._.editor.activeFilter.check(k.requiredContent) ? k.disable() : (k.enable(), d++))
            }
            !d || g && !this._.editor.activeFilter.check(g) ? f[0].addClass("cke_dialog_tab_disabled") :
        ...
        var a = this.parts.dialog, b = this.getSize(), c = CKEDITOR.document.getWindow().getViewPaneSize(), f =
          (c.width - b.width) / 2, e = (c.height - b.height) / 2;
      ...
      setupContent: function () {
        ...
        if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
          ...
          c = CKEDITOR.dom.element.createFromHtml(['\x3ca class\x3d"cke_dialog_tab"',
            0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ? ' style\x3d"display:none"' : "", ' id\x3d"', e, '"', f.gecko && !f.hc ? "" : ' href\x3d"javascript:void(0)"', ' tabIndex\x3d"-1" hidefocus\x3d"true" role\x3d"tab"\x3e', a.label, "\x3c/a\x3e"].join(""));
        ...
        if (this._.currentTabId != a && !this._.tabs[a][0].hasClass("cke_dialog_tab_disabled") && !1 !== this.fire("selectPage", {
          ...
          for (var c in this._.tabs) {
            var f = this._.tabs[c][0], e = this._.tabs[c][1];
    ...
    var r = {
      ...
      for (var f = 0, e; e = a[f]; f++) if (e.id == b || c && e[c] && (e = u(e[c], b, c))) return e;
      return null
    }, t = function (a, b, c, f, e) {
      if (c) {
        for (var g = 0, d; d = a[g]; g++) {
          if (d.id == c) return a.splice(g, 0, b), b;
          if (f && d[f] && (d = t(d[f], b, c, f, !0))) return d
        }
        if (e) return null
      }
      a.push(b);
      ...
      this.dialog = a;
      for (var c = b.contents, f = 0, e; e = c[f]; f++) c[f] = e && new h(a, e);
      CKEDITOR.tools.extend(this, b)
    };
    x.prototype = {
      getContents: function (a) {
        return u(this.contents, a)
      }, getButton: function (a) {
        return u(this.buttons, a)
    ...
    var z, C = {}, y, B = {}, G = function (a) {
      var b = a.data.$.ctrlKey || a.data.$.metaKey, c = a.data.$.altKey, f = a.data.$.shiftKey,
        e = String.fromCharCode(a.data.$.keyCode);
      (b = B[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (f ? "SHIFT+" : "") + e]) && b.length && (b = b[b.length - 1], b.keydown && b.keydown.call(b.uiElement, b.dialog, b.key), a.data.preventDefault())
    }, D = function (a) {
      var b = a.data.$.ctrlKey || a.data.$.metaKey, c = a.data.$.altKey,
        f = a.data.$.shiftKey, e = String.fromCharCode(a.data.$.keyCode);
      (b = B[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (f ? "SHIFT+" : "") + e]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key), a.data.preventDefault()))
    ...
    (function () {
      CKEDITOR.ui.dialog = {
        uiElement: function (a, b, c, f, e, g, d) {
          if (!(4 > arguments.length)) {
            var h = (f.call ? f(b) : f) || "div", k = ["\x3c", h, " "], m = (e && e.call ? e(b) : e) || {},
              l = (g && g.call ? g(b) : g) || {}, n = (d && d.call ? d.call(this, a, b) : d) || "",
            ...
            for (var r = l["class"] && l["class"].split ? l["class"].split(" ") : [], t = 0; t < r.length; t++) r[t] && (p[r[t]] = 1);
            r = [];
            for (t in p) r.push(t);
            l["class"] = r.join(" ");
            b.title && (l.title = b.title);
            p = (b.style || "").split(";");
            b.align && (r = b.align, m["margin-left"] = "left" == r ? 0 : "auto", m["margin-right"] = "right" == r ? 0 : "auto");
          ...
          if (!(3 > arguments.length)) {
            this._ || (this._ = {});
            var g = this._.children = b, d = e && e.width || null, h = e && e.heights || null;
            CKEDITOR.ui.dialog.uiElement.call(this, a, e || {type: "vbox"}, f, "div", null, {role: "presentation"}, function () {
              ...
              for (var f = 0; f < c.length; f++) {
                ...
                h ? k.push("height:" + v(h[f])) : e && e.expand && k.push("height:" + Math.floor(100 / c.length) + "%");
    ...
    CKEDITOR.ui.dialog.uiElement.prototype = {
      ...
      setValue: function (a, b) {
        ...
        for (e in a) if (c = e.match(b)) this.eventProcessors[e] ? this.eventProcessors[e].call(this, this._.dialog, a[e]) : f(this, this._.dialog, c[1].toLowerCase(), a[e]);
        return this
      }, eventProcessors: {
        onLoad: function (a, b) {
          a.on("load", b, this)
    ...
    (function () {
      var a = {
        build: function (a, b, c) {
          for (var f = b.children, e, g = [], d = [], h = 0; h < f.length && (e = f[h]); h++) {
            var k = [];
            g.push(k);
    ...
    (function () {
      var a = /^([a]|[^a])+$/, b = /^\d*$/, c = /^\d*(?:\.\d+)?$/, f = /^(((\d*(\.\d+))|(\d*))(px|\%)?)?$/,
      ...
      CKEDITOR.dialog.validate = {
        functions: function () {
          var a = arguments;
          return function () {
            var b = this && this.getValue ? this.getValue() : a[0], c, f = CKEDITOR.VALIDATE_AND, e = [], g;
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      openDialog: function (a, b) {
        ...
        if ("function" == typeof f) c = this._.storedDialogs || (this._.storedDialogs = {}), c = c[a] || (c[a] = new CKEDITOR.dialog(this, a)), b && b.call(c, c), c.show(); else {
    ...
    init: function (a) {
      var d = 0, b = function (b, e, g, m) {
        if (m) {
          m = new CKEDITOR.style(m);
          var f = c[g];
          f.unshift(m);
          a.attachStyleStateChange(m, function (b) {
            !a.readOnly && a.getCommand(g).setState(b)
          });
      ...
      }, g = a.config, l = a.lang.basicstyles;
    ...
    function a(a, b, c, e) {
      if (!a.isReadOnly() && !a.equals(c.editable())) {
        ...
        e = a;
        for (var g = c.editable(); (e = e.getParent()) && !e.equals(g);) if (e.getCustomData("bidi_processed")) {
    ...
    function b(b) {
      return {
        ...
        refresh: function (a, b) {
          var c = a.config.useComputedState, f, c = void 0 === c || c;
          if (!c) {
            f = b.lastElement;
            for (var e = a.editable(); f && !(f.getName() in k || f.equals(e));) {
              var g = f.getParent();
              if (!g) break;
              f = g
            }
        ...
        exec: function (c) {
          var e = c.getSelection(), h = c.config.enterMode, k = e.getRanges();
          if (k && k.length) {
            for (var m = {}, r = e.createBookmarks(), k = k.createIterator(), u, t = 0; u = k.getNextRange(1);) {
              var A = u.getEnclosedNode();
              A && (!A || A.type == CKEDITOR.NODE_ELEMENT && A.getName() in l) || (A = d(u, g, h));
              A && a(A, b, c, m);
              var x = new CKEDITOR.dom.walker(u), z = r[t].startNode, C = r[t++].endNode;
              x.evaluator = function (a) {
              ...
              for (; A = x.next();) a(A, b, c, m);
              u = u.createIterator();
              for (u.enlargeBr = h != CKEDITOR.ENTER_BR; A = u.getNextParagraph(h == CKEDITOR.ENTER_P ? "p" : "div");) a(A, b, c, m)
            }
    ...
    function c(a) {
      var b =
        a == e.setAttribute, c = a == e.removeAttribute, g = /\bdirection\s*:\s*(.*?)\s*(:?$|;)/;
      return function (e, d) {
        if (!this.isReadOnly()) {
          var h;
          if (h = e == (b || c ? "dir" : "direction") || "style" == e && (c || g.test(d))) {
            a:{
              h = this;
              for (var k = h.getDocument().getBody().getParent(); h;) {
                if (h.equals(k)) {
                  h = !1;
                  break a
                }
          ...
          if (h && (h = this.getDirection(1), k = a.apply(this, arguments), h != this.getDirection(1))) return this.getDocument().fire("dirChanged", this), k
        }
    ...
    CKEDITOR.plugins.add("bidi", {
      init: function (a) {
        function c(b, e, g, d, h) {
          a.addCommand(g, new CKEDITOR.command(a, d));
    ...
    var a = {
      exec: function (a) {
        var b = a.getCommand("blockquote").state, c = a.getSelection(), g = c && c.getRanges()[0];
        if (g) {
          var l = c.createBookmarks();
          if (CKEDITOR.env.ie) {
            var k =
              l[0].startNode, e = l[0].endNode, h;
            if (k && "blockquote" == k.getParent().getName()) for (h = k; h = h.getNext();) if (h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary()) {
              k.move(h, !0);
              break
            }
            if (e && "blockquote" == e.getParent().getName()) for (h = e; h = h.getPrevious();) if (h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary()) {
              e.move(h);
              break
            }
          }
          ...
          if (b == CKEDITOR.TRISTATE_OFF) {
            ...
            for (; 0 < g.length;) if (b =
              ...
              for (e = new CKEDITOR.dom.documentFragment(a.document); b.getFirst();) e.append(b.getFirst().remove()), k.push(e.getLast());
              e.replace(b)
            } else k.push(b);
            ...
            for (e = k.length - 1; 0 <= e; e--) {
              ...
              a:{
                h = g;
                for (var m = 0, f = h.getChildCount(), n = void 0; m < f && (n = h.getChild(m)); m++) if (n.type == CKEDITOR.NODE_ELEMENT && n.isBlockBoundary()) {
                  h = !1;
                  break a
                }
                h = !0
            ...
            if (a.config.enterMode == CKEDITOR.ENTER_BR) for (g = !0; b.length;) if (m = b.shift(), "div" == m.getName()) {
    ...
    a.prototype = {
      ...
      update: function (a) {
        ...
        var g = this.element, d = g.findOne(".cke_notification_message"), k = g.findOne(".cke_notification_progress"),
          e = a.type;
        ...
        var a = this, c, g, d = this.editor.lang.common.close;
        ...
        if ("number" == typeof this.duration) c = this.duration; else if ("info" == this.type || "success" == this.type) c = "number" == typeof this.editor.config.notification_duration ? this.editor.config.notification_duration : 5E3;
    ...
    d.prototype = {
      add: function (a) {
        ...
        var a = this.editor, c = a.config, g = new CKEDITOR.dom.element("div");
        ...
        var a = CKEDITOR.document.getWindow(), c = this.editor;
        ...
        function a() {
          c.setStyle("left", u(t + d.width - n - p))
        }

        var c = this.element, g = this.editor, d = g.ui.contentsElement.getClientRect(),
          k = g.ui.contentsElement.getDocumentPosition(), e, h, m = c.getClientRect(), f, n = this._notificationWidth,
          p = this._notificationMargin;
        f = CKEDITOR.document.getWindow();
        var q = f.getScrollPosition(), v = f.getViewPaneSize(), w = CKEDITOR.document.getBody(),
          r = w.getDocumentPosition(), u = CKEDITOR.tools.cssLength;
        ...
        e && e.isVisible() && h.bottom > d.top && h.bottom < d.bottom - m.height ? c.setStyles({
          position: "fixed",
          top: u(h.bottom)
        }) : 0 < d.top ? c.setStyles({
          position: "absolute",
          top: u(k.y)
        }) : k.y + d.height - m.height > q.y ? c.setStyles({position: "fixed", top: 0}) : c.setStyles({
          position: "absolute",
          top: u(k.y + d.height - m.height)
        });
        var t = "fixed" == c.getStyle("position") ? d.left : "static" != w.getComputedStyle("position") ? k.x - r.x : k.x;
        d.width < n + p ? k.x + n + p > q.x + v.width ? a() : c.setStyle("left", u(t)) : k.x + n + p > q.x + v.width ? c.setStyle("left", u(t)) : k.x + d.width / 2 + n / 2 + p > q.x + v.width ? c.setStyle("left", u(t - k.x + q.x + v.width - n - p)) : 0 > d.left + d.width - n - p ? a() : 0 > d.left + d.width / 2 - n / 2 ? c.setStyle("left", u(t - k.x + q.x)) : c.setStyle("left", u(t + d.width / 2 - n / 2 - p / 2))
      }
    };
    ...
    CKEDITOR.ui.button.prototype = {
      render: function (a, g) {
        ...
        var k = null, e = CKEDITOR.env, h = this._.id = CKEDITOR.tools.getNextId(), m = "", f = this.command, n, p, q;
        this._.editor = a;
        var v = {
          id: h, button: this, editor: a, focus: function () {
        ...
        }, this), m += f.state == CKEDITOR.TRISTATE_ON ? "on" : f.state == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off");
        var t;
        if (this.directional) a.on("contentDirChanged", function (b) {
          var f = CKEDITOR.document.getById(this._.id), e = f.getFirst();
          b = b.data;
        ...
        var A = null, x = this.icon;
        t = p;
        this.icon && !/\./.test(this.icon) ? (t = this.icon, x = null) : (this.icon && (A = this.icon), CKEDITOR.env.hidpi && this.iconHiDpi && (A = this.iconHiDpi));
        A ? (CKEDITOR.skin.addIcon(A, A), x = null) : A = t;
        m = {
          id: h,
          name: p,
          iconName: t,
          ...
          focusFn: r,
          clickFn: n,
          style: CKEDITOR.skin.getIconStyle(A, "rtl" == a.lang.dir, x, this.iconOffset),
    ...
    function a(a) {
      function b() {
        for (var f = c(), h = CKEDITOR.tools.clone(a.config.toolbarGroups) || d(a), m = 0; m < h.length; m++) {
          var l = h[m];
          if ("/" != l) {
            "string" == typeof l && (l = h[m] = {name: l});
            var w, r = l.groups;
            if (r) for (var u = 0; u < r.length; u++) w = r[u], (w = f[w]) && e(l, w);
            (w = f[l.name]) && e(l, w)
          }
        }
        return h
      ...
      function c() {
        var b = {}, f, e, d;
        for (f in a.ui.items) e = a.ui.items[f], d = e.toolbar || "others", d = d.split(","), e = d[0], d = parseInt(d[1] || -1, 10), b[e] || (b[e] = []), b[e].push({
          name: f,
          order: d
        });
      ...
      function h(a) {
        var b = [], c, f, g;
        for (c = 0; c < a.length; ++c) f = a[c], g = {}, "/" == f ? b.push(f) : CKEDITOR.tools.isArray(f) ? (e(g, CKEDITOR.tools.clone(f)), b.push(g)) : f.items && (e(g, CKEDITOR.tools.clone(f.items)), g.name = f.name, b.push(g));
        return b
      }

      var m = a.config.removeButtons, m = m && m.split(","), f = a.config.toolbar;
    ...
    b.prototype.focus = function () {
      for (var a = 0, b; b = this.toolbars[a++];) for (var c =
        0, e; e = b.items[c++];) if (e.focus) {
        e.focus();
        return
      }
    };
    ...
    CKEDITOR.plugins.add("toolbar", {
      requires: "button", init: function (g) {
        var d, k = function (a, b) {
          var c, f = "rtl" == g.lang.dir, n = g.config.toolbarGroupCycling, p = f ? 37 : 39, f = f ? 39 : 37,
            n = void 0 === n || n;
          switch (b) {
            case 9:
            case CKEDITOR.SHIFT + 9:
              for (; !c || !c.items.length;) if (c =
                9 == b ? (c ? c.next : a.toolbar.next) || g.toolbox.toolbars[0] : (c ? c.previous : a.toolbar.previous) || g.toolbox.toolbars[g.toolbox.toolbars.length - 1], c.items.length) for (a = c.items[d ? c.items.length - 1 : 0]; a && !a.focus;) (a = d ? a.previous : a.next) || (c = 0);
              a && a.focus();
              return !1;
            case p:
              c = a;
        ...
        g.on("uiSpace", function (c) {
          if (c.data.space == g.config.toolbarLocation) {
            ...
            var d = CKEDITOR.tools.getNextId(),
              ...
              d = !1 !== g.config.toolbarStartupExpanded, f, l;
            ...
            for (var p = g.toolbox.toolbars, q = a(g), v = q.length, w = 0; w < v; w++) {
              var r, u = 0, t, A = q[w], x = "/" !== A && ("/" === q[w + 1] || w == v - 1), z;
              if (A) if (f && (m.push("\x3c/span\x3e"), l = f = 0), "/" === A) m.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e'); else {
                z = A.items || A;
                for (var C = 0; C < z.length; C++) {
                  ...
                  if (y) {
                    ...
                    if (y.type == CKEDITOR.UI_SEPARATOR) l = f && y; else {
                      B = !1 !== y.canGroup;
                      if (!u) {
                        r = CKEDITOR.tools.getNextId();
                        u = {id: r, items: []};
                        t = A.name && (g.lang.toolbar.toolbarGroups[A.name] || A.name);
                        m.push('\x3cspan id\x3d"', r, '" class\x3d"cke_toolbar' + (x ? ' cke_toolbar_last"' : '"'), t ? ' aria-labelledby\x3d"' + r + '_label"' : "", ' role\x3d"toolbar"\x3e');
                        t && m.push('\x3cspan id\x3d"', r, '_label" class\x3d"cke_voice_label"\x3e', t, "\x3c/span\x3e");
                        m.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e');
                        var D = p.push(u) - 1;
                        0 < D && (u.previous = p[D - 1], u.previous.next = u)
                      }
                      B ? f || (m.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'), f = 1) : f && (m.push("\x3c/span\x3e"), f = 0);
                      l && (G(l), l = 0);
                      G(y)
                    }
                  }
            ...
            if (g.config.toolbarCanCollapse && g.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
              ...
              g.addCommand("toolbarCollapse", {
                readOnly: 1, exec: function (a) {
                  var b = a.ui.space("toolbar_collapser"), c = b.getPrevious(), f = a.ui.space("contents"),
                    e = c.getParent(), g = parseInt(f.$.style.height, 10), d = e.$.offsetHeight,
        ...
        g.on("destroy", function () {
          if (this.toolbox) {
            var a, b = 0, c, f, g;
            for (a = this.toolbox.toolbars; b < a.length; b++) for (f = a[b].items,
    ...
    CKEDITOR.ui.prototype.addToolbarGroup = function (a, b, c) {
      var e = d(this.editor), h = 0 === b, m = {name: a};
      if (c) {
        if (c = CKEDITOR.tools.search(e, function (a) {
          return a.name == c
        })) {
          !c.groups && (c.groups = []);
      ...
      b && (b = CKEDITOR.tools.indexOf(e, function (a) {
        return a.name == b
      }));
      h ? e.splice(0, 0, a) : "number" == typeof b ? e.splice(b + 1, 0, m) : e.push(a)
    }
  }(),CKEDITOR.UI_SEPARATOR = "separator",
    CKEDITOR.config.toolbarLocation = "top","use strict",function () {
    function a(a, b, c) {
      b.type || (b.type = "auto");
    ...
    function d(b) {
      function c() {
        ...
        a.on(B.mainPasteEvent, function (a) {
          "beforepaste" == B.mainPasteEvent && G || z(a)
        });
        "beforepaste" == B.mainPasteEvent && (a.on("paste", function (a) {
          D || (d(), a.data.preventDefault(), z(a), k("paste"))
      ...
      function e(a) {
        return {
          ...
          exec: function () {
            ...
            a || b.showNotification(b.lang.clipboard[this.type +
            "Error"]);
            return a
          }
        }
        ...
        return {
          canUndo: !1, async: !0, fakeKeystroke: CKEDITOR.CTRL + 86, exec: function (b, c) {
            function f(c, d) {
              ...
              c ? (c.method = "paste", c.dataTransfer || (c.dataTransfer = B.initPasteDataTransfer()), a(b, c, d)) : g && !b._.forcePasteDialog && b.showNotification(k, "info", b.config.clipboard_notificationDuration);
              b._.forcePasteDialog = !1;
              b.fire("afterCommandExec", {name: "paste", command: e, returnValue: !!c})
            }

            c = "undefined" !== typeof c && null !== c ? c : {};
            var e = this, g = "undefined" !== typeof c.notification ?
              c.notification : !0, d = c.type,
      ...
      function k(a) {
        var c = b.document, e = c.getBody(), g = !1, d = function () {
          g = !0
        };
        e.on(a, d);
      ...
      function m() {
        if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
          ...
          a.getType() == CKEDITOR.SELECTION_ELEMENT && (c = a.getSelectedElement()) && (e = a.getRanges()[0], g = b.document.createText(""), g.insertBefore(c), e.setStartBefore(g), e.setEndAfter(c),
            a.selectRanges([e]), setTimeout(function () {
      ...
      function l(a, c) {
        var e = b.document, g = b.editable(), d = function (a) {
          a.cancel()
        }, h;
        if (!e.getById("cke_pastebin")) {
          var k = b.getSelection(), m = k.createBookmarks();
          ...
          var t = 0, e = e.getWindow();
          CKEDITOR.env.webkit ? (g.append(n),
            n.addClass("cke_editable"), g.is("body") || (t = "static" != g.getComputedStyle("position") ? g : CKEDITOR.dom.element.get(g.$.offsetParent), t = t.getDocumentPosition().y)) : g.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(n);
          n.setStyles({
            position: "absolute",
            top: e.getScrollPosition().y - t + 10 + "px",
            width: "1px",
          ...
          var u = t.select();
          CKEDITOR.env.ie && (h = g.once("blur", function () {
            b.lockSelection(u)
          }));
      ...
      function A() {
        if ("paste" == B.mainPasteEvent) return b.fire("beforePaste", {type: "auto", method: "paste"}), !1;
        b.focus();
        d();
      ...
      function z(c) {
        var e = {type: "auto", method: "paste", dataTransfer: B.initPasteDataTransfer(c)};
        e.dataTransfer.cacheData();
        var g = !1 !== b.fire("beforePaste", e);
        g && B.canClipboardApiBeTrusted(e.dataTransfer, b) ? (c.data.preventDefault(), setTimeout(function () {
          a(b, e)
        }, 0)) : l(c, function (c) {
          e.dataValue =
      ...
      var B = CKEDITOR.plugins.clipboard, G = 0, D = 0, F = 0;
      (function () {
        b.on("key", x);
        b.on("contentDom", c);
      ...
      (function () {
        function a(c, e, g, d, h) {
          ...
          b.addMenuItems && b.addMenuItem(e, {
            label: k, command: e, group: "clipboard",
            order: h
          })
        }
      ...
      b.getClipboardData = function (a, c) {
        ...
        !1 === A() && (b.removeListener("paste", e), b._.forcePasteDialog && d && b.fire("pasteDialog") ? (b.on("pasteDialogCommit", g), b.on("dialogHide", function (a) {
          a.removeListener();
    ...
    function h(b) {
      ...
      b.on("contentDom", function () {
        ...
        var k = b.editable(), m = CKEDITOR.plugins.clipboard.getDropTarget(b), l = b.ui.space("top"),
          A = b.ui.space("bottom");
        ...
        k.attachListener(m, "drop", function (a) {
          if (!a.data.$.defaultPrevented) {
            ...
            if (!e.isReadOnly() || e.type == CKEDITOR.NODE_ELEMENT && e.is("html")) {
              var e = c.getRangeAtDropPosition(a, b), g = c.dragRange;
              e && d(a, g, e)
            }
          }
        }, null, null, 9999);
        ...
        k.attachListener(b, "drop", function (a) {
          if (a = a.data) {
            var d = a.dropRange, h = a.dragRange, k = a.dataTransfer;
            k.getTransferType(b) == CKEDITOR.DATA_TRANSFER_INTERNAL ?
              setTimeout(function () {
                c.internalDrop(h, d, k, b)
              }, 0) : k.getTransferType(b) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? e(h, d, k) : g(d, k)
          }
        }, null, null, 9999)
      })
    }
    ...
    CKEDITOR.plugins.add("clipboard", {
      requires: "dialog,notification,toolbar", init: function (a) {
        ...
        if (CKEDITOR.env.gecko) {
          var m = ["image/png", "image/jpeg", "image/gif"], v;
          a.on("paste", function (b) {
            var c = b.data, e = c.dataTransfer;
            if (!c.dataValue && "paste" == c.method && e && 1 == e.getFilesCount() && v != e.id && (e = e.getFile(0), -1 != CKEDITOR.tools.indexOf(m, e.type))) {
        ...
        a.on("paste", function (b) {
          ...
          if (!b.data.dataValue) {
            var c = b.data.dataTransfer, e = c.getData("text/html");
            if (e) b.data.dataValue = e, b.data.type = "html"; else if (e = c.getData("text/plain")) b.data.dataValue = a.editable().transformPlainTextToHtml(e), b.data.type = "text"
          }
        }, null, null, 1);
        a.on("paste", function (a) {
          ...
          if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
            ...
            for (g.setHtml(b); 1 == g.getChildCount() && (e = g.getFirst()) && e.type == CKEDITOR.NODE_ELEMENT && (e.hasClass("cke_editable") || e.hasClass("cke_contents"));) g = f = e;
            f && (b = f.getHtml().replace(/<br>$/i, ""))
          }
          CKEDITOR.env.ie ? b = b.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function (b, e) {
            return e.toLowerCase() in c ? (a.data.preSniffing = "html", "\x3c" + e) : b
        ...
        a.on("paste", function (e) {
          e = e.data;
          var g = a._.nextPasteType || e.type, d = e.dataValue, h, m = a.config.clipboard_defaultContentType || "html",
            n = e.dataTransfer.getTransferType(a) == CKEDITOR.DATA_TRANSFER_EXTERNAL,
            v = !0 === a.config.forcePasteAsPlainText;
          h = "html" == g || "html" == e.preSniffing ? "html" : b(d);
          delete a._.nextPasteType;
          "htmlifiedtext" == h && (d = c(a.config, d));
          if ("text" == g && "html" == h) d =
            l(a, d, k.get("plain-text")); else if (n && a.pasteFilter && !e.dontFilter || v) d = l(a, d, a.pasteFilter);
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      fixSplitNodesAfterDrop: function (a,
        ...
        "number" == typeof e && "number" == typeof c && d.type == CKEDITOR.NODE_ELEMENT && (g(a.startContainer, d, c) || g(a.endContainer,
          d, e))
      },
      isDropRangeAffectedByDragRange: function (a, b) {
        var c = b.startContainer, e = b.endOffset;
      ...
      internalDrop: function (b, c, e, g) {
        var d = CKEDITOR.plugins.clipboard, h = g.editable(), k, m;
        g.fire("saveSnapshot");
        g.fire("lockSnapshot", {dontUpdate: 1});
        CKEDITOR.env.ie && 10 > CKEDITOR.env.version && this.fixSplitNodesAfterDrop(b, c, d.dragStartContainerChildCount,
      ...
      getRangeAtDropPosition: function (a,
                                        b) {
        var c = a.data.$, e = c.clientX, g = c.clientY, d = b.getSelection(!0).getRanges()[0], h = b.createRange();
        if (a.data.testRange) return a.data.testRange;
        if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(e, g)) c = b.document.$.caretRangeFromPoint(e, g), h.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), h.collapse(!0); else if (c.rangeParent) h.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), h.collapse(!0); else {
          ...
          if (document.body.createTextRange) {
            ...
            try {
              ...
              if (k) {
                ...
                var y = b.document.$.elementFromPoint(e, g), B = new CKEDITOR.dom.element(y), G;
                if (B.equals(b.editable()) ||
                  "html" == B.getName()) return d && d.startContainer && !d.startContainer.equals(b.editable()) ? d : null;
                G = B.getClientRect();
                e < G.left ? h.setStartAt(B, CKEDITOR.POSITION_AFTER_START) : h.setStartAt(B, CKEDITOR.POSITION_BEFORE_END);
                h.collapse(!0)
              }
            } catch (D) {
              return null
      ...
      initDragDataTransfer: function (a, b) {
        var c = a.data.$ ? a.data.$.dataTransfer : null, e = new this.dataTransfer(c, b);
        "dragstart" === a.name && e.storeId();
        c ? this.dragData && e.id == this.dragData.id ? e = this.dragData : this.dragData = e : this.dragData ?
          e = this.dragData : this.dragData = e;
      ...
      initPasteDataTransfer: function (a, b) {
        if (this.isCustomCopyCutSupported) {
          if (a && a.data && a.data.$) {
            var c = a.data.$.clipboardData, e = new this.dataTransfer(c, b);
            "copy" !== a.name && "cut" !== a.name || e.storeId();
            this.copyCutData && e.id == this.copyCutData.id ? (e = this.copyCutData, e.$ = c) : this.copyCutData = e;
            return e
          }
    ...
    CKEDITOR.plugins.clipboard.dataTransfer.prototype =
      {
        getData: function (a, b) {
          ...
          if ("string" === typeof c) var g = c.indexOf("\x3c/html\x3e"), c = -1 !== g ? c.substring(0, g + 7) : c;
          return c
        },
        setData: function (a, b) {
          ...
          function a(c) {
            ...
            var e = b.getData(c);
            "text/html" == c && (b._.nativeHtmlCache = b.getData(c, !0), e = b._stripHtml(e));
            e && (b._.data[c] = e)
          }
    ...
    CKEDITOR.plugins.clipboard.fallbackDataTransfer.prototype =
      {
        isRequired: function () {
          ...
          var c = this._getData(this._customDataFallbackType,
            !0);
          if (b) return c;
          var c = this._extractDataComment(c), e = null,
          ...
          try {
            ...
            if (this._isUnsupportedMimeTypeError(d)) {
              ...
              var c = this._getFallbackTypeContent(), h = this._getFallbackTypeData();
              h[a] = e;
              try {
                e = this._applyDataComment(c, h), g.setData(this._customDataFallbackType, e), this._dataTransfer._.nativeHtmlCache = e
              } catch (k) {
                e = ""
              }
            }
    ...
    requires: "button", onLoad: function () {
      ...
      CKEDITOR.ui.panelButton = CKEDITOR.tools.createClass({
        base: CKEDITOR.ui.button, $: function (d) {
          var b = d.panel || {};
          delete d.panel;
          this.base(d);
        ...
        proto: {
          createPanel: function (a) {
            var b = this._;
            if (!b.panel) {
              var c = this._.panelDefinition, g = this._.panelDefinition.block,
                l = c.parent || CKEDITOR.document.getBody(), k = this._.panel = new CKEDITOR.ui.floatPanel(a, l, c),
                c = k.addBlock(b.id, g), e = this;
              k.onShow = function () {
              ...
              k.onHide = function (c) {
                ...
                e.setState(e.modes &&
                e.modes[a.mode] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED);
                b.on = 0;
    ...
    var a = CKEDITOR.addTemplate("panel", '\x3cdiv lang\x3d"{langCode}" id\x3d"{id}" dir\x3d{dir} class\x3d"cke cke_reset_all {editorId} cke_panel cke_panel {cls} cke_{dir}" style\x3d"z-index:{z-index}" role\x3d"presentation"\x3e{frame}\x3c/div\x3e'),
      d = CKEDITOR.addTemplate("panel-frame", '\x3ciframe id\x3d"{id}" class\x3d"cke_panel_frame" role\x3d"presentation" frameborder\x3d"0" src\x3d"{src}"\x3e\x3c/iframe\x3e'),
      ...
      CKEDITOR.tools.createClass({
        $: function (a, b) {
          ...
          markItem: function (a) {
            ...
            }, d = this._.getItems(), k, e, h = d.count() - 1; 0 <= h; h--) if (k = d.getItem(h), k.getAscendant(b) || (e = k, this._.focusIndex = h), "true" == k.getAttribute("aria-selected")) {
              e = k;
              this._.focusIndex = h;
              break
            }
          ...
          show: function () {
            ...
            switch (d) {
              case "next":
                for (var k = this._.focusIndex, d = this.element.getElementsByTag("a"), e; e = d.getItem(++k);) if (e.getAttribute("_cke_focus") && e.$.offsetWidth) {
                  this._.focusIndex = k;
                  e.focus();
                  break
                }
              ...
              case "prev":
                k = this._.focusIndex;
                for (d = this.element.getElementsByTag("a"); 0 < k && (e = d.getItem(--k));) {
    ...
    function a(a,
      ...
      var e = d[k];
      e || (e = d[k] = new CKEDITOR.ui.panel(c, l), e.element = g.append(CKEDITOR.dom.element.createFromHtml(e.render(a), c)), e.element.setStyles({
        display: "none",
        position: "absolute"
      }));
      return e
    ...
    CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
      $: function (b, c, g, d) {
        ...
        var e = c.getDocument();
        d = a(b, e, c, g, d || 0);
        var h = d.element, m = h.getFirst(), f = this;
        ...
        b.on("mode", k);
        b.on("resize", k);
        e.getWindow().on("resize", function () {
          this.reposition()
        }, this)
      }, proto: {
        ...
        showBlock: function (a, c, g, d, k, e) {
          var h = this._.panel, m = h.showBlock(a);
          ...
          var n = this.element, f = this._.iframe,
            f = CKEDITOR.env.ie && !CKEDITOR.env.edge ? f : new CKEDITOR.dom.window(f.$.contentWindow),
            p = n.getDocument(), q = this._.parentElement.getPositionedAncestor(), v = c.getDocumentPosition(p),
            p = q ? q.getDocumentPosition(p) :
              {x: 0, y: 0}, w = "rtl" == this._.dir, r = v.x + (d || 0) - p.x, u = v.y + (k || 0) - p.y;
          !w || 1 != g && 4 != g ? w || 2 != g && 3 != g || (r += c.$.offsetWidth - 1) : r += c.$.offsetWidth;
          ...
          CKEDITOR.tools.setTimeout(function () {
            var a = CKEDITOR.tools.bind(function () {
              ...
              var b = h.element.getWindow(), a = n.$.getBoundingClientRect(), b = b.getViewPaneSize(),
                c = a.width || a.right - a.left, f = a.height || a.bottom - a.top, g = w ? a.right : b.width - a.left,
                d = w ? b.width - a.right : a.left;
              w ? g < c && (r = d > c ? r + c : b.width > c ? r - a.left : r - a.right + b.width) : g < c && (r = d > c ? r - c : b.width > c ? r - a.right + b.width : r - a.left);
              c = a.top;
              b.height -
              ...
              n.setStyles({top: u + "px", left: r + "px"});
              n.setOpacity(1);
              e && e()
            }, this);
          ...
          return c.allowBlur
        }, showAsChild: function (a, c, g, d, k, e) {
          if (this._.activeChild != a || a._.panel._.offsetParentId != g.getId()) this.hideChild(), a.onHide = CKEDITOR.tools.bind(function () {
            CKEDITOR.tools.setTimeout(function () {
              this._.focused || this.hide()
            }, 0, this)
          }, this), this._.activeChild = a, this._.focused = !1, a.showBlock(c, g, d, k, e), this.blur(), (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) && setTimeout(function () {
    ...
    CKEDITOR.on("instanceDestroyed", function () {
      var a = CKEDITOR.tools.isEmpty(CKEDITOR.instances), c;
      for (c in d) {
        var g = d[c];
    ...
    requires: "panelbutton,floatpanel", init: function (a) {
      function d(c, e, d, h, q) {
        var v = new CKEDITOR.style(l["colorButton_" + e + "Style"]), w = CKEDITOR.tools.getNextId() + "_colorBox", r;
        q = q || {};
        a.ui.add(c, CKEDITOR.UI_PANELBUTTON,
          {
            ...
            onBlock: function (c, g) {
              ...
              g.element.setHtml(b(c, e, w));
              g.element.getDocument().getBody().setStyle("overflow", "hidden");
              CKEDITOR.ui.fire("ready", this);
              var d = g.keys, h = "rtl" == a.lang.dir;
              d[h ? 37 : 39] = "next";
              d[40] = "next";
              d[9] = "next";
              d[h ? 39 : 37] = "prev";
            ...
            refresh: function () {
              a.activeFilter.check(v) || this.setState(CKEDITOR.TRISTATE_DISABLED)
            },
            onOpen: function () {
              var b = a.getSelection(), c = b && b.getStartElement(), d = a.elementPath(c);
              if (d) {
                ...
                this._.panel._.iframe.getFrameDocument().getById(w).setStyle("background-color", d);
                if (c = b && b.getRanges()[0]) {
                  for (var b = new CKEDITOR.dom.walker(c), h = c.collapsed ? c.startContainer : b.next(), c = ""; h;) {
                    h.type === CKEDITOR.NODE_TEXT && (h = h.getParent());
                  ...
                  for (h = 0; h < c.count(); h++) {
                    ...
                    b && b == g(k.getAttribute("data-value")) && k.setAttribute("aria-selected",
                      !0)
                  }
                }
                return d
      ...
      function b(b, e, d) {
        b = [];
        var g = l.colorButton_colors.split(","), h = l.colorButton_colorsPerRow || 6,
          v = a.plugins.colordialog && !1 !== l.colorButton_enableMore, w = g.length + (v ? 2 : 1),
          r = CKEDITOR.tools.addFunction(function (b, e) {
            function f(b) {
              ...
              d.childRule = "back" == e ? function (a) {
                return c(a)
              } : function (a) {
                return !(a.is("a") || a.getElementsByTag("a").count()) || c(a)
              };
              a.focus();
              a.applyStyle(new CKEDITOR.style(d,
                {color: b}));
              a.fire("saveSnapshot")
            }
        ...
        for (d = 0; d < g.length; d++) {
          ...
          var u = g[d].split("/"), t = u[0], A = u[1] || t;
          u[1] || (t = "#" + t.replace(/^(.)(.)(.)$/, "$1$1$2$2$3$3"));
          u = a.lang.colorbutton.colors[A] || A;
          b.push('\x3ctd\x3e\x3ca class\x3d"cke_colorbox" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"',
            u, '" onclick\x3d"CKEDITOR.tools.callFunction(', r, ",'", t, "','", e, "'); return false;\" href\x3d\"javascript:void('", u, '\')" data-value\x3d"' + A + '" role\x3d"option" aria-posinset\x3d"', d + 2, '" aria-setsize\x3d"', w, '"\x3e\x3cspan class\x3d"cke_colorbox" style\x3d"background-color:#', A, '"\x3e\x3c/span\x3e\x3c/a\x3e\x3c/td\x3e')
        }
        v && b.push('\x3c/tr\x3e\x3ctr\x3e\x3ctd colspan\x3d"' + h + '" align\x3d"center"\x3e\x3ca class\x3d"cke_colormore" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', k.more, '" onclick\x3d"CKEDITOR.tools.callFunction(',
          r, ",'?','", e, "');return false;\" href\x3d\"javascript:void('", k.more, "')\"", ' role\x3d"option" aria-posinset\x3d"', w, '" aria-setsize\x3d"', w, '"\x3e', k.more, "\x3c/a\x3e\x3c/td\x3e");
      ...
      var l = a.config, k = a.lang.colorbutton;
      if (!CKEDITOR.env.hc) {
        d("TextColor",
          "fore", k.textColorTitle, 10, {
        ...
        var e = {}, h = a.config.colorButton_normalizeBackground;
        if (void 0 === h || h) e.contentTransformations = [[{
          element: "span", left: function (a) {
            ...
            var c = (new CKEDITOR.style(a.config.colorButton_backStyle, {color: b.styles.background})).getDefinition();
            b.name = c.element;
            b.styles = c.styles;
    ...
    requires: "dialog", init: function (a) {
      ...
      a.getColorFromDialog = function (b, c) {
        ...
        if (a._.storedDialogs && a._.storedDialogs.colordialog) k(a._.storedDialogs.colordialog); else CKEDITOR.on("dialogDefinition", function (a) {
    ...
    function a(a, b, c, d) {
      ...
      if (a = a.startContainer.getAscendant(b, !0) || a.endContainer.getAscendant(b, !0)) if (c(a), d) return;
      for (; a = f.next();) if (a = a.getAscendant(b, !0)) if (c(a), d) break
    }
    ...
    var c = CKEDITOR.tools.indexOf, g = CKEDITOR.tools.getMouseButton, l = !1;
      ...
      init: function (a) {
        ...
        a.on("contentDom", function () {
          var b = a.editable(), c = b.isInline() ?
            b : a.document, e = a.ui.get("CopyFormatting");
          ...
          e && (c = CKEDITOR.document.getById(e._.id), b.attachListener(c, "dblclick", function () {
        ...
        a.copyFormatting.on("applyFormatting", function (g) {
          if (!g.data.preventFormatStripping) {
            var m = g.data.range, f = b._extractStylesFromRange(a, m), l = b._determineContext(m), p, q;
            if (a.copyFormatting._isContextAllowed(l)) for (q = 0; q < f.length; q++) l = f[q], p = m.createBookmark(), -1 === c(b.preservedElements, l.element) ? CKEDITOR.env.webkit && !CKEDITOR.env.chrome ? f[q].removeFromRange(g.data.range,
        ...
        a.copyFormatting.on("applyFormatting", function (b) {
          var c = CKEDITOR.plugins.copyformatting, e = c._determineContext(b.data.range);
    ...
    CKEDITOR.plugins.copyformatting = {
      ...
      commands: {
        copyFormatting: {
          exec: function (a, b) {
            var c = CKEDITOR.plugins.copyformatting, d = a.copyFormatting, f = b ? "keystrokeHandler" == b.from : !1,
              g = b ? b.sticky || f : !1, l = c._getCursorContainer(a), q = CKEDITOR.document.getDocumentElement();
          ...
          editorFocus: CKEDITOR.env.ie && !CKEDITOR.env.edge ? !1 : !0, exec: function (a, b) {
            var c = a.getCommand("copyFormatting"), d = b ? "keystrokeHandler" == b.from : !1,
              f = CKEDITOR.plugins.copyformatting, g = a.copyFormatting, l = f._getCursorContainer(a),
            ...
            if (d || c.state === CKEDITOR.TRISTATE_ON) {
              ...
              d = f._applyFormat(a,
                g.styles);
              g.sticky || (g.styles = null, l.removeClass("cke_copyformatting_active"), q.removeClass("cke_copyformatting_disabled"), q.removeClass("cke_copyformatting_tableresize_cursor"), c.setState(CKEDITOR.TRISTATE_OFF), f._detachPasteKeystrokeHandler(a));
      ...
      _extractStylesFromElement: function (a, b) {
        var d = {}, g = [];
        do if (b.type === CKEDITOR.NODE_ELEMENT && !b.hasAttribute("data-cke-bookmark") && (d.element = b, a.copyFormatting.fire("extractFormatting", d, a) && d.styleDef && g.push(new CKEDITOR.style(d.styleDef)), b.getName && -1 !== c(CKEDITOR.plugins.copyformatting.breakOnElements, b.getName()))) break; while ((b = b.getParent()) && b.type === CKEDITOR.NODE_ELEMENT);
        return g
      },
      _extractStylesFromRange: function (a, b) {
        for (var c = [], d = new CKEDITOR.dom.walker(b), f; f = d.next();) c = c.concat(CKEDITOR.plugins.copyformatting._extractStylesFromElement(a, f));
        return c
      },
      _removeStylesFromElementInRange: function (a, b) {
        for (var d = -1 !== c(["ol", "ul", "table"], b), g = new CKEDITOR.dom.walker(a), f; f = g.next();) if (f = f.getAscendant(b, !0)) if (f.removeAttributes(f.getAttributes()), d) break
      },
      _getSelectedWordOffset: function (a) {
        ...
        function g(a, f) {
          var k = a, l = /\s/g, n = "p br ol ul li td th div caption body".split(" "), p = !1, v = !1, y, B;
          do {
            for (y = b(k, f); !y && k.getParent();) {
              k = k.getParent();
              if (-1 !== c(n, k.getName())) {
                v = p = !0;
                break
            ...
            if (y && y.getName && -1 !== c(n, y.getName())) {
              p = !0;
              break
            }
            k = y
          } while (k && k.getStyle && ("none" == k.getStyle("display") || !k.getText()));
          for (k || (k = a); k.type !==
          CKEDITOR.NODE_TEXT;) k = !p || f || v ? k.getChild(0) : k.getChild(k.getChildCount() - 1);
          for (n = d(k); null != (v = l.exec(n)) && (B = v.index, f);) ;
          if ("number" !== typeof B && !p) return g(k, f);
          if (p) f ? B = 0 : (l = /([\.\b]*$)/, B = (v = l.exec(n)) ? v.index : n.length); else if (f && (B += 1, B > n.length)) return g(k);
          return {node: k, offset: B}
        }

        var f = /\b\w+\b/ig, l, p, q, v, w;
        q = v = w = a.startContainer;
        for (l = d(q); null != (p = f.exec(l));) if (p.index + p[0].length >= a.startOffset) return a = p.index, f = p.index + p[0].length, 0 === p.index && (p = g(q, !0), v = p.node, a = p.offset), f >= l.length &&
        (l = g(q), w = l.node, f = l.offset), {startNode: v, startOffset: a, endNode: w, endOffset: f};
        return null
      },
      _filterStyles: function (a) {
        var b = CKEDITOR.tools.isEmpty, c = [], d, f;
        for (f = 0; f < a.length; f++) d = a[f]._.definition, -1 !== CKEDITOR.tools.indexOf(CKEDITOR.plugins.copyformatting.inlineBoundary, d.element) && (d.element = a[f].element = "span"), "span" === d.element && b(d.attributes) && b(d.styles) || c.push(a[f]);
        return c
      },
      _determineContext: function (a) {
        function b(c) {
          var e = new CKEDITOR.dom.walker(a), f;
          if (a.startContainer.getAscendant(c,
      ...
      _applyStylesToTextContext: function (a, b, d) {
        var g = CKEDITOR.plugins.copyformatting, f = g.excludedAttributesFromInlineTransform, l, p;
        CKEDITOR.env.webkit && !CKEDITOR.env.chrome && a.getSelection().selectRanges([b]);
        for (l = 0; l < d.length; l++) if (b = d[l], -1 === c(g.excludedElementsFromInlineTransform, b.element)) {
          if (-1 !== c(g.elementsForInlineTransform, b.element)) for (b.element =
      ...
      _applyStylesToListContext: function (b, c, d) {
        var g, f, l;
        for (l = 0; l < d.length; l++) g = d[l], f = c.createBookmark(), "ol" === g.element || "ul" === g.element ? a(c, {
          ul: 1,
          ol: 1
        }, function (a) {
          var b = g;
          ...
          g.applyToObject(a)
        }) : CKEDITOR.plugins.copyformatting._applyStylesToTextContext(b, c,
          [g]), c.moveToBookmark(f)
      },
      _applyStylesToTableContext: function (b, e, d) {
        ...
        var f, l, p;
        for (p = 0; p < d.length; p++) f = d[p], l = e.createBookmark(), -1 !== c(["table", "tr"], f.element) ? a(e, f.element, function (a) {
          f.applyToObject(a)
        }) : -1 !== c(["td", "th"], f.element) ? a(e, {td: 1, th: 1}, function (a) {
          g(a, f)
        }) : -1 !== c(["thead", "tbody"], f.element) ? a(e, {thead: 1, tbody: 1}, function (a) {
          g(a, f)
        }) : CKEDITOR.plugins.copyformatting._applyStylesToTextContext(b,
          e, [f]), e.moveToBookmark(l)
      },
      _applyFormat: function (a, b) {
        var c = a.getSelection().getRanges()[0], d = CKEDITOR.plugins.copyformatting, f, g;
        if (!c) return !1;
        if (c.collapsed) {
          g = a.getSelection().createBookmarks();
          if (!(f = d._getSelectedWordOffset(c))) return;
          c = a.createRange();
    ...
    requires: "floatpanel",
    beforeInit: function (a) {
      for (var d = a.config.menu_groups.split(","), b = a._.menuGroups = {}, c = a._.menuItems = {}, g = 0; g < d.length; g++) b[d[g]] = g + 1;
    ...
    CKEDITOR.menu = CKEDITOR.tools.createClass({
      $: function (a, b) {
        ...
        add: function (a) {
          ...
          var g = this.items, f = this.editor, n = this._.panel, p = this._.element;
          if (!n) {
          ...
          a(g);
          for (var q = f.elementPath(), q = ['\x3cdiv class\x3d"cke_menu' + (q && q.direction() != f.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], v = g.length, w = v && g[0].group,
                 r = 0; r < v; r++) {
            var u = g[r];
            w != u.group && (q.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'), w = u.group);
            u.render(this, r, q)
          }
          q.push("\x3c/div\x3e");
          p.setHtml(q.join(""));
          ...
          var b =
            CKEDITOR.tools.array.filter(this.items, function (b) {
              return a === b.command
            });
    ...
    CKEDITOR.menuItem = CKEDITOR.tools.createClass({
      $: function (a, b, c) {
        ...
        render: function (a, d, e) {
          var h = a.id + String(d), m = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state, f = "",
            n = this.editor,
            p, q, v = m == CKEDITOR.TRISTATE_ON ? "on" : m == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off";
          this.role in {
            menuitemcheckbox: 1,
            menuitemradio: 1
          } && (f = ' aria-checked\x3d"' + (m == CKEDITOR.TRISTATE_ON ? "true" : "false") + '"');
          var w = this.getItems, r = "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";", u = this.name;
            ...
            a.on("contextmenu", function (a) {
              ...
              if (!d || !c) {
                ...
                var k = a.getTarget().getDocument(),
                  e = a.getTarget().getDocument().getDocumentElement(), c = !k.equals(CKEDITOR.document),
                  k = k.getWindow().getScrollPosition(), h = c ? a.$.clientX : a.$.pageX || k.x + a.$.clientX,
                  m = c ? a.$.clientY : a.$.pageY || k.y + a.$.clientY;
                CKEDITOR.tools.setTimeout(function () {
                  this.open(e, null, h, m)
    ...
    function d() {
      ...
      if (a) {
        var b = this.att, d = this.getValue();
    ...
    CKEDITOR.plugins.add("dialogadvtab", {
      requires: "dialog", allowedContent: function (a) {
        ...
        g || (g = b);
        var k = c.lang.common, e = {
          id: "advanced",
          label: k.advancedTab,
          title: k.advancedTab,
          elements: [{type: "vbox", padding: 1, children: []}]
        }, h = [];
        if (g.id || g.dir) g.id && h.push({
          id: "advId",
          att: "id",
          type: "text",
          ...
          style: "width:100%",
          items: [[k.notSet,
            ""], [k.langDirLTR, "ltr"], [k.langDirRTL, "rtl"]],
          setup: a,
          commit: d
        ...
        if (g.styles || g.classes) h = [], g.styles && h.push({
          ...
          updateStyle: function (a, b) {
            var e = this.getValue(), d = c.document.createElement("span");
      ...
      requires: "dialog", init: function (a) {
        if (!a.blockless) {
          ...
          a.addMenuItems && (a.addMenuItems({
            editdiv: {label: d.edit, command: "editdiv", group: "div", order: 1},
    ...
    function a(a, b) {
      ...
      var h = a.ui.spaceId("path"), m, f = a._.elementsPath, n = f.idBase;
      ...
      f.onClick = k;
      var p = CKEDITOR.tools.addFunction(k), q = CKEDITOR.tools.addFunction(function (b, c) {
        var e = f.idBase, d;
      ...
      a.on("selectionChange", function (b) {
        for (var e = [], d = f.list = [], k = [], l = f.filters, A = !0, x = b.data.path.elements, z = x.length; z--;) {
          var C = x[z], y = 0;
          ...
          y || (d.unshift(C), k.unshift(b))
        }
        d = d.length;
        for (l = 0; l < d; l++) b = k[l], A = a.lang.elementspath.eleTitle.replace(/%1/, b), b = c.output({
          id: n + l,
          label: A,
          text: b,
    ...
    var c = CKEDITOR.dom.walker.whitespaces(), g = CKEDITOR.dom.walker.bookmark();
    CKEDITOR.plugins.enterkey = {
      enterBlock: function (a, e, l, p) {
        if (l = l || d(a)) {
          l =
            b(l);
          var q = l.document, v = l.checkStartOfBlock(), w = l.checkEndOfBlock(), r = a.elementPath(l.startContainer),
            u = r.block, t = e == CKEDITOR.ENTER_DIV ? "div" : "p", A;
          if (v && w) {
            if (u && (u.is("li") || u.getParent().is("li"))) {
              ...
              A = l.getParent();
              p = !u.hasPrevious();
              var x = !u.hasNext(), t = a.getSelection(), z = t.createBookmarks(), v = u.getDirection(1),
                w = u.getAttribute("class"), C = u.getAttribute("style"), y = A.getDirection(1) != v;
              a = a.enterMode != CKEDITOR.ENTER_BR || y || C || w;
              if (A.is("li")) p || x ? (p &&
              x && l.remove(), u[x ? "insertAfter" : "insertBefore"](A)) : u.breakParent(A); else {
                if (a) if (r.block.is("li") ? (A = q.createElement(e == CKEDITOR.ENTER_P ? "p" : "div"), y && A.setAttribute("dir", v), C && A.setAttribute("style", C), w && A.setAttribute("class", w), u.moveChildren(A)) : A = r.block, p || x) A[p ? "insertBefore" : "insertAfter"](l); else u.breakParent(l), A.insertAfter(l); else if (u.appendBogus(!0), p || x) for (; q = u[p ? "getFirst" : "getLast"]();) q[p ? "insertBefore" : "insertAfter"](l); else for (u.breakParent(l); q = u.getLast();) q.insertAfter(l);
                u.remove()
              }
              t.selectBookmarks(z);
              return
          ...
          if (v = l.splitBlock(t)) {
            ...
            r = v.wasStartOfBlock;
            a = v.wasEndOfBlock;
            u ? (z = u.getParent(), z.is("li") && (u.breakParent(z),
              u.move(u.getNext(), 1))) : e && (z = e.getParent()) && z.is("li") && (e.breakParent(z), z = e.getNext(), l.moveToElementEditStart(z), e.move(e.getPrevious()));
            if (r || a) {
              if (e) {
                if (e.is("li") || !h.test(e.getName()) && !e.is("pre")) A = e.clone()
              } else u && (A = u.clone());
              A ? p && !A.is("li") && A.renameNode(t) : z && z.is("li") ? A = z : (A = q.createElement(t), e && (x = e.getDirection()) && A.setAttribute("dir", x));
              if (q = v.elementPath) for (p = 0, t = q.elements.length; p < t; p++) {
                z = q.elements[p];
                if (z.equals(q.block) || z.equals(q.blockLimit)) break;
                CKEDITOR.dtd.$removeEmpty[z.getName()] &&
                (z = z.clone(), A.moveChildren(z), A.append(z))
              }
              A.appendBogus();
              A.getParent() || l.insertNode(A);
              A.is("li") && A.removeAttribute("value");
              !CKEDITOR.env.ie || !r || a && e.getChildCount() || (l.moveToElementEditStart(a ? e : A), l.select());
              l.moveToElementEditStart(r && !a ? u : A)
            } else u.is("li") && (A = l.clone(), A.selectNodeContents(u), A = new CKEDITOR.dom.walker(A), A.evaluator = function (a) {
              return !(g(a) || c(a) || a.type == CKEDITOR.NODE_ELEMENT && a.getName() in CKEDITOR.dtd.$inline && !(a.getName() in CKEDITOR.dtd.$empty))
            }, (z = A.next()) &&
            z.type == CKEDITOR.NODE_ELEMENT && z.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? q.createElement("br") : q.createText(" ")).insertBefore(z)), u && l.moveToElementEditStart(u);
            l.select();
            l.scrollIntoView()
          }
        }
        ...
        if (c = c || d(a)) {
          var k = c.document, l = c.checkEndOfBlock(),
            w = new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()), r = w.block,
            u = r && w.block.getName();
          g || "li" != u ? (!g && l && h.test(u) ? (l = r.getDirection()) ? (k = k.createElement("div"), k.setAttribute("dir", l), k.insertAfter(r), c.setStart(k,
            0)) : (k.createElement("br").insertAfter(r), CKEDITOR.env.gecko && k.createText("").insertAfter(r), c.setStartAt(r.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (a = "pre" == u && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? k.createText("\r") : k.createElement("br"), c.deleteContents(), c.insertNode(a), CKEDITOR.env.needsBrFiller ? (k.createText("﻿").insertAfter(a), l && (r || w.blockLimit).appendBogus(), a.getNext().$.nodeValue = "", c.setStartAt(a.getNext(), CKEDITOR.POSITION_AFTER_START)) :
            c.setStartAt(a, CKEDITOR.POSITION_AFTER_END)), c.collapse(!0), c.select(), c.scrollIntoView()) : e(a, b, c, g)
        }
      }
    };
    var l = CKEDITOR.plugins.enterkey, k = l.enterBr, e = l.enterBlock, h = /^h[1-6]$/
  }(),function () {
    function a(a, b) {
      var c = {}, g = [], l = {nbsp: " ", shy: "­", gt: "\x3e", lt: "\x3c", amp: "\x26", apos: "'", quot: '"'};
      ...
      if (!b && a) {
        a = a.split(",");
        var k = document.createElement("div"), e;
        k.innerHTML =
          "\x26" + a.join(";\x26") + ";";
        e = k.innerHTML;
        k = null;
    ...
    CKEDITOR.plugins.add("entities", {
      afterInit: function (d) {
        ...
        if (d = (d = d.dataProcessor) && d.htmlFilter) {
          ...
          var k = a(l.join(",")), e = k.regex ? "[" + k.regex + "]" : "a^";
          delete k.regex;
          g.entities && g.entities_processNumerical && (e = "[^ -~]|" + e);
          var e = new RegExp(e, "g"), h = a("nbsp,gt,lt,amp,shy", !0), m = new RegExp(h.regex, "g");
          d.addRules({
            text: function (a) {
              return a.replace(m, b).replace(e, c)
            }
    ...
    popup: function (a, d, b, c) {
      ...
      640 > d && (d = 640);
      420 > b && (b = 420);
      var g = parseInt((window.screen.height - b) / 2, 10), l = parseInt((window.screen.width -
        d) / 2, 10);
      ...
      if (!k) return !1;
      try {
        -1 == navigator.userAgent.toLowerCase().indexOf(" chrome/") && (k.moveTo(l, g), k.resizeTo(d, b)), k.focus(), k.location.href = a
      } catch (e) {
    ...
    function d(a, c, d) {
      var e = a.config.fileTools_defaultFileName;
      this.editor = a;
      this.lang = a.lang;
    ...
    CKEDITOR.plugins.add("filetools", {
      beforeInit: function (b) {
        ...
        b.on("fileUploadRequest",
          function (a) {
            var c = a.data.fileLoader, e = new FormData;
            a = a.data.requestData;
            var d = b.config.fileTools_requestHeaders, m, f;
            for (f in a) {
              var n = a[f];
              "object" === typeof n && n.file ? e.append(f, n.file, n.name) : e.append(f, n)
            }
            e.append("ckCsrfToken", CKEDITOR.tools.getCsrfToken());
            if (d) for (m in d) c.xhr.setRequestHeader(m, d[m]);
            c.xhr.send(e)
          }, null, null, 999);
        b.on("fileUploadResponse", function (a) {
          var b = a.data.fileLoader, c = b.xhr, d = a.data;
          try {
            var g = JSON.parse(c.responseText);
            g.error && g.error.message && (d.message = g.error.message);
            if (g.uploaded) for (var f in g) d[f] = g[f]; else a.cancel()
          } catch (n) {
            d.message = b.lang.filetools.responseError, CKEDITOR.warn("filetools-response-error", {responseText: c.responseText}), a.cancel()
          }
        }, null, null, 999)
      }
    });
    ...
    d.prototype = {
      loadAndUpload: function (a,
        ...
        var a = this, b = this.reader = new FileReader;
        ...
        e.onload = function () {
          c.update();
          if ("abort" != c.status) if (c.uploaded = c.uploadTotal, 200 > e.status || 299 < e.status) c.message = c.lang.filetools["httpError" + e.status], c.message || (c.message = c.lang.filetools.httpError.replace("%1",
            e.status)), c.changeStatus("error"); else {
            for (var a = {fileLoader: c}, b = ["message", "fileName", "url"], d = c.editor.fire("fileUploadResponse", a), g = 0; g < b.length; g++) {
              var l = b[g];
    ...
    function a(a, b) {
      var c = [];
      if (b) for (var e in b) c.push(e + "\x3d" + encodeURIComponent(b[e])); else return a;
    ...
    function c() {
      var c = this.getDialog(), e = c.getParentEditor();
    ...
    function e(a, m, q, v) {
      if (v && v.length) for (var w, r = v.length; r--;) if (w = v[r], "hbox" != w.type && "vbox" != w.type && "fieldset" != w.type || e(a, m, q, w.children), w.filebrowser) if ("string" == typeof w.filebrowser && (w.filebrowser = {
        action: "fileButton" ==
        w.type ? "QuickUpload" : "Browse", target: w.filebrowser
      }), "Browse" == w.filebrowser.action) {
        var u = w.filebrowser.url;
        void 0 === u && (u = a.config["filebrowser" + b(m) + "BrowseUrl"], void 0 === u && (u = a.config.filebrowserBrowseUrl));
        u && (w.onClick = c, w.filebrowser.url = u, w.hidden = !1)
      } else if ("QuickUpload" == w.filebrowser.action && w["for"] && (u = w.filebrowser.url, void 0 === u && (u = a.config["filebrowser" + b(m) + "UploadUrl"], void 0 === u && (u = a.config.filebrowserUploadUrl)), u)) {
        var t = w.onClick;
        w.onClick = function (b) {
          var c = b.sender, e = c.getDialog().getContentElement(this["for"][0],
            this["for"][1]).getInputElement(), k = CKEDITOR.fileTools && CKEDITOR.fileTools.isFileUploadSupported;
          if (t && !1 === t.call(c, b)) return !1;
          if (l.call(c, b)) {
            if ("form" !== a.config.filebrowserUploadMethod && k) return b = a.uploadRepository.create(e.$.files[0]), b.on("uploaded", function (a) {
              var b = a.sender.responseData;
              f.call(a.sender.editor, b.url, b.message)
            }), b.on("error", h.bind(this)), b.on("abort", h.bind(this)), b.loadAndUpload(d(u)), "xhr";
            g(e);
            return !0
          }
          return !1
        ...
        w.filebrowser.url = u;
        w.hidden = !1;
        k(a, q.getContents(w["for"][0]).get(w["for"][1]),
          w.filebrowser)
      }
    }
    ...
    function f(a, b) {
      ...
      if ("function" !=
        typeof b || !1 !== b.call(this._.filebrowserSe)) if (!d || !1 !== d.call(this._.filebrowserSe, a, b)) if ("string" == typeof b && b && alert(b), a && (e = this._.filebrowserSe, c = e.getDialog(), e = e.filebrowser.target || null)) if (e = e.split(":"), d = c.getContentElement(e[0], e[1])) d.setValue(a), c.selectPage(e[0])
    }
    ...
    CKEDITOR.on("dialogDefinition",
      function (a) {
        if (a.editor.plugins.filebrowser) for (var b = a.data.definition, c, d = 0; d < b.contents.length; ++d) if (c = b.contents[d]) e(a.editor, a.data.name, b, c.elements), c.hidden && c.filebrowser && (c.hidden = !m(b, c.id, c.filebrowser))
      })
  }(),CKEDITOR.plugins.add("find", {
    requires: "dialog", init: function (a) {
      var d = a.addCommand("find", new CKEDITOR.dialogCommand("find")),
        b = a.addCommand("replace", new CKEDITOR.dialogCommand("find", {tabId: "replace"}));
      d.canUndo = !1;
      d.readOnly = 1;
      b.canUndo = !1;
    ...
    function a(a, b) {
      var e = c.exec(a), d = c.exec(b);
      if (e) {
        if (!e[2] && "px" == d[2]) return d[1];
        if ("px" == e[2] && !d[2]) return d[1] + "px"
      }
      return b
    }

    var d = CKEDITOR.htmlParser.cssStyle, b = CKEDITOR.tools.cssLength,
      c = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i, g = {
        elements: {
          $: function (b) {
            var c = b.attributes;
    ...
    CKEDITOR.editor.prototype.createFakeElement = function (a, c, e, g) {
      var m = this.lang.fakeobjects, m = m[e] || m.unknown;
      c = {
        "class": c,
      ...
      g && (c["data-cke-resizable"] = g, e = new d, g = a.getAttribute("width"),
        a = a.getAttribute("height"), g && (e.rules.width = b(g)), a && (e.rules.height = b(a)), e.populate(c));
      return this.document.createElement("img", {attributes: c})
    };
    CKEDITOR.editor.prototype.createFakeParserElement = function (a, c, e, g) {
      var m = this.lang.fakeobjects, m = m[e] || m.unknown, f;
          ...
          elements: {
            "cke:object": function (g) {
              ...
              if (!(k.classid && String(k.classid).toLowerCase() || a(g))) {
                for (k = 0; k < g.children.length; k++) if ("cke:embed" == g.children[k].name) {
    ...
    function a(a) {
      var g = a.config, l = a.fire("uiSpace", {space: "top", html: ""}).html, k = function () {
        function e(a, c, d) {
          h.setStyle(c, b(d));
        ...
        var l, m, w, r, u, t, A, x = g.floatSpaceDockedOffsetX || 0, z = g.floatSpaceDockedOffsetY || 0,
          C = g.floatSpacePinnedOffsetX || 0, y = g.floatSpacePinnedOffsetY || 0;
        return function (e) {
          if (m = a.editable()) {
            ...
            u = d.getViewPaneSize();
            t = w.height;
            A = "pageXOffset" in d.$ ? d.$.pageXOffset : CKEDITOR.document.$.documentElement.scrollLeft;
            l ? (t + z <=
            r.top ? f("top") : t + z > u.height - r.bottom ? f("pin") : f("bottom"), e = u.width / 2, e = g.floatSpacePreferRight ? "right" : 0 < r.left && r.right < u.width && r.width > w.width ? "rtl" == g.contentsLangDirection ? "right" : "left" : e - r.left > r.right - e ? "left" : "right", w.width > u.width ? (e = "left", n = 0) : (n = "left" == e ? 0 < r.left ? r.left : 0 : r.right < u.width ? u.width - r.right : 0, n + w.width > u.width && (e = "left" == e ? "right" : "left", n = 0)), h.setStyle(e, b(("pin" == l ? C : x) + n + ("pin" == l ? 0 : "left" == e ? A : -A)))) : (l = "pin", f("pin"), k(e))
          }
        }
      }();
      if (l) {
        var e = new CKEDITOR.template('\x3cdiv id\x3d"cke_{name}" class\x3d"cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} ' +
          ...
          h = CKEDITOR.document.getBody().append(CKEDITOR.dom.element.createFromHtml(e.output({
            ...
            voiceLabel: a.title
          }))), m = CKEDITOR.tools.eventsBuffer(500, k), f = CKEDITOR.tools.eventsBuffer(100, k);
        h.unselectable();
    ...
    var d = CKEDITOR.document.getWindow(), b = CKEDITOR.tools.cssLength;
      ...
      CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({
        base: CKEDITOR.ui.panel.block, $: function (a, b) {
          ...
          add: function (a, b, k) {
            ...
            for (var d in b) a = c.getById(b[d]), e = a.getNext(), a.setStyle("display", ""), e && "ul" == e.getName() && e.setStyle("display", "")
          }, mark: function (a) {
    ...
    CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
      $: function (a) {
        ...
        renderHtml: function (a) {
          ...
          var l =
            CKEDITOR.env, k = "cke_" + this.id, e = CKEDITOR.tools.addFunction(function (c) {
            p && (a.unlockSelection(1), p = 0);
            m.execute(c)
          }, this), h = this, m = {
            id: k, combo: this, focus: function () {
              CKEDITOR.document.getById(k).getChild(1).focus()
            }, execute: function (c) {
              var e = h._;
              if (e.state != CKEDITOR.TRISTATE_DISABLED) if (h.createPanel(a), e.on) e.panel.hide(); else {
                h.commit();
                var d = h.getValue();
                d ? e.list.mark(d) : e.list.unmarkAll();
                e.panel.showBlock(h.id, new CKEDITOR.dom.element(c), 4)
              }
            }, clickFn: e
          };
          ...
          if (!this._.panel) {
            var c = this._.panelDefinition, d = this._.panelDefinition.block,
              l = c.parent || CKEDITOR.document.getBody(), k = "cke_combopanel__" + this.name,
              e = new CKEDITOR.ui.floatPanel(a, l, c), c = e.addListBlock(this.id, d), h = this;
            e.onShow = function () {
    ...
    function a(a, c, g, l, k, e, h, m) {
      var f = a.config, n = new CKEDITOR.style(h), p = k.split(";");
      k = [];
      for (var q = {}, v = 0; v < p.length; v++) {
        var w = p[v];
        if (w) {
          var w = w.split("/"), r = {}, u = p[v] = w[0];
          r[g] = k[v] = w[1] || u;
          q[u] = new CKEDITOR.style(h, r);
      ...
      a.ui.addRichCombo(c, {
        ...
        init: function () {
          ...
          for (var e = 0; e < p.length; e++) c = p[e], this.add(c, q[c].buildPreview(), c)
        },
        onClick: function (c) {
          a.focus();
          a.fire("saveSnapshot");
          var e = this.getValue(), f = q[c], g, h, k, m, l;
          if (e && c != e) if (g = q[e], e = a.getSelection().getRanges()[0], e.collapsed) {
            if (h = a.elementPath(), k = h.contains(function (a) {
              return g.checkElementRemovable(a)
            })) {
              m = e.checkBoundaryOfElement(k, CKEDITOR.START);
              l = e.checkBoundaryOfElement(k, CKEDITOR.END);
              if (m && l) {
                for (m = e.createBookmark(); h = k.getFirst();) h.insertBefore(k);
                k.remove();
                e.moveToBookmark(m)
              } else m || l ? e.moveToPosition(k, m ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_END) : (e.splitElement(k),
        ...
        onRender: function () {
          a.on("selectionChange", function (c) {
            ...
            for (var f = 0, g; f < c.length; f++) {
              g = c[f];
              for (var h in q) if (q[h].checkElementMatch(g, !0, a)) {
                h != d && this.setValue(h);
                return
              }
            }
    ...
    function d(a, c, g) {
      var l = c.pop();
      if (l) {
        if (g) return d(a, c, l.equals(g) ? null : g);
        g = l.clone();
        a.insertNode(g);
    ...
    element: "span", styles: {"font-family": "#(family)"}, overrides: [{
      element: "font",
    ...
    requires: "richcombo", init: function (a) {
      if (!a.blockless) {
        for (var d = a.config, b = a.lang.format, c = d.format_tags.split(";"),
               g = {}, l = 0, k = [], e = 0; e < c.length; e++) {
          var h = c[e], m = new CKEDITOR.style(d["format_" + h]);
          if (!a.filter.customConfig || a.filter.check(m)) l++, g[h] = m, g[h]._.enterMode = a.config.enterMode, k.push(m)
        }
        0 !== l && a.ui.addRichCombo("Format", {
          ...
          onRender: function () {
            a.on("selectionChange", function (b) {
              ...
              b = b.data.path;
              this.refresh();
              for (var e in g) if (g[e].checkActive(b, a)) {
          ...
          refresh: function () {
            var b = a.elementPath();
            if (b) {
              if (b.isContextFor("p")) for (var c in g) if (a.activeFilter.check(g[c])) return;
              this.setState(CKEDITOR.TRISTATE_DISABLED)
            }
          }
        })
    ...
    {element: "h3"},CKEDITOR.config.format_h4 = {element: "h4"},CKEDITOR.config.format_h5 = {element: "h5"},CKEDITOR.config.format_h6 = {element: "h6"},CKEDITOR.plugins.add("forms", {
    requires: "dialog,fakeobjects", onLoad: function () {
      CKEDITOR.addCss(".cke_editable form{border: 1px dotted #FF0000;padding: 2px;}\n");
      CKEDITOR.addCss("img.cke_hidden{background-image: url(" + CKEDITOR.getUrl(this.path + "images/hiddenfield.gif") + ");background-position: center center;background-repeat: no-repeat;border: 1px solid #a9a9a9;width: 16px !important;height: 16px !important;}")
    },
    init: function (a) {
      var d = a.lang, b = 0, c = {email: 1, password: 1, search: 1, tel: 1, text: 1, url: 1}, g = {
        ...
        l = {
          ...
          var k = {allowedContent: g[e], requiredContent: l[e]};
          "form" == e && (k.context = "form");
      ...
      a.addMenuItems && (k = {
        checkbox: {
          label: d.forms.checkboxAndRadio.checkboxTitle, command: "checkbox",
          group: "checkbox"
        },
      ...
      var d = a.dataProcessor, b = d && d.htmlFilter, d = d && d.dataFilter;
    ...
    base: CKEDITOR.htmlParser.basicWriter, $: function () {
      ...
      this._.inPre = 0;
      this._.rules = {};
      var a = CKEDITOR.dtd, d;
      for (d in CKEDITOR.tools.extend({}, a.$nonBodyContent, a.$block, a.$listItem, a.$tableContent)) this.setRules(d, {
        indent: !a[d]["#"], breakBeforeOpen: 1, breakBeforeClose: !a[d]["#"], breakAfterClose: 1, needsSpace: d in
      ...
      openTagClose: function (a, d) {
        ...
        "string" == typeof d && (this.forceSimpleAmpersand && (d = d.replace(/&amp;/g, "\x26")), d = CKEDITOR.tools.htmlEncodeAttr(d));
        this._.output.push(" ", a, '\x3d"', d, '"')
      }, closeTag: function (a) {
        var d =
          this._.rules[a];
    ...
    var d = CKEDITOR.TRISTATE_DISABLED, b = CKEDITOR.TRISTATE_OFF;
      ...
      init: function (b) {
        ...
        b.on("dirChanged",
          function (a) {
            ...
            d.setStartBefore(e);
            d.setEndAfter(e);
            for (var g = new CKEDITOR.dom.walker(d), m; m = g.next();) if (m.type == CKEDITOR.NODE_ELEMENT) if (!m.equals(e) && m.getDirection()) d.setStartAfter(m), g = new CKEDITOR.dom.walker(d); else {
              var f = b.config.indentClasses;
              if (f) for (var n = "ltr" == a.data.dir ? ["_rtl", ""] : ["", "_rtl"], p = 0; p < f.length; p++) m.hasClass(f[p] + n[0]) && (m.removeClass(f[p] + n[0]), m.addClass(f[p] + n[1]));
    ...
    CKEDITOR.plugins.indent.specificDefinition.prototype =
      {
        execJob: function (a, b) {
          ...
          b = this.jobs[b];
          a.activeFilter.checkFeature(this) ? b.state = b.refresh.call(this, a, l) : b.state = d;
          return b.state
    ...
    function a(a, b, c) {
      if (!a.getCustomData("indent_processed")) {
        var g = this.editor, f = this.isIndent;
        if (b) {
    ...
    var b = CKEDITOR.dtd.$listItem, c = CKEDITOR.dtd.$list, g = CKEDITOR.TRISTATE_DISABLED, l = CKEDITOR.TRISTATE_OFF;
    CKEDITOR.plugins.add("indentblock", {
      requires: "indent", init: function (k) {
        function e() {
          ...
          this.contentTransformations = [["div: splitMarginShorthand"], ["h1: splitMarginShorthand"],
            ["h2: splitMarginShorthand"], ["h3: splitMarginShorthand"], ["h4: splitMarginShorthand"], ["h5: splitMarginShorthand"], ["h6: splitMarginShorthand"], ["ol: splitMarginShorthand"], ["p: splitMarginShorthand"], ["pre: splitMarginShorthand"], ["ul: splitMarginShorthand"]];
          ...
          this.jobs = {
            20: {
              refresh: function (a, c) {
                ...
                if (!e.is(b)) var h = e.getAscendant(b), e = h && c.contains(h) ||
                  e;
                e.is(b) && (e = e.getParent());
                if (this.enterBr || this.getContext(c)) {
                  if (m) {
                    var h = m, e = e.$.className.match(this.classNameRegex), k = this.isIndent,
                      h = e ? k ? e[1] != h.slice(-1) : !0 : k;
                    return h ? l : g
                  }
                  return this.isIndent ? l : e ? CKEDITOR[0 >= (parseInt(e.getStyle(d(e)), 10) || 0) ? "TRISTATE_DISABLED" : "TRISTATE_OFF"] : g
                }
                return g
              }, exec: function (b) {
                var e = b.getSelection(), e = e && e.getRanges()[0], d;
                if (d = b.elementPath().contains(c)) a.call(this, d, m); else for (e = e.createIterator(), b = b.config.enterMode, e.enforceRealBlocks = !0, e.enlargeBr =
        ...
        var h = CKEDITOR.plugins.indent, m = k.config.indentClasses;
        h.registerCommands(k, {indentblock: new e(k, "indentblock", !0), outdentblock: new e(k, "outdentblock")});
        CKEDITOR.tools.extend(e.prototype, h.specificDefinition.prototype, {
          context: {
            div: 1,
            dl: 1,
            h1: 1,
    ...
    function () {
      function a(a) {
        function c(d) {
          for (var h = l.startContainer, t = l.endContainer; h && !h.getParent().equals(d);) h = h.getParent();
          for (; t && !t.getParent().equals(d);) t = t.getParent();
          if (!h || !t) return !1;
          for (var A = [], x = !1; !x;) h.equals(t) && (x = !0), A.push(h), h = h.getNext();
          if (1 > A.length) return !1;
          h = d.getParents(!0);
          for (t = 0; t < h.length; t++) if (h[t].getName && k[h[t].getName()]) {
            d = h[t];
            break
          }
          for (var h = g.isIndent ? 1 : -1, t = A[0], A = A[A.length - 1], x = CKEDITOR.plugins.list.listToArray(d, f), z = x[A.getCustomData("listarray_index")].indent,
                 t = t.getCustomData("listarray_index"); t <= A.getCustomData("listarray_index"); t++) if (x[t].indent += h, 0 < h) {
            for (var v = x[t].parent, y = t - 1; 0 <= y; y--) if (x[y].indent === h) {
              v = x[y].parent;
              break
            }
            x[t].parent = new CKEDITOR.dom.element(v.getName(), v.getDocument())
          }
          for (t = A.getCustomData("listarray_index") + 1; t < x.length && x[t].indent > z; t++) x[t].indent += h;
          h = CKEDITOR.plugins.list.arrayToList(x, f, null, a.config.enterMode, d.getDirection());
          if (!g.isIndent) {
            var B;
            if ((B = d.getParent()) && B.is("li")) for (var A = h.listNode.getChildren(),
                                                          w = [], q, t = A.count() - 1; 0 <= t; t--) (q = A.getItem(t)) && q.is && q.is("li") && w.push(q)
          }
          h && h.listNode.replace(d);
          if (w && w.length) for (t = 0; t < w.length; t++) {
            for (q = d = w[t]; (q = q.getNext()) && q.is && q.getName() in k;) CKEDITOR.env.needsNbspFiller && !d.getFirst(b) && d.append(l.document.createText(" ")), d.append(q);
            d.insertAfter(B)
          }
        ...
        for (var g = this, f = this.database, k = this.context, l, q = a.getSelection(), q = (q && q.getRanges()).createIterator(); l = q.getNextRange();) {
          for (var v = l.getCommonAncestor(); v &&
          (v.type != CKEDITOR.NODE_ELEMENT || !k[v.getName()]);) {
          ...
          if (!v) {
            var w = l.getEnclosedNode();
            w && w.type == CKEDITOR.NODE_ELEMENT && w.getName() in k && (l.setStartAt(w, CKEDITOR.POSITION_AFTER_START), l.setEndAt(w, CKEDITOR.POSITION_BEFORE_END), v = w)
          }
          v && l.startContainer.type == CKEDITOR.NODE_ELEMENT && l.startContainer.getName() in k && (w = new CKEDITOR.dom.walker(l), w.evaluator = d, l.startContainer =
            w.next());
          v && l.endContainer.type == CKEDITOR.NODE_ELEMENT && l.endContainer.getName() in k && (w = new CKEDITOR.dom.walker(l), w.evaluator = d, l.endContainer = w.previous());
          if (v) return c(v)
        }
        return 0
      }
      ...
      var c = CKEDITOR.dom.walker.whitespaces(!0), g = CKEDITOR.dom.walker.bookmark(!1, !0),
        l = CKEDITOR.TRISTATE_DISABLED, k = CKEDITOR.TRISTATE_OFF;
          ...
          function c(b) {
            ...
            b.on("key", function (a) {
              ...
              if ("wysiwyg" == b.mode && a.data.keyCode == this.indentKey && c) {
                ...
                !e || this.isIndent && CKEDITOR.plugins.indentList.firstItemInPath(this.context, c, e) || (b.execCommand(this.relatedGlobal), a.cancel())
              }
            }, this);
            this.jobs[this.isIndent ? 10 : 30] = {
              refresh: this.isIndent ? function (a, b) {
                var c = this.getContext(b), e = CKEDITOR.plugins.indentList.firstItemInPath(this.context, b, c);
    ...
    function a(a, b) {
      b =
        void 0 === b || b;
      var d;
      if (b) d = a.getComputedStyle("text-align"); else {
    ...
    function d(a, b, d) {
      ...
      if (b) {
        ...
        this.requiredContent = k + "(" + this.cssClassName + ")"
    ...
    function b(a) {
      var b = a.editor, d = b.createRange();
      d.setStartBefore(a.data.node);
      d.setEndAfter(a.data.node);
      for (var k = new CKEDITOR.dom.walker(d), e; e = k.next();) if (e.type == CKEDITOR.NODE_ELEMENT) if (!e.equals(a.data.node) && e.getDirection()) d.setStartAfter(e), k = new CKEDITOR.dom.walker(d); else {
    ...
    d.prototype = {
      exec: function (b) {
        var d = b.getSelection(), l = b.config.enterMode;
        if (d) {
          for (var k = d.createBookmarks(), e = d.getRanges(), h = this.cssClassName, m, f, n = b.config.useComputedState, n = void 0 === n || n, p = e.length - 1; 0 <= p; p--) for (m = e[p].createIterator(), m.enlargeBr = l != CKEDITOR.ENTER_BR; f = m.getNextParagraph(l == CKEDITOR.ENTER_P ? "p" : "div");) if (!f.isReadOnly()) {
            var q = f.getName(), v;
            v = b.activeFilter.check(q +
              "{text-align}");
            if ((q = b.activeFilter.check(q + "(" + h + ")")) || v) {
              f.removeAttribute("align");
              f.removeStyle("text-align");
              var w = h && (f.$.className = CKEDITOR.tools.ltrim(f.$.className.replace(this.cssClassRegex, ""))),
                r = this.state == CKEDITOR.TRISTATE_OFF && (!n || a(f, !0) != this.value);
              h && q ? r ? f.addClass(h) : w || f.removeAttribute("class") : r && v && f.setStyle("text-align", this.value)
            }
          }
          b.focus();
        ...
        var l = d.block || d.blockLimit, k = l.getName(), e = l.equals(b.editable()),
    ...
    CKEDITOR.plugins.add("justify", {
      init: function (a) {
        if (!a.blockless) {
          var g = new d(a, "justifyleft", "left"), l = new d(a, "justifycenter", "center"),
          ...
          a.ui.addButton && (a.ui.addButton("JustifyLeft", {
            ...
            {label: a.lang.common.justify, command: "justifyblock", toolbar: "align,40"}));
          a.on("dirChanged", b)
        }
      }
    })
    ...
    CKEDITOR.plugins.add("language", {
      requires: "menubutton", init: function (a) {
        var d = a.config.language_list || ["ar:Arabic:rtl", "fr:French", "es:Spanish"], b = this, c = a.lang.language,
          g = {}, l, k, e, h;
        ...
        for (h = 0; h < d.length; h++) l = d[h].split(":"), k = l[0], e = "language_" + k, g[e] = {
          label: l[1],
          langId: k,
          group: "language",
          order: h,
        ...
        }, g[e].style = new CKEDITOR.style({element: "span", attributes: {lang: k, dir: g[e].ltr ? "ltr" : "rtl"}});
        g.language_remove = {
          label: c.remove, group: "language_remove", state: CKEDITOR.TRISTATE_DISABLED,
          order: g.length, onClick: function () {
        ...
        a.ui.add("Language", CKEDITOR.UI_MENUBUTTON, {
          ...
          command: "language",
          onMenu: function () {
            var c = {}, e = b.getCurrentLangElement(a), d;
        ...
        a = d && d.elements;
        var b;
        if (d) for (var c = 0; c < a.length; c++) d = a[c], !b && "span" == d.getName() && d.hasAttribute("dir") && d.hasAttribute("lang") && (b = d);
        return b
      }
    })
  }(),"use strict",function () {
    ...
    function d(a) {
      for (var b, c = a.length, e = [], d = 0; d < c; d++) b = a.charCodeAt(d), e.push(b);
      return "String.fromCharCode(" + e.join(",") + ")"
    }

    function b(b, c) {
      var e = b.plugins.link, d = e.compiledProtectionFunction.params, f, g;
      g = [e.compiledProtectionFunction.name, "("];
      for (var h = 0; h < d.length; h++) e = d[h].toLowerCase(), f = c[e], 0 < h && g.push(","), g.push("'", f ? a(encodeURIComponent(c[e])) : "", "'");
      g.push(")");
      return g.join("")
    }
    ...
    CKEDITOR.plugins.add("link", {
      requires: "dialog,fakeobjects", onLoad: function () {
        ...
        a.ui.addButton && (a.ui.addButton("Link", {
          ...
          {label: a.lang.link.anchor.toolbar, command: "anchor", toolbar: "links,30"}));
    ...
    var g = /^javascript:/, l = /^mailto:([^?]+)(?:\?(.+))?$/, k = /subject=([^;?:@&=$,\/]*)/i,
      e = /body=([^;?:@&=$,\/]*)/i, h = /^#(.*)$/, m = /^((?:http|https|ftp|news):\/\/)?(.*)$/,
    ...
    CKEDITOR.plugins.link = {
      getSelectedLink: function (a, b) {
        ...
        for (e = 0; e < d.length; e++) if (g = c.getRanges()[e], g.shrink(CKEDITOR.SHRINK_ELEMENT, !0, {skipBogus: !0}), (g = a.elementPath(g.getCommonAncestor()).contains("a", 1)) && b) f.push(g); else if (g) return g;
        return b ? f : null
        ...
        for (d = 0; f = c.getItem(d++);) (f = this.tryRestoreFakeAnchor(a, f)) && e.push({
        ...
        var c = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
          ...
          x = a.config.emailProtection, z, C = {};
        c.match(g) && ("encode" == x ? c = c.replace(n, function (a, b, c) {
          c = c || "";
          return "mailto:" + String.fromCharCode.apply(String, b.split(",")) + c.replace(/\\'/g, "'")
        }) : x && c.replace(p, function (a, b, c) {
          if (b == d.name) {
            C.type = "email";
            a = C.email = {};
            b = /(^')|('$)/g;
            c = c.match(/[^,\s]+/g);
            for (var e = c.length, f, g, h = 0; h < e; h++) f = decodeURIComponent, g = c[h].replace(b, "").replace(/\\'/g, "'"), g = f(g), f = d.params[h].toLowerCase(), a[f] = g;
            a.address = [a.name, a.domain].join("@")
          }
        }));
        if (!C.type) if (x = c.match(h)) C.type =
          "anchor", C.anchor = {}, C.anchor.name = C.anchor.id = x[1]; else if (x = c.match(l)) {
          z = c.match(k);
          c = c.match(e);
          C.type = "email";
          var y = C.email = {};
          y.address = x[1];
          z && (y.subject = decodeURIComponent(z[1]));
          c && (y.body = decodeURIComponent(c[1]))
        } else c && (z = c.match(m)) && (C.type = "url", C.url = {}, C.url.protocol = z[1], C.url.url = z[2]);
        if (b) {
          if (c = b.getAttribute("target")) C.target = {
            type: c.match(f) ? c : "frame",
            name: c
          }; else if (c = (c = b.data("cke-pa-onclick") || b.getAttribute("onclick")) && c.match(q)) for (C.target = {
            type: "popup",
            name: c[1]
          }; x =
                                                                                                            v.exec(c[2]);) "yes" != x[2] && "1" != x[2] || x[1] in {
            height: 1,
            width: 1,
            top: 1,
            left: 1
          } ? isFinite(x[2]) && (C.target[x[1]] = x[2]) : C.target[x[1]] = !0;
          null !== b.getAttribute("download") && (C.download = !0);
          var c = {}, B;
          for (B in w) (x = b.getAttribute(B)) && (c[w[B]] = x);
        ...
        switch (e.type) {
          ...
          case "anchor":
            ...
            break;
          case "email":
            var k = e.email, h = k.address;
            switch (f) {
              case "":
              case "encode":
                var l = encodeURIComponent(k.subject || ""), m = encodeURIComponent(k.body || ""), k = [];
                l && k.push("subject\x3d" + l);
                m && k.push("body\x3d" + m);
                k = k.length ? "?" + k.join("\x26") : "";
                "encode" == f ? (f = ["javascript:void(location.href\x3d'mailto:'+",
                  d(h)], k && f.push("+'", a(k), "'"), f.push(")")) : f = ["mailto:", h, k];
                break;
              default:
        ...
        if (e.target) if ("popup" == e.target.type) {
          for (var f = ["window.open(this.href, '", e.target.name || "", "', '"], n = "resizable status location toolbar menubar fullscreen scrollbars dependent".split(" "), h = n.length, l = function (a) {
            e.target[a] && n.push(a + "\x3d" + e.target[a])
          }, k = 0; k < h; k++) n[k] += e.target[n[k]] ? "\x3dyes" : "\x3dno";
          l("width");
          l("left");
          l("height");
          l("top");
        ...
        if (e.advanced) {
          for (var v in w) (f = e.advanced[w[v]]) && (g[v] = f);
          g.name && (g["data-cke-saved-name"] = g.name)
        }
        g["data-cke-saved-href"] && (g.href = g["data-cke-saved-href"]);
        v = {target: 1, onclick: 1, "data-cke-pa-onclick": 1, "data-cke-saved-name": 1, download: 1};
        e.advanced && CKEDITOR.tools.extend(v, w);
        for (var p in g) delete v[p];
        return {set: g, removed: CKEDITOR.tools.objectKeys(v)}
      }, showDisplayTextForElement: function (a, b) {
        var c = {img: 1, table: 1, tbody: 1, thead: 1, tfoot: 1, input: 1, select: 1, textarea: 1},
          e = b.getSelection();
        return b.widgets && b.widgets.focused || e && 1 < e.getRanges().length ? !1 : !a || !a.getName || !a.is(c)
      }
    };
        ...
        if (CKEDITOR.env.ie) {
          var b = a.getSelection().getRanges()[0],
            c = b.getPreviousEditableNode() && b.getPreviousEditableNode().getAscendant("a", !0) ||
              b.getNextEditableNode() && b.getNextEditableNode().getAscendant("a", !0), e;
    ...
    CKEDITOR.removeAnchorCommand.prototype = {
      exec: function (a) {
        ...
        if (b && (e = b.getSelectedElement()) && (e.getChildCount() ? e.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(a, e))) e.remove(1); else if (e = CKEDITOR.plugins.link.getSelectedLink(a)) e.hasAttribute("href") ? (e.removeAttributes({
            name: 1,
    ...
    function a(a, b, c) {
      ...
      for (g = h + 1; g < d.length; g++) if (d[g].indent > d[g - 1].indent + 1) {
        f = d[g - 1].indent + 1 - d[g].indent;
        for (h = d[g].indent; d[g] && d[g].indent >= h;) d[g].indent += f, g++;
        g--
      }
      var k = CKEDITOR.plugins.list.arrayToList(d, c, null, a.config.enterMode, b.root.getAttribute("dir")).listNode, l,
        m;
      e(!0);
      e();
      k.replace(b.root);
    ...
    function b(a, b, c, e) {
      for (var d, f; d = a[e ? "getLast" : "getFirst"](q);) (f = d.getDirection(1)) !== b.getDirection(1) && d.setAttribute("dir", f), d.remove(), c ? d[e ? "insertBefore" : "insertAfter"](c) : b.append(d, e)
    }
    ...
    function l(a, e, d) {
      ...
      e.trim(!1, !0);
      var h = e.createBookmark(), l = new CKEDITOR.dom.elementPath(e.startContainer), m = l.block,
        l = l.lastElement.getAscendant("li", 1) || m, z = new CKEDITOR.dom.elementPath(d.startContainer),
        p = z.contains(CKEDITOR.dtd.$listItem),
        z = z.contains(CKEDITOR.dtd.$list);
      m ? (m = m.getBogus()) && m.remove() : z && (m = z.getPrevious(f)) && n(m) && m.remove();
    ...
    function k(a) {
      return (a = a.getLast(f)) && a.type == CKEDITOR.NODE_ELEMENT && a.getName() in e ? a : null
    }

    var e = {ol: 1, ul: 1}, h = CKEDITOR.dom.walker.whitespaces(), m = CKEDITOR.dom.walker.bookmark(),
      f = function (a) {
        return !(h(a) || m(a))
    ...
    CKEDITOR.plugins.list = {
      listToArray: function (a, b, c, d, f) {
        ...
        for (var h, k = a[c].parent.getDocument(), l = new CKEDITOR.dom.documentFragment(k), n = null, y = c, p = Math.max(a[c].indent, 0), q =
          null, D, F, I = d == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
          var H = a[y];
          h = H.grandparent;
          D = H.element.getDirection(1);
          if (H.indent == p) {
            n && a[y].parent.getName() == n.getName() || (n = a[y].parent.clone(!1, 1), g && n.setAttribute("dir", g), l.append(n));
            q = n.append(H.element.clone(0, 1));
            D != n.getDirection(1) && q.setAttribute("dir", D);
            for (h = 0; h < H.contents.length; h++) q.append(H.contents[h].clone(1, 1));
            y++
          } else if (H.indent == Math.max(p, 0) + 1) H = a[y - 1].element.getDirection(1), y = CKEDITOR.plugins.list.arrayToList(a, null, y, d, H != D ? D : null), !q.getChildCount() &&
          CKEDITOR.env.needsNbspFiller && 7 >= k.$.documentMode && q.append(k.createText(" ")), q.append(y.listNode), y = y.nextIndex; else if (-1 == H.indent && !c && h) {
            e[h.getName()] ? (q = H.element.clone(!1, !0), D != h.getDirection(1) && q.setAttribute("dir", D)) : q = new CKEDITOR.dom.documentFragment(k);
            var n = h.getDirection(1) != D, J = H.element, K = J.getAttribute("class"), E = J.getAttribute("style"),
              R = q.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (d != CKEDITOR.ENTER_BR || n || E || K), O,
              S = H.contents.length, L;
            for (h = 0; h < S; h++) if (O = H.contents[h], m(O) &&
            1 < S) R ? L = O.clone(1, 1) : q.append(O.clone(1, 1)); else if (O.type == CKEDITOR.NODE_ELEMENT && O.isBlockBoundary()) {
              n && !O.getDirection() && O.setAttribute("dir", D);
              F = O;
              ...
              F = null;
              L && (q.append(L), L = null);
              q.append(O.clone(1, 1))
            } else R ? (F || (F = k.createElement(I), q.append(F), n && F.setAttribute("dir", D)), E && F.setAttribute("style", E), K && F.setAttribute("class", K), L && (F.append(L), L = null), F.append(O.clone(1,
              1))) : q.append(O.clone(1, 1));
            L && ((F || q).append(L), L = null);
            q.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && y != a.length - 1 && (CKEDITOR.env.needsBrFiller && (D = q.getLast()) && D.type == CKEDITOR.NODE_ELEMENT && D.is("br") && D.remove(), (D = q.getLast(f)) && D.type == CKEDITOR.NODE_ELEMENT && D.is(CKEDITOR.dtd.$block) || q.append(k.createElement("br")));
          ...
          F = null;
          if (a.length <= y || Math.max(a[y].indent, 0) < p) break
        }
        if (b) for (a = l.getFirst(); a;) {
          if (a.type ==
            CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(b, a), a.getName() in CKEDITOR.dtd.$listItem && (c = a, k = g = d = void 0, d = c.getDirection()))) {
            for (g = c.getParent(); g && !(k = g.getDirection());) g = g.getParent();
            d == k && c.removeAttribute("dir")
          }
          a = a.getNextSourceNode()
        }
        return {listNode: l, nextIndex: y}
      }
    };
    var p = /^h[1-6]$/, q = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT);
    d.prototype = {
      exec: function (b) {
        this.refresh(b, b.elementPath());
        var d = b.config, g = b.getSelection(), h = g && g.getRanges();
        if (this.state == CKEDITOR.TRISTATE_OFF) {
          ...
          } else d.enterMode == CKEDITOR.ENTER_BR ? k.appendBogus() : h[0].fixBlock(1, d.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), g.selectRanges(h)
        }
        for (var d = g.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0; (l = h.getNextRange()) && ++n;) {
          var q = l.getBoundaryNodes(), y = q.startNode, B = q.endNode;
          y.type == CKEDITOR.NODE_ELEMENT && "td" == y.getName() && l.setStartAt(q.startNode, CKEDITOR.POSITION_AFTER_START);
          B.type == CKEDITOR.NODE_ELEMENT && "td" == B.getName() && l.setEndAt(q.endNode, CKEDITOR.POSITION_BEFORE_END);
          l = l.createIterator();
          for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; q = l.getNextParagraph();) if (!q.getCustomData("list_block")) {
            CKEDITOR.dom.element.setMarker(m, q, "list_block", 1);
            for (var G = b.elementPath(q), y = G.elements, B = 0, G = G.blockLimit, D, F = y.length - 1; 0 <= F && (D = y[F]); F--) if (e[D.getName()] && G.contains(D)) {
              G.removeCustomData("list_group_object_" + n);
              (y = D.getCustomData("list_group_object")) ? y.contents.push(q) :
                (y = {root: D, contents: [q]}, k.push(y), CKEDITOR.dom.element.setMarker(m, D, "list_group_object", y));
              B = 1;
              break
            }
            B || (B = G, B.getCustomData("list_group_object_" + n) ? B.getCustomData("list_group_object_" + n).contents.push(q) : (y = {
              root: B,
              contents: [q]
            }, CKEDITOR.dom.element.setMarker(m, B, "list_group_object_" + n, y), k.push(y)))
          }
        }
        for (D = []; 0 < k.length;) if (y = k.shift(), this.state == CKEDITOR.TRISTATE_OFF) if (e[y.root.getName()]) {
          h = b;
          n = y;
          y = m;
          l = D;
          B = CKEDITOR.plugins.list.listToArray(n.root, y);
          G = [];
          for (q = 0; q < n.contents.length; q++) F =
            n.contents[q], (F = F.getAscendant("li", !0)) && !F.getCustomData("list_item_processed") && (G.push(F), CKEDITOR.dom.element.setMarker(y, F, "list_item_processed", !0));
          for (var F = n.root.getDocument(), I = void 0, H = void 0, q = 0; q < G.length; q++) {
            var J = G[q].getCustomData("listarray_index"), I = B[J].parent;
            I.is(this.type) || (H = F.createElement(this.type), I.copyAttributes(H, {
              start: 1,
              type: 1
            }), H.removeStyle("list-style-type"), B[J].parent = H)
          }
          y = CKEDITOR.plugins.list.arrayToList(B, y, null, h.config.enterMode);
          B = void 0;
          G = y.listNode.getChildCount();
          for (q = 0; q < G && (B = y.listNode.getChild(q)); q++) B.getName() == this.type && l.push(B);
          ...
          B = y = void 0;
          I = void 0 === I || I;
          for (F = 0; F < G.length; F++) for (H = G[F]; J = H.getParent();) {
            if (J.equals(l)) {
              n.push(H);
          ...
          if (!(1 > n.length)) {
            ...
            q.push(F);
            for (I = q = void 0; n.length;) q = n.shift(), I = h.createElement("li"), H = q, H.is("pre") || p.test(H.getName()) || "false" == H.getAttribute("contenteditable") ? q.appendTo(I) : (q.copyAttributes(I), y && q.getDirection() && (I.removeStyle("direction"), I.removeAttribute("dir")), q.moveChildren(I), q.remove()), I.appendTo(F);
            y && B && F.setAttribute("dir", y);
            G ? F.insertBefore(G) :
              F.appendTo(l)
          }
        } else this.state == CKEDITOR.TRISTATE_ON && e[y.root.getName()] && a.call(this, b, y, m);
        for (F = 0; F < D.length; F++) c(D[F]);
        CKEDITOR.dom.element.clearAllMarkers(m);
        g.selectBookmarks(d);
        b.focus()
      }, refresh: function (a, b) {
        var c = b.contains(e, 1), d = b.blockLimit || b.root;
    ...
    CKEDITOR.plugins.add("list", {
      requires: "indentlist", init: function (a) {
        a.blockless || (a.addCommand("numberedlist",
          new d("numberedlist", "ol")), a.addCommand("bulletedlist", new d("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton("NumberedList", {
          ...
          if ("wysiwyg" == a.mode && c in {8: 1, 46: 1}) {
            var h = a.getSelection().getRanges()[0], m = h && h.startPath();
            if (h && h.collapsed) {
              var p =
                8 == c, q = a.editable(), C = new CKEDITOR.dom.walker(h.clone());
              C.evaluator = function (a) {
                return f(a) && !n(a)
              };
              ...
              if (p) {
                var y;
                (y = m.contains(e)) && h.checkBoundaryOfElement(y, CKEDITOR.START) && (y = y.getParent()) && y.is("li") && (y = k(y)) ? (d = y, y = y.getPrevious(f), c.moveToPosition(y && n(y) ? y : d, CKEDITOR.POSITION_BEFORE_START)) : (C.range.setStartAt(q, CKEDITOR.POSITION_AFTER_START), C.range.setEnd(h.startContainer, h.startOffset), (y = C.previous()) &&
                y.type == CKEDITOR.NODE_ELEMENT && (y.getName() in e || y.is("li")) && (y.is("li") || (C.range.selectNodeContents(y), C.reset(), C.evaluator = g, y = C.previous()), d = y, c.moveToElementEditEnd(d), c.moveToPosition(c.endPath().block, CKEDITOR.POSITION_BEFORE_END)));
                if (d) l(a, c, h), b.cancel(); else {
                  var B = m.contains(e);
                  B && h.checkBoundaryOfElement(B, CKEDITOR.START) && (d = B.getFirst(f), h.checkBoundaryOfElement(d, CKEDITOR.START) && (y = B.getPrevious(f), k(d) ? y && (h.moveToElementEditEnd(y), h.select()) : a.execCommand("outdent"), b.cancel()))
                }
              } else if (d =
                m.contains("li")) {
                if (C.range.setEndAt(q, CKEDITOR.POSITION_BEFORE_END), p = (q = d.getLast(f)) && g(q) ? q : d, m = 0, (y = C.next()) && y.type == CKEDITOR.NODE_ELEMENT && y.getName() in e && y.equals(q) ? (m = 1, y = C.next()) : h.checkBoundaryOfElement(p, CKEDITOR.END) && (m = 2), m && y) {
                  h = h.clone();
                  h.moveToElementEditStart(y);
                  if (1 == m && (c.optimize(), !c.startContainer.equals(d))) {
                    for (d = c.startContainer; d.is(CKEDITOR.dtd.$inline);) B = d, d = d.getParent();
    ...
    function b(a) {
      var b = a.element;
      if (b && n(b) && (b = b.getAscendant(a.triggers,
        !0)) && a.editable.contains(b)) {
        var c = k(b);
    ...
    function e(a) {
      ...
      B(c, {
        ...
        lineChildren: [B(D('\x3cspan title\x3d"' + a.editor.lang.magicline.title + '" contenteditable\x3d"false"\x3e\x26#8629;\x3c/span\x3e',
          b), {
          base: U + "height:17px;width:17px;" + (a.rtl ? "left" : "right") + ":17px;background:url(" + e + ") center no-repeat " + a.boxColor + ";cursor:pointer;" + (F.hc ? "font-size: 15px;line-height:14px;border:1px solid #fff;text-align:center;" : "") + (F.hidpi ? "background-size: 9px 10px;" : ""),
        ...
        place: function () {
          var b = a.view,
            c = a.editable, e = a.trigger, d = e.upper, f = e.lower, g = d || f, h = g.getParent(), k = {};
          this.trigger = e;
          d && x(a, d, !0);
          f && x(a, f, !0);
          x(a, h, !0);
      ...
      c.lineChildren[0].on("mouseup",
        function (b) {
          ...
          h(a, function (b) {
            ...
            b[c.is(K) ? "insertBefore" : "insertAfter"](c.is(K) ? c.lower : c.upper)
          }, !0);
          a.editor.focus();
    ...
    function h(a, b, c) {
      var e = new CKEDITOR.dom.range(a.doc), d = a.editor, f;
      F.ie && a.enterMode == CKEDITOR.ENTER_BR ? f = a.doc.createText(Z) : (f = (f = k(a.element, !0)) && f.data("cke-enter-mode") || a.enterMode, f = new G(J[f],
      ...
      return {
        canUndo: !0, modes: {wysiwyg: 1}, exec: function () {
          ...
          return function (d) {
            ...
            if (!w(a, d) && d && !d.equals(a.editable) && !d.contains(a.editable)) {
    ...
    function w(a, b) {
      if (!b) return !1;
      for (var c = b.getParents(1), e = c.length; e--;) for (var d = a.tabuList.length; d--;) if (c[e].hasAttribute(a.tabuList[d])) return !0;
      return !1
    }
    ...
    function u(a) {
      ...
      x(a, b);
      return !h && 0 <= b.size.top && l(c.y, 0, b.size.top + g) ? (a = a.inInlineMode || 0 === e.scroll.y ? S : V, new d([null, b, K, O, a])) : h && b.size.bottom <= e.pane.height && l(c.y, b.size.bottom - g, e.pane.height) ? (a = a.inInlineMode || l(b.size.bottom, e.pane.height - g, e.pane.height) ? L : V, new d([b, null, E, O, a])) : null
    }

    function t(a) {
      var c =
        a.mouse, e = a.view, f = a.triggerOffset, h = b(a);
      if (!h) return null;
      x(a, h);
      var f = Math.min(f, 0 | h.size.outerHeight / 2), k = [], m, N;
      if (l(c.y, h.size.top - 1, h.size.top + f)) N = !1; else if (l(c.y, h.size.bottom - f, h.size.bottom + 1)) N = !0; else return null;
      if (p(h) || r(a, h, N) || h.getParent().is(X)) return null;
      var y = g(a, h, !N);
      if (y) {
        if (y && y.type == CKEDITOR.NODE_TEXT) return null;
        if (n(y)) {
          if (p(y) || !v(a, y) || y.getParent().is(X)) return null;
          k = [y, h][N ? "reverse" : "concat"]().concat([R, O])
        }
      } else h.equals(a.editable[N ? "getLast" : "getFirst"](a.isRelevant)) ?
        (z(a), N && l(c.y, h.size.bottom - f, e.pane.height) && l(h.size.bottom, e.pane.height - f, e.pane.height) ? m = L : l(c.y, 0, h.size.top + f) && (m = S)) : m = V, k = [null, h][N ? "reverse" : "concat"]().concat([N ? E : K, O, m, h.equals(a.editable[N ? "getLast" : "getFirst"](a.isRelevant)) ? N ? L : S : V]);
    ...
    function A(a, b, c, e) {
      ...
      return B({border: f, padding: h, margin: g, ignoreScroll: c},
        k, !0)
    }
    ...
    function x(a, b, c) {
      ...
      return B(b.size, A(a, b, c), {date: +new Date}, !0)
    }
    ...
    function C(a, b) {
      ...
      if (!(!b && c && c.date > new Date - M)) {
        var e = a.win, c = e.getScrollPosition(), e = e.getViewPaneSize();
        B(a.view, {
          scroll: {
            x: c.x,
            y: c.y,
    ...
    function y(a, b, c, e) {
      for (var f = e, g = e, h = 0, k = !1, l = !1, m = a.view.pane.height, n = a.mouse; n.y + h < m && 0 < n.y - h;) {
        k || (k = b(f, e));
        l || (l = b(g, e));
        !k && 0 < n.y - h && (f = c(a, {x: n.x, y: n.y - h}));
        !l && n.y + h < m && (g = c(a, {x: n.x, y: n.y + h}));
        if (k && l) break;
        h += 2
      }
    ...
    CKEDITOR.plugins.add("magicline", {
      init: function (a) {
        ...
        a.on("contentDom", function () {
          var k = a.editable(), n = a.document, p = a.window;
          B(l, {editable: k, inInlineMode: k.isInline(), doc: n, win: p, hotNode: null}, !0);
          ...
          k.is(H.$inline) || (l.inInlineMode && !q(k) && k.setStyles({
            ...
            top: null,
            left: null
          }), e.call(this, l), C(l), k.attachListener(a, "beforeUndoImage", function () {
            l.line.detach()
            ...
            if ("wysiwyg" == a.mode) if (l.inInlineMode) {
              ...
              C(l);
              z(l, !0);
              var e = l.view.editable, d = l.view.scroll;
              c > e.left - d.x && c < e.right - d.x && b > e.top - d.y && b < e.bottom - d.y || (clearTimeout(r), r = null, l.line.detach())
            ...
            if ("wysiwyg" == a.mode &&
              ...
              r = setTimeout(function () {
                ...
                r = l.trigger = null;
                C(l);
                y && !l.hiddenMode && a.focusManager.hasFocus && !l.line.mouseNear() && (l.element = W(l, !0)) && ((l.trigger = u(l) || t(l) || Y(l)) && !w(l, l.trigger.upper || l.trigger.lower) ? l.line.attach().place() : (l.trigger = null, l.line.detach()), y = !1)
              }, 30)
            }
            ...
            l.hiddenMode = 0;
            l.mouseDown = 0
          }), a.addCommand("accessPreviousSpace", m(l)), a.addCommand("accessNextSpace", m(l, !0)), a.setKeystroke([[c.magicline_keystrokePrevious, "accessPreviousSpace"], [c.magicline_keystrokeNext, "accessNextSpace"]]), a.on("loadSnapshot", function () {
            var b, c, e, d;
            for (d in{p: 1, br: 1, div: 1}) for (b = a.document.getElementsByTag(d),
                                                   e = b.count(); e--;) if ((c = b.getItem(e)).data("cke-magicline-hot")) {
              l.hotNode = c;
    ...
    var B = CKEDITOR.tools.extend, G = CKEDITOR.dom.element, D = G.createFromHtml, F = CKEDITOR.env,
      I = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, H = CKEDITOR.dtd, J = {}, K = 128, E = 64, R = 32, O = 16, S = 4,
      L = 2,
      V = 1, Z = " ", X = H.$listItem, da = H.$tableContent, P = B({}, H.$nonEditable, H.$empty), Q = H.$block, M = 100,
      ...
      T = U + "border-color:transparent;display:block;border-style:solid;", N = "\x3cspan\x3e" + Z + "\x3c/span\x3e";
    ...
    var W = function () {
      ...
      }(), aa = CKEDITOR.dom.walker.whitespaces(), ba = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT),
      Y = function () {
        function b(d) {
          var f =
            d.element, g, h, k;
          ...
          for (var f = Number.MAX_VALUE, m, N, p, t; h && !h.equals(g) && (N = g.getNext(d.isRelevant));) m = Math.abs(c(d, g, N) - d.mouse.y), m < f && (f = m, p = g, t = N), g = N, x(d, g);
          if (!p || !t || !l(d.mouse.y, p.size.top, t.size.bottom)) return null;
          k.upper = p;
          k.lower = t;
          return k.set(R, 8)
        }
    ...
    function a(a) {
      ...
      for (var b = [], c = ["style", "className"], d = 0; d < c.length; d++) {
        ...
        g && (g = new CKEDITOR.dom.element(g), b.push([g, g.nextSibling]), g.remove())
      }
      return b
    }
    ...
    function c(b, c) {
      var e = a(b), g = b.$;
      "class" in c && (g.className = c["class"]);
      "inline" in c && (g.style.cssText = c.inline);
      d(e)
    }
    ...
    CKEDITOR.plugins.add("maximize", {
      init: function (a) {
        ...
        if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
          var e = a.lang, h = CKEDITOR.document, m = h.getWindow(), f, n, p, q = CKEDITOR.TRISTATE_OFF;
          a.addCommand("maximize",
            {
              ...
              exec: function () {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                  ...
                  w = {overflow: CKEDITOR.env.webkit ? "" : "hidden", width: 0, height: 0};
                  ...
                  d();
                  w = v.getDocumentPosition();
                  v.setStyles({left: -1 * w.x + "px", top: -1 * w.y + "px"});
                  CKEDITOR.env.gecko && g(a)
                } else if (this.state == CKEDITOR.TRISTATE_ON) {
                  m.removeListener("resize", d);
                  for (var r = [w, v], t = 0; t < r.length; t++) c(r[t], r[t].getCustomData("maximize_saved_styles")), r[t].removeCustomData("maximize_saved_styles");
                ...
                this.toggleState();
                if (r =
                  this.uiItems[0]) w = this.state == CKEDITOR.TRISTATE_OFF ? e.maximize.maximize : e.maximize.minimize, r = CKEDITOR.document.getById(r._.id), r.getChild(1).setHtml(w), r.setAttribute("title", w), r.setAttribute("href", 'javascript:void("' + w + '");');
    ...
    CKEDITOR.plugins.add("pagebreak", {
      requires: "fakeobjects", onLoad: function () {
        ...
        function b(b) {
          CKEDITOR.tools.extend(b.attributes, a(d.lang.pagebreak.alt), !0);
          b.children.length = 0
        }

        var c = d.dataProcessor, g = c && c.dataFilter, c = c && c.htmlFilter, l = /page-break-after\s*:\s*always/i,
    ...
    CKEDITOR.plugins.pagebreakCmd = {
      exec: function (d) {
        var b = d.document.createElement("div", {attributes: a(d.lang.pagebreak.alt)});
        d.insertElement(b)
      }, context: "div",
      allowedContent: {
    ...
    CKEDITOR.plugins.add("pastefromword", {
      requires: "clipboard", init: function (d) {
        function b(a) {
          ...
          }, this), c.length === d.length)))) for (b = 0; b < c.length; b++) 0 === c[b].indexOf("file://") && d[b] && (a.data.dataValue = a.data.dataValue.replace(c[b],
            d[b]))
        }
        ...
        d.on("paste", function (b) {
          var e = b.data, h = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ?
            ...
            h = h || e.dataValue, f = {dataValue: h, dataTransfer: {"text/rtf": l}},
          ...
          if (h && (c || l) && (!1 !== d.fire("pasteFromWord", f) || c)) {
            ...
            var n = a(d, g, function () {
              if (n) d.fire("paste", e); else if (!d.config.pasteFromWordPromptCleanup ||
    ...
    var a = {
      canUndo: !1, async: !0, exec: function (a, b) {
        var c = a.lang, g = CKEDITOR.tools.keystrokeToString(c.common.keyboard,
    ...
    var a, d = {
      modes: {wysiwyg: 1, source: 1}, canUndo: !1, readOnly: 1, exec: function (b) {
        var c,
          d = b.config, l = d.baseHref ? '\x3cbase href\x3d"' + d.baseHref + '"/\x3e' : "";
        if (d.fullPage) c = b.getData().replace(/<head>/, "$\x26" + l).replace(/[^>]*(?=<\/title>)/, "$\x26 \x26mdash; " + b.lang.preview.preview); else {
          var d = "\x3cbody ", k = b.document && b.document.getBody();
        ...
        k = 80;
        try {
          var e = window.screen, l = Math.round(.8 * e.width), d = Math.round(.7 * e.height),
            k = Math.round(.1 * e.width)
        } catch (h) {
        }
    ...
    init: function (a) {
      a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE && (a.addCommand("print", CKEDITOR.plugins.print), a.ui.addButton && a.ui.addButton("Print", {
        ...
        command: "print", toolbar: "document,50"
      }))
    }
      ...
      removeformat: {
        exec: function (a) {
          for (var d =
            ...
            var h = e.createBookmark(), m = h.startNode, f = h.endNode, n = function (b) {
              for (var e = a.elementPath(b),
                     f = e.elements, g = 1, h; (h = f[g]) && !h.equals(e.block) && !h.equals(e.blockLimit); g++) d.test(h.getName()) && c(a, h) && b.breakParent(h)
            };
            n(m);
            if (f) for (n(f), m = m.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); m && !m.equals(f);) if (m.isReadOnly()) {
              if (m.getPosition(f) & CKEDITOR.POSITION_CONTAINS) break;
              m = m.getNext(k)
            } else n = m.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), "img" == m.getName() && m.data("cke-realelement") || !c(a, m) || (d.test(m.getName()) ? m.remove(1) : (m.removeAttributes(b), a.fire("removeFormatCleanup", m))), m = n;
            e.moveToBookmark(h)
          }
          a.forceNextSelectionCheck();
    ...
    CKEDITOR.plugins.add("resize", {
      init: function (a) {
        function d(b) {
          var d = h.width, g = h.height, k = d + (b.data.$.screenX - e.x) * ("rtl" == l ? -1 : 1);
        ...
        var c = a.config, g = a.ui.spaceId("resizer"), l = a.element ? a.element.getDirection(1) : "ltr";
        ...
        if (!1 !== c.resize_enabled) {
          var k = null, e, h,
            m = ("both" == c.resize_dir || "horizontal" == c.resize_dir) && c.resize_minWidth != c.resize_maxWidth,
            f = ("both" == c.resize_dir || "vertical" ==
              c.resize_dir) && c.resize_minHeight != c.resize_maxHeight, n = CKEDITOR.tools.addFunction(function (f) {
              k || (k = a.getResizable());
          ...
          a.on("uiSpace", function (b) {
            if ("bottom" == b.data.space) {
              ...
              var e = '\x3cspan id\x3d"' + g + '" class\x3d"cke_resizer' + c + " cke_resizer_" + l + '" title\x3d"' + CKEDITOR.tools.htmlEncode(a.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event)"\x3e' + ("ltr" == l ? "◢" : "◣") + "\x3c/span\x3e";
    ...
    CKEDITOR.plugins.add("save", {
      init: function (d) {
        d.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE && (d.addCommand("save", a).startDisabled = !d.element.$.form, d.ui.addButton && d.ui.addButton("Save", {
    ...
    requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", onLoad: function (a) {
      ...
      if ((c = ["grayt_description", "grayt_suggest", "grayt_control"].concat(c)) &&
        c.length) for (g = 0; g < c.length; g++) a.addMenuGroup(c[g], g - 10);
      ...
      var d = CKEDITOR.plugins.scayt, b = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE, c = function () {
        d.destroy(a)
      }, g = function () {
        ...
        c.attachListener(c, "focus", function (c) {
          ...
          if ((b || c) && a._.savedSelection) {
            ...
            c =
              !c && a._.savedSelection.getRanges();
      ...
      a.on("beforeCommandExec", function (b) {
        ...
        b.data.name in d.options.disablingCommandExec && "wysiwyg" == a.mode ? c && (d.destroy(a), a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED)) : "bold" !== b.data.name && "italic" !== b.data.name && "underline" !== b.data.name && "strike" !== b.data.name && "subscript" !== b.data.name && "superscript" !== b.data.name && "enter" !== b.data.name &&
          "cut" !== b.data.name && "language" !== b.data.name || !c || ("cut" === b.data.name && (k = !1, f = !0), "language" === b.data.name && (f = g = !0), a.fire("reloadMarkupScayt", {
            removeOptions: {
              removeInside: k,
              forceBookmark: f,
              language: g
      ...
      a.on("reloadMarkupScayt", function (b) {
        var c =
          b.data && b.data.removeOptions, g = b.data && b.data.timeout, f = b.data && b.data.language, k = a.scayt;
      ...
      "boolean" !== typeof a.config.grayt_autoStartup && (a.config.grayt_autoStartup =
        !1);
      ...
      if (a.config.scayt_disableOptionsStorage) {
        var d = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ? [a.config.scayt_disableOptionsStorage] : void 0,
          ...
          k = CKEDITOR.tools.search, e = CKEDITOR.tools.indexOf;
        a.config.scayt_disableOptionsStorage = function (a) {
          for (var b = [], c = 0; c < a.length; c++) {
            var d = a[c], p = !!k(a, "options");
            if (!k(g, d) || p && k(l, function (a) {
              if ("lang" === a) return !1
            })) return;
            k(l, d) && l.splice(e(l, d), 1);
            if ("all" === d || p && k(a, "lang")) return [];
            "options" === d && (l = ["lang"])
          }
          return b = b.concat(l)
        }(d)
      ...
      var d = CKEDITOR.plugins.scayt, b = a.dataProcessor, c = b && b.htmlFilter,
        g = a._.elementsPath && a._.elementsPath.filters, b = b && b.dataFilter, l = a.addRemoveFormatFilter,
        k = function (b) {
          if (a.scayt && (b.hasAttribute(d.options.data_attribute_name) || b.hasAttribute(d.options.problem_grammar_data_attribute))) return !1
        }, e = function (b) {
          var c = !0;
          a.scayt && (b.hasAttribute(d.options.data_attribute_name) || b.hasAttribute(d.options.problem_grammar_data_attribute)) && (c = !1);
          return c
        };
      g && g.push(k);
      b && b.addRules({
      ...
      return {
        scayt: {
          ...
          scayt_ignoreall: {
            label: a.getLocal("btn_ignoreAll"), group: "scayt_control", order: 2, exec: function (a) {
          ...
          grayt_problemdescription: {
            ...
            label: a.getLocal("btn_ignore"), group: "grayt_control", order: 2, exec: function (a) {
      ...
      var c = {}, g = {}, l = b ? "word" : "phrase", k = b ? "startGrammarCheck" : "startSpellCheck", e = a.scayt;
      if (0 < d.length && "no_any_suggestions" !== d[0]) if (b) for (b = 0; b < d.length; b++) {
        ...
        b < a.config.scayt_maxSuggestions ? (a.addMenuItem(h, {
          ...
          order: b + 1
        }), g[h] = CKEDITOR.TRISTATE_OFF, "on" === a.config.scayt_moreSuggestions && (a.addMenuItem("scayt_moresuggest", {
      ...
      } else for (b = 0; b < d.length; b++) h = "grayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[b].replace(" ", "_"), a.addCommand(h,
        this.createCommand(CKEDITOR.plugins.scayt.suggestions[b], l, k)), a.addMenuItem(h, {
        label: d[b],
        command: h,
        group: "grayt_suggest",
        order: b + 1
      ...
      var b = a.scayt, c = this.scaytMenuDefinition(a), g =
          {}, l = a.config.scayt_contextCommands.split("|"), k = d.getAttribute(b.getLangAttribute()) || b.getLang(), e,
        h, m;
      e = b.isScaytNode(d);
      h = b.isGraytNode(d);
      e ? (c = c.scayt, g = d.getAttribute(b.getScaytNodeAttributeName()), b.fire("getSuggestionsList", {
        lang: k,
        word: g
      }), g = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, e)) : h && (c = c.grayt, g = d.getAttribute(b.getGraytNodeAttributeName()), m = b.getProblemDescriptionText(g, k), c.grayt_problemdescription && m && (c.grayt_problemdescription.label = m), b.fire("getGrammarSuggestionsList",
      ...
      delete g[f], a.addCommand(f, {exec: c[f].exec}), a.addMenuItem(f, {
    ...
    charsToObserve: [{
      charName: "cke-fillingChar", charCode: function () {
        var a = CKEDITOR.version.match(/^\d(\.\d*)*/), a = a && a[0], d;
        if (a) {
          d =
            "4.5.7";
          var b, a = a.replace(/\./g, "");
    ...
    replaceOldOptionsNames: function (a) {
      for (var d in a) d in this.backCompatibilityMap && (a[this.backCompatibilityMap[d]] = a[d], delete a[d])
    },
      ...
      this.loadScaytLibrary(a, function (a) {
        ...
        if (l) {
          ...
          try {
            ...
            d.alarmCompatibilityMessage(), delete l.charsToObserve, k = g(l)
          }
          ...
          k.addMarkupHandler && k.addMarkupHandler(function (b) {
            var e = a.editable(), d = e.getCustomData(b.charName);
    ...
    "scaytDialog" !== d && "checkspell" !== d && (a.on("show", function (a) {
    ...
    if ("scaytDialog" === d) a.on("cancel", function (a) {
      return !1
    }, this, null, -1);
    if ("checkspell" === d) a.on("cancel", function (a) {
      a = a.sender && a.sender.getParentEditor();
      var c = CKEDITOR.plugins.scayt, d = a.scayt;
    ...
    if ("replace" === d) a.on("hide", function (a) {
      a = a.sender && a.sender.getParentEditor();
      var c = CKEDITOR.plugins.scayt, d = a.scayt;
      ...
      a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function (a) {
        return function () {
          ...
          if (CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state.scayt[this.name] &&
            this.scayt) {
            if (c = "ready" == this.status) var l = d.removeMarkupFromString(this.getSnapshot()),
              d = d.removeMarkupFromString(this._.previousValue), c = c && d !== l
          } else c = a.call(this);
          return c
        }
      });
    ...
    if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
      ...
      a[d] = CKEDITOR.tools.override(a[d], function (a) {
        return function (c) {
          var d = c.editor.scayt, l = this.contents, k = c.contents, e = null;
    ...
    CKEDITOR.plugins.add("showblocks", {
      onLoad: function () {
        var a = "p div pre address blockquote h1 h2 h3 h4 h5 h6".split(" "), b, c, g, l, k = CKEDITOR.getUrl(this.path),
          e = !(CKEDITOR.env.ie && 9 > CKEDITOR.env.version),
          h = e ? ":not([contenteditable\x3dfalse]):not(.cke_show_blocks_off)" : "", m, f;
        ...
        if (!d.blockless) {
          var c = d.addCommand("showblocks", a);
          c.canUndo = !1;
          ...
          d.on("mode", function () {
            c.state != CKEDITOR.TRISTATE_DISABLED && c.refresh(d)
          });
      ...
      modes: {wysiwyg: 1}, onLoad: function () {
        ...
        a && a.addRules({
          elements: {
            table: function (a) {
              a = a.attributes;
              var b = a["class"], d = parseInt(a.border, 10);
    ...
    function () {
      CKEDITOR.plugins.add("stylescombo", {
        requires: "richcombo", init: function (a) {
          var d = a.config, b = a.lang.stylescombo, c = {}, g = [], l = [];
          ...
          a.ui.addRichCombo("Styles", {
            ...
            onClick: function (b) {
              ...
              b = c[b];
              var e = a.elementPath();
              if (b.group && b.removeStylesFromSameGroup(a)) a.applyStyle(b); else a[b.checkActive(e, a) ? "removeStyle" : "applyStyle"](b);
              a.fire("saveSnapshot")
            },
            onRender: function () {
              a.on("selectionChange", function (b) {
                ...
                for (var d = 0, g = b.length, f; d < g; d++) {
                  f = b[d];
                  for (var l in c) if (c[l].checkElementRemovable(f, !0, a)) {
                    l !=
                    e && this.setValue(l);
                    return
                  }
            ...
            onOpen: function () {
              var d = a.getSelection(), d = d.getSelectedElement() || d.getStartElement() || a.editable(),
                d = a.elementPath(d), e = [0, 0, 0, 0];
              this.showAll();
              this.unmarkAll();
              for (var g in c) {
                var l = c[g], f = l._.type;
                l.checkApplicable(d, a, a.activeFilter) ? e[f]++ : this.hideItem(g);
                l.checkActive(d, a) && this.mark(g)
              }
            ...
            refresh: function () {
              var b = a.elementPath();
              if (b) {
                for (var e in c) if (c[e].checkApplicable(b, a, a.activeFilter)) return;
                this.setState(CKEDITOR.TRISTATE_DISABLED)
              }
            },
            reset: function () {
          ...
          if (b.editable().hasFocus) {
            ...
            if (e = (new CKEDITOR.dom.elementPath(c.getCommonAncestor(), c.root)).contains({
              ...
              var c = b.createRange(), d = CKEDITOR.tools.tryThese(function () {
                ...
                var b = e.getParent(), b = b.getAscendant("table").$.rows[b.$.rowIndex + (a ? -1 : 1)];
                return b.cells[a ? b.cells.length - 1 : 0]
              });
              if (d || a) if (d) d = new CKEDITOR.dom.element(d), c.moveToElementEditStart(d), c.checkStartOfBlock() && c.checkEndOfBlock() || c.selectNodeContents(d); else return !0; else {
    ...
    var d = {editorFocus: !1, modes: {wysiwyg: 1, source: 1}}, b = {
      exec: function (a) {
    ...
    CKEDITOR.plugins.add("tab", {
      init: function (g) {
        for (var l = !1 !== g.config.enableTabKeyTools, k = g.config.tabSpaces || 0,
               e = ""; k--;) e += " ";
        if (e) g.on("key", function (a) {
          9 == a.data.keyCode && (g.insertText(e), a.cancel())
        });
    ...
    var b =
      void 0 === d ? this.getTabIndex() : d, c, g, l, k, e, h;
    if (0 >= b) for (e = this.getNextSourceNode(a, CKEDITOR.NODE_ELEMENT); e;) {
      if (e.isVisible() && 0 === e.getTabIndex()) {
        l = e;
        break
      }
      e = e.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT)
    } else for (e = this.getDocument().getBody().getFirst(); e = e.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT);) {
      if (!c) if (!g && e.equals(this)) {
        if (g = !0, a) {
          if (!(e = e.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT))) break;
          c = 1
        }
      ...
      if (!a.blockless) {
        ...
        a.addCommand("tableDelete", d({
          exec: function (a) {
            ...
            if (b) {
              var d = b.getParent(), k = a.editable();
    ...
    function a(a, b) {
      ...
      function e(a) {
        0 < d.length || a.type != CKEDITOR.NODE_ELEMENT || !v.test(a.getName()) || a.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(f, a, "selected_cell",
          !0), d.push(a))
      }
      ...
      for (var g = a.getRanges(), h = 0; h < g.length; h++) {
        var k = g[h];
        if (k.collapsed) (k = k.getCommonAncestor().getAscendant({td: 1, th: 1}, !0)) && c(k) && d.push(k); else {
          var k = new CKEDITOR.dom.walker(k), l;
          for (k.guard = e; l = k.next();) l.type == CKEDITOR.NODE_ELEMENT && l.is(CKEDITOR.dtd.table) || (l = l.getAscendant({
            td: 1,
            th: 1
          }, !0)) && !l.getCustomData("selected_cell") && c(l) && (CKEDITOR.dom.element.setMarker(f, l, "selected_cell", !0), d.push(l))
        }
      }
    ...
    function b(c) {
      if (c instanceof CKEDITOR.dom.selection) {
        var e = c.getRanges(), d = a(c), f = d[0].getAscendant("table"), g = CKEDITOR.tools.buildTableMap(f),
          h = d[0].getParent().$.rowIndex, d = d[d.length - 1], k = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [];
        c.reset();
        for (c = h; c <= k; c++) {
          for (var l = g[c], m = new CKEDITOR.dom.element(f.$.rows[c]), n = 0; n < l.length; n++) {
            var p = new CKEDITOR.dom.element(l[n]), q = p.getParent().$.rowIndex;
    ...
    function c(a) {
      for (var b =
        a.getParent().$.cells, c = 0, e = 0; e < b.length; e++) {
        var d = b[e], c = c + d.colSpan;
        if (d == a.$) break
      }
      return c - 1
    }
    ...
    function l(b, c) {
      for (var e = w(b) ? b : a(b), d = e[0].getAscendant("table"), f = g(e, 1), e = g(e), h = c ? f : e, k = CKEDITOR.tools.buildTableMap(d), d = [], f = [], e = [], l = k.length, m = 0; m < l; m++) d.push(k[m][h]), f.push(c ? k[m][h - 1] : k[m][h + 1]);
    ...
    function k(b) {
      function c(a) {
        ...
        for ((d = e.getPrevious()) || (d = e.getParent().getPrevious().getLast()); d.type !== CKEDITOR.NODE_TEXT && "br" !== d.getName().toLowerCase();) if (d = d.getLast(), !d) return a;
        b.setEndAt(d, CKEDITOR.POSITION_BEFORE_END);
        return b.select()
      }

      CKEDITOR.env.webkit && !b.isFake && (b = c(b));
      var e = b.getRanges(), d = a(b), f = d[0], g = d[d.length - 1], d = f.getAscendant("table"),
        h = CKEDITOR.tools.buildTableMap(d), k, l, m = [];
      b.reset();
      var n = 0;
      for (b = h.length; n < b; n++) for (var p = 0, q = h[n].length; p < q; p++) void 0 === k && h[n][p] == f.$ && (k = p), h[n][p] == g.$ && (l = p);
      for (n = k; n <= l; n++) for (p = 0; p < h.length; p++) g = h[p], f = new CKEDITOR.dom.element(d.$.rows[p]), g = new CKEDITOR.dom.element(g[n]), g.$ && (1 == g.$.colSpan ? g.remove() : --g.$.colSpan,
    ...
    function h(b) {
      if (b instanceof CKEDITOR.dom.selection) {
        var c =
          b.getRanges(), e = a(b), d = e[0] && e[0].getAscendant("table"), f;
        a:{
          var g = 0;
          f = e.length - 1;
          for (var k = {}, l, n; l = e[g++];) CKEDITOR.dom.element.setMarker(k, l, "delete_cell", !0);
          for (g = 0; l = e[g++];) if ((n = l.getPrevious()) && !n.getCustomData("delete_cell") || (n = l.getNext()) && !n.getCustomData("delete_cell")) {
            CKEDITOR.dom.element.clearAllMarkers(k);
            f = n;
            break a
          }
          CKEDITOR.dom.element.clearAllMarkers(k);
          g = e[0].getParent();
          (g = g.getPrevious()) ? f = g.getLast() : (g = e[f].getParent(), f = (g = g.getNext()) ? g.getChild(0) : null)
        }
        b.reset();
        for (b =
    ...
    function m(a, b) {
      var c = a.getDocument(), e = CKEDITOR.document;
    ...
    function n(b, c, e) {
      ...
      var k = CKEDITOR.tools.buildTableMap(g), l = k.length, m = k[0].length, n = b.getParent().$.rowIndex,
        p = f(k, n, b);
      if (c) {
        var q;
        try {
          ...
          q = k["up" == c ? n - v : "down" == c ? n + v : n]["left" == c ? p - h : "right" == c ? p + h : p]
        } catch (w) {
          return !1
        }
        if (!q || b.$ == q) return !1;
      ...
      c = b.getDocument();
      var J = n, v = q = 0, K = !e && new CKEDITOR.dom.documentFragment(c), E = 0;
      for (c = 0; c < d.length; c++) {
        h = d[c];
        var R = h.getParent(), O = h.getFirst(), S = h.$.colSpan, L = h.$.rowSpan, R = R.$.rowIndex, V = f(k, R, h),
          E = E + S * L, v = Math.max(v, V - p + S);
        q = Math.max(q, R - n + L);
        e || (S = h, (L = S.getBogus()) && L.remove(),
          S.trim(), h.getChildren().count() && (R == J || !O || O.isBlockBoundary && O.isBlockBoundary({br: 1}) || (J = K.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !J || J.is && J.is("br") || K.append("br")), h.moveChildren(K)), c ? h.remove() : h.setHtml(""));
        J = R
      }
      if (e) return q * v == E;
      K.moveChildren(b);
      b.appendBogus();
      v >= m ? b.removeAttribute("rowSpan") : b.$.rowSpan = q;
      q >= l ? b.removeAttribute("colSpan") : b.$.colSpan = v;
    ...
    function p(b, c) {
      ...
      if (c) return !0;
      var e = e[0], d = e.getParent(), g = d.getAscendant("table"), h = CKEDITOR.tools.buildTableMap(g),
        k = d.$.rowIndex, l = f(h, k, e), m = e.$.rowSpan, n;
      if (1 < m) {
        n = Math.ceil(m / 2);
        for (var m = Math.floor(m / 2), d = k + n, g = new CKEDITOR.dom.element(g.$.rows[d]), h = f(h, d), p, d = e.clone(), k = 0; k < h.length; k++) if (p = h[k], p.parentNode == g.$ && k > l) {
          d.insertBefore(new CKEDITOR.dom.element(p));
          break
        } else p = null;
        p || g.append(d)
      } else for (m = n = 1, g = d.clone(), g.insertAfter(d), g.append(d = e.clone()),
    ...
    function q(b, c) {
      ...
      if (1 < e.length) return !1;
      if (c) return !0;
      var e = e[0], d = e.getParent(), g = d.getAscendant("table"), g = CKEDITOR.tools.buildTableMap(g),
        h = f(g, d.$.rowIndex, e), k = e.$.colSpan;
      if (1 < k) d = Math.ceil(k / 2), k = Math.floor(k / 2); else {
        for (var k = d = 1, l = [], m = 0; m < g.length; m++) {
          var n = g[m];
          l.push(n[h]);
    ...
    var v = /^(?:td|th)$/, w = CKEDITOR.tools.isArray;
    CKEDITOR.plugins.tabletools = {
      requires: "table,dialog,contextmenu", init: function (c) {
        ...
        var v = c.lang.table, w = CKEDITOR.tools.style.parse;
        g("cellProperties", new CKEDITOR.dialogCommand("cellProperties", f({
          allowedContent: "td th{width,height,border-color,background-color,white-space,vertical-align,text-align}[colspan,rowspan]",
          requiredContent: "table",
          contentTransformations: [[{
            element: "td", left: function (a) {
              return a.styles.background && w.background(a.styles.background).color
            }, right: function (a) {
              a.styles["background-color"] = w.background(a.styles.background).color
            }
          },
            {
        ...
        g("cellMergeRight", f({
          allowedContent: "td[colspan]", requiredContent: "td[colspan]", exec: function (a, b) {
            b.cell = n(a.getSelection(), "right");
            m(b.cell, !0)
          }
        }));
        g("cellMergeDown", f({
          allowedContent: "td[rowspan]", requiredContent: "td[rowspan]", exec: function (a, b) {
        ...
        c.addMenuItems && c.addMenuItems({
          tablecell: {
            label: v.cell.menu, group: "tablecell", order: 1, getItems: function () {
              ...
              return {
                ...
                tablecell_properties: 0 < e.length ? CKEDITOR.TRISTATE_OFF :
                  CKEDITOR.TRISTATE_DISABLED
              }
            }
          },
          ...
          tablecell_insertAfter: {label: v.cell.insertAfter, group: "tablecell", command: "cellInsertAfter", order: 10},
          tablecell_delete: {label: v.cell.deleteCell, group: "tablecell", command: "cellDelete", order: 15},
          tablecell_merge: {label: v.cell.merge, group: "tablecell", command: "cellMerge", order: 16},
          tablecell_merge_right: {
            label: v.cell.mergeRight, group: "tablecell", command: "cellMergeRight",
            order: 17
          },
          tablecell_merge_down: {label: v.cell.mergeDown, group: "tablecell", command: "cellMergeDown", order: 18},
          ...
          tablerow_insertBefore: {label: v.row.insertBefore, group: "tablerow", command: "rowInsertBefore", order: 5},
          tablerow_insertAfter: {label: v.row.insertAfter, group: "tablerow", command: "rowInsertAfter", order: 10},
          tablerow_delete: {label: v.row.deleteRow, group: "tablerow", command: "rowDelete", order: 15},
          tablecolumn: {
          ...
          tablecolumn_delete: {label: v.column.deleteColumn, group: "tablecolumn", command: "columnDelete", order: 15}
        });
    ...
    for (d = d || 0; d <= c; d++) {
      ...
      for (var e = -1, h = b; h <= (-1 === g ? a[d].cells.length - 1 : g); h++) {
        ...
        if (!m) break;
        for (e++; k[l][e];) e++;
        for (var f = isNaN(m.colSpan) ? 1 : m.colSpan, m = isNaN(m.rowSpan) ? 1 : m.rowSpan, n = 0; n < m && !(d + n > c); n++) {
          k[l + n] || (k[l + n] = []);
          for (var p = 0; p < f; p++) k[l + n][e + p] = a[d].cells[h]
        }
        e += f - 1;
        if (-1 !== g && e >= g) break
      }
    ...
    function d(a, b) {
      var c = a.getAscendant("table"), e = b.getAscendant("table"), d = CKEDITOR.tools.buildTableMap(c), f = m(a),
        g = m(b), h = [], k = {}, l, n;
      ...
      for (c = 0; c < d[f].length; c++) if (a.$ === d[f][c]) {
        l = c;
        break
      }
      for (c = 0; c < d[g].length; c++) if (b.$ === d[g][c]) {
        n = c;
        break
      }
      l > n && (c = l, l = n, n = c);
      for (c = f; c <= g; c++) for (f = l; f <= n; f++) e = new CKEDITOR.dom.element(d[c][f]), e.$ && !e.getCustomData("selected_cell") && (h.push(e), CKEDITOR.dom.element.setMarker(k, e, "selected_cell", !0));
      CKEDITOR.dom.element.clearAllMarkers(k);
      return h
    }
    ...
    function g(a, b) {
      var c = a.editable().find(".cke_table-faked-selection"), e;
      a.fire("lockSnapshot");
    ...
    function l(a, b) {
      var c = [], e, d;
      for (d = 0; d < b.length; d++) e = a.createRange(), e.setStartBefore(b[d]), e.setEndAfter(b[d]), c.push(e);
    ...
    function e(b, c, e) {
      ...
      !h[0].collapsed ? !0 : !1);
      if (h) r.first = c || f[0], r.dirty = c ? !1 : 1 !== f.length; else if (r.active && c && r.first.getAscendant("table").equals(c.getAscendant("table"))) {
        f = d(r.first, c);
        if (!r.dirty && 1 === f.length && !a(e.data.getTarget())) return g(b, "mouseup" === e.name);
        r.dirty = !0;
        r.last = c;
        l(b, f)
      }
    ...
    function h(a) {
      var b = (a = a.editor || a.sender.editor) && a.getSelection(), c = b && b.getRanges() || [], e;
    ...
    function f(b) {
      function d(a, b) {
        return a && b ? a.equals(b) || a.contains(b) || b.contains(a) || a.getCommonAncestor(b).is(w) : !1
      }
      ...
      function l(a, b, c, e) {
        return ("mousedown" !== a.name || CKEDITOR.tools.getMouseButton(a) !== CKEDITOR.MOUSE_BUTTON_LEFT && e) && ("mouseup" !== a.name || h(a.data.getTarget()) || d(c, e)) ? !1 : !0
      }

      if (b.data.getTarget().getName && ("mouseup" === b.name || !a(b.data.getTarget()))) {
        var m = b.editor || b.listenerData.editor, n = m.getSelection(1), p = c(m), q = b.data.getTarget(),
          v = q && q.getAscendant({td: 1, th: 1}, !0), q = q && q.getAscendant("table", !0),
          w = {table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1};
        l(b, n, p, q) && g(m, !0);
        !r.active && "mousedown" ===
        b.name && CKEDITOR.tools.getMouseButton(b) === CKEDITOR.MOUSE_BUTTON_LEFT && q && (r = {active: !0}, CKEDITOR.document.on("mouseup", f, null, {editor: m}));
        (v || q) && e(m, v || q, b);
        "mouseup" === b.name && (CKEDITOR.tools.getMouseButton(b) === CKEDITOR.MOUSE_BUTTON_LEFT && (h(b.data.getTarget()) || d(p, q)) && k(m), r = {active: !1}, CKEDITOR.document.removeListener("mouseup", f))
      }
    }
    ...
    function p(a,
      ...
      var e = a.getSelection(), d = e.createBookmarks(), f = a.document, g = a.createRange(),
        h = f.getDocumentElement().$, k = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
        l = a.blockless || CKEDITOR.env.ie ? "span" : "div", m, n, p, q;
      f.getById("cke_table_copybin") || (m = f.createElement(l), n = f.createElement(l), n.setAttributes({
        ...
        height: "1px",
        overflow: "hidden"
      }), m.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right",
        "-5000px"), m.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), n.append(m), a.editable().append(n), q = a.on("selectionChange", c, null, null, 0), k && (p = h.scrollTop), g.selectNodeContents(m), g.select(), k && (h.scrollTop = p), setTimeout(function () {
        n.remove();
        e.selectBookmarks(d);
        q.removeListener();
        a.fire("unlockSnapshot");
    ...
    v.prototype.getTableMap = function () {
      var a = A(this.cells.first), b;
      a:{
        b = this.cells.last;
        var c = b.getAscendant("table"), e = m(b), c = CKEDITOR.tools.buildTableMap(c), d;
        for (d = 0; d < c[e].length; d++) if ((new CKEDITOR.dom.element(c[e][d])).equals(b)) {
          b = d;
          break a
        }
        b = void 0
    ...
    v.prototype.insertRow = function (a, b, c) {
      ...
      for (var e = this.cells.first.$.cellIndex, d = this.cells.last.$.cellIndex, f = c ? [] : this.cells.all, g, h = 0; h < a; h++) g = x(c ? this.cells.all : f, b), g = CKEDITOR.tools.array.filter(g.find("td, th").toArray(), function (a) {
    ...
    v.prototype.insertColumn = function (a) {
      ...
      if ("undefined" === typeof a) a = 1; else if (0 >= a) return;
      for (var c = this.cells, e = c.all, d = m(c.first), f = m(c.last), c = 0; c < a; c++) e = e.concat(CKEDITOR.tools.array.filter(z(e), b));
    ...
    var C = {
      onPaste: function (a) {
        ...
        var f = a.editor, g = f.getSelection(), h = t(g), k = this.findTableInPastedContent(f, a.data.dataValue),
          m = g.isInTable(!0) && this.isBoundarySelection(g), n, p;
        !h.length || 1 === h.length && !b(g.getRanges()[0]) && !m || m && !k || (h = h[0].getAscendant("table"), n = new v(t(g, h)), f.once("afterPaste", function () {
          var a;
          if (p) {
          ...
          f.fire("afterPaste")
        }, 0)) : (e(n.cells.first), f.once("afterPaste", function () {
          f.fire("lockSnapshot");
      ...
      isBoundarySelection: function (a) {
        ...
        var c = a.dataProcessor, e = new CKEDITOR.dom.element("body");
        ...
        var e, d = A(a.cells.first),
          f = a._getTable(), g = {}, h, k, l, m;
        for (l = 0; l < c.length; l++) for (h = new CKEDITOR.dom.element(f.$.rows[a.rows.first.$.rowIndex + l]), m = 0; m < c[l].length; m++) if (k = new CKEDITOR.dom.element(c[l][m]), e = b[l] && b[l][m] ? new CKEDITOR.dom.element(b[l][m]) : null, k && !k.getCustomData("processed")) {
      ...
      getCellsBetween: d, keyboardIntegration: function (a) {
        ...
        c.attachListener(c, "keydown", function (a) {
          function c(b,
            ...
            var f = a.createRange(), g = CKEDITOR.dom.range.mergeRanges(e);
            CKEDITOR.tools.array.forEach(g, function (a) {
              a.enlarge(CKEDITOR.ENLARGE_ELEMENT)
            });
            var h = g[0].getBoundaryNodes(), k = h.startNode, h = h.endNode;
            if (k && k.is && k.is(d)) {
              ...
              !m && h && h.is && !h.is("table") && h.getNext() &&
              (m = h.getNext().findOne("td, th"), n = !0);
          ...
          delete d.th;
          return function (d) {
            var f = d.data.getKey(), g, h = 37 === f || 38 == f, k, l, m;
            if (e[f] && (g = a.getSelection()) && g.isInTable() && g.isFake) if (k = g.getRanges(), l = k[0]._getTableElement(),
              m = k[k.length - 1]._getTableElement(), d.data.preventDefault(), d.cancel(), 8 < f && 46 > f) k[0].moveToElementEditablePosition(h ? l : m, !h), g.selectRanges([k[0]]); else {
              for (d = 0; d < k.length; d++) b(k[d]);
        ...
        c.attachListener(c, "keypress", function (c) {
          var e = a.getSelection(), d = c.data.$.charCode || 13 === c.data.getKey(), f;
    ...
    CKEDITOR.plugins.add("tableselection", {
      requires: "clipboard,tabletools", onLoad: function () {
        u = CKEDITOR.plugins.tabletools;
        t = u.getSelectedCells;
        A = u.getCellColIndex;
        x = u.insertRow;
        z = u.insertColumn;
        ...
        (a.addContentsCss && a.addContentsCss(this.path + "styles/tableselection.css"), a.on("contentDom", function () {
          var b = a.editable(), c = b.isInline() ? b : a.document, e = {editor: a};
        ...
        }), a.on("paste", C.onPaste, C), w(a, "rowInsertBefore rowInsertAfter columnInsertBefore columnInsertAfter cellInsertBefore cellInsertAfter".split(" "), function (a, b) {
          l(a, b.selectedCells)
        }), w(a, ["cellMerge", "cellMergeRight", "cellMergeDown"], function (a, b) {
          l(a, [b.commandData.cell])
        }), w(a, ["cellDelete"], function (a) {
          g(a, !0)
        }))
      }
    })
    ...
    CKEDITOR.loadTemplates = function (a, c) {
      for (var g = [], l = 0, k = a.length; l < k; l++) d[a[l]] || (g.push(a[l]), d[a[l]] = 1);
    ...
    var a = [CKEDITOR.CTRL + 90, CKEDITOR.CTRL + 89, CKEDITOR.CTRL + CKEDITOR.SHIFT + 90], d = {8: 1, 46: 1};
    CKEDITOR.plugins.add("undo", {
      init: function (c) {
        ...
        var f = c.undoManager = new b(c), k = f.editingHandler = new l(f), p = c.addCommand("undo", {
          exec: function () {
    ...
    b.prototype = {
      type: function (a, c) {
        var d = b.getKeyGroup(a), f = this.strokesRecorded[d] + 1;
      ...
      redo: function () {
        ...
        if (this.locked) this.locked.level++; else if (a) this.locked = {level: 1}; else {
          ...
          if (b) d = !0; else {
            ...
            this.currentImage && this.currentImage.equalsContent(f) && (d = f)
          }
      ...
      equalsContent: function (a) {
        ...
        if (b || a) {
          ...
          for (var c = 0; c < b.length; c++) {
            var d = b[c], g = a[c];
            if (d.startOffset != g.startOffset || d.endOffset != g.endOffset || !CKEDITOR.tools.arrayCompare(d.start, g.start) || !CKEDITOR.tools.arrayCompare(d.end, g.end)) return !1
          }
        }
        return !0
      }
    ...
    l.prototype = {
      onKeydown: function (d) {
        var g = d.data.getKey();
        if (229 !== g) if (-1 < CKEDITOR.tools.indexOf(a,
          d.data.getKeystroke())) d.data.preventDefault(); else if (this.keyEventsStack.cleanUp(d), d = this.undoManager, this.keyEventsStack.getLast(g) || this.keyEventsStack.push(g), this.lastKeydownImage = new c(d.editor), b.isNavigationKey(g) || this.undoManager.keyGroupChanged(g)) if (d.strokesRecorded[0] || d.strokesRecorded[1]) d.save(!1, this.lastKeydownImage, !1), d.resetType()
      }, onInput: function () {
        ...
        if (!(b.ieFunctionalKeysBug(a) && this.lastKeydownImage && this.lastKeydownImage.equalsContent(new c(d.editor, !0)))) if (0 < g) d.type(a); else if (b.isNavigationKey(a)) this.onNavigationKey(!0)
      },
    ...
    function b(a, b) {
      ...
      var d = CKEDITOR.tools.bind(this.queryViewport, this),
        e = CKEDITOR.tools.bind(this.hideVisible, this), k = CKEDITOR.tools.bind(this.removeAll, this);
    ...
    function c(a) {
      ...
      return b && !e[a.getComputedStyle("position")]
    }
    ...
    a.prototype = {
      start: function (a) {
        var b = this, c = this.editor, d = this.doc, e, g, k, l, r = CKEDITOR.tools.eventsBuffer(50, function () {
        ...
        var b, d, e;
        do if (e = a.$["data-cke-expando"], !(e && e in this.relations)) {
        ...
        function a(d, e, g, h, k) {
          for (var l = 0, r; k(g);) {
            g += h;
            if (25 == ++l) break;
            if (r = this.doc.$.elementFromPoint(e, g)) if (r == d) l = 0; else if (b(d, r) && (l = 0, c(r = new CKEDITOR.dom.element(r)))) return r
          }
        }
        ...
        return function (b, d, e) {
          var g = this.win.getViewPaneSize().height, k = a.call(this, b.$, d, e, -1, function (a) {
            return 0 < a
          });
          d = a.call(this, b.$, d, e, 1, function (a) {
            return a < g
          });
          if (k) for (this.traverseSearch(k); !k.getParent().equals(b);) k = k.getParent();
          if (d) for (this.traverseSearch(d); !d.getParent().equals(b);) d = d.getParent();
          for (; k || d;) {
            k && (k = k.getNext(c));
        ...
        this.relations =
          {};
        for (var a = this.editable.getElementsByTag("*"), b = 0, d, e, g; d = a.getItem(b++);) if (!d.equals(this.editable) && d.type == CKEDITOR.NODE_ELEMENT && (d.hasAttribute("contenteditable") || !d.isReadOnly()) && c(d) && d.isVisible()) for (g in this.lookups) (e = this.lookups[g](d)) && this.store(d, e);
    ...
    d.prototype = {
      locate: function () {
        ...
        return function (e, g) {
          a = this.locations;
          b = [];
          for (var k in a) for (var l in a[k]) if (c = Math.abs(e - a[k][l]), b.length) {
            for (d = 0; d < b.length; d++) if (c < b[d].dist) {
    ...
    b.prototype = {
      removeAll: function () {
        ...
        if (c = this.getStyle(a.uid, a.type)) {
          ...
          if (!d) for (e in this.hidden) if (this.hidden[e].getCustomData("hash") !== this.hash) {
        ...
        var c = this.relations[a], d = this.locations[a][b], e = {};
        ...
        a = a.getClientRect();
        var b = this.container.getDocumentPosition(), c = this.container.getComputedStyle("position");
    ...
    var k = {left: 1, right: 1, center: 1}, e = {absolute: 1, fixed: 1};
    ...
    CKEDITOR.plugins.widgetselection = {
      ...
      addFillers: function (d) {
        ...
        if (!this.isWholeContentSelected(d) && 0 < d.getChildCount()) {
          var c = d.getFirst(a), g = d.getLast(a);
          c && c.type == CKEDITOR.NODE_ELEMENT && !c.isEditable() && (this.startFiller = this.createFiller(), d.append(this.startFiller, 1));
          g && g.type == CKEDITOR.NODE_ELEMENT && !g.isEditable() && (this.endFiller = this.createFiller(!0), d.append(this.endFiller, 0));
          if (this.hasFiller(d)) return b = b.createRange(), b.selectNodeContents(d), b.select(), !0
        }
        return !1
      },
      ...
      removeFiller: function (a, b) {
        if (a) {
          var c = b.editor, g = b.editor.getSelection().getRanges()[0].startPath(), l = c.createRange(), k, e;
    ...
    function d(a, b, c, e, f) {
      ...
      CKEDITOR.tools.extend(this, e, {
        ...
        element: c,
        data: CKEDITOR.tools.extend({}, "function" == typeof e.defaults ? e.defaults() : e.defaults),
        dataReady: !1,
        inited: !1,
        ready: !1,
        ...
        _: {downcastFn: e.downcast && "string" == typeof e.downcast ? e.downcasts[e.downcast] : e.downcast}
      }, !0);
    ...
    function c(a, b) {
      a.addCommand(b.name, {
        exec: function (a, c) {
          ...
          if (e && e.name == b.name) e.edit(); else if (b.insert) b.insert(); else if (b.template) {
            var e = "function" == typeof b.defaults ? b.defaults() : b.defaults,
              e = CKEDITOR.dom.element.createFromHtml(b.template.output(e)), f, g = a.widgets.wrapElement(e, b.name),
              k = new CKEDITOR.dom.documentFragment(g.getDocument());
            k.append(g);
    ...
    function g(a, b) {
      function c(a, d) {
        var e = b.upcast.split(","), f, g;
        for (g = 0; g < e.length; g++) if (f = e[g], f === a.name) return b.upcasts[f].call(this, a, d);
        return !1
      }
    ...
    function k(a) {
      ...
      if ("wysiwyg" == this.editor.mode) {
        var b = this.editor.editable(), c = this.instances, e, f, g, k;
        if (b) {
          for (e in c) c[e].isReady() && !b.contains(c[e].wrapper) && this.destroy(c[e], !0);
          if (a && a.initOnlyNew) c = this.initOnAll(); else {
            var h = b.find(".cke_widget_wrapper"), c = [];
            e = 0;
            for (f = h.count(); e < f; e++) {
              g = h.getItem(e);
              if (k = !this.getByElement(g, !0)) {
                a:{
                  k = w;
                  for (var l = g; l =
                    l.getParent();) if (k(l)) {
              ...
              k && b.contains(g) && (g.addClass("cke_widget_new"), c.push(this.initOn(g.getFirst(d.isDomWidgetElement))))
            }
          }
    ...
    function n(a) {
      var b = [], c = a._.upcasts, e = a._.upcastCallbacks;
      return {
        toBeWrapped: b, iterator: function (a) {
          ...
          if (l = c.length) {
            ...
            h = 0;
            for (f = e.length; h < f; ++h) if (!1 === e[h](a)) return;
            for (h = 0; h < l; ++h) if (f = c[h], k = {}, g = f[0](a, k)) return g instanceof CKEDITOR.htmlParser.element && (a = g), a.attributes["data-cke-widget-data"] =
              encodeURIComponent(JSON.stringify(k)), a.attributes["data-cke-widget-upcasted"] = 1, b.push([a, f[1]]), !1
          }
        }
      }
    }
    ...
    function A(a) {
      ...
      b.on("drop", function (c) {
        var d = c.data.dataTransfer, e = d.getData("cke/widget-id"), f = d.getTransferType(b), d = b.createRange();
    ...
    function x(a) {
      var b = a.editor;
      b.on("contentDom", function () {
        var c = b.editable(), e = c.isInline() ? c : b.document, f, g;
        c.attachListener(e, "mousedown", function (c) {
          var e = c.data.getTarget();
          f = e instanceof CKEDITOR.dom.element ? a.getByElement(e) : null;
          g = 0;
          f && (f.inline && e.type == CKEDITOR.NODE_ELEMENT &&
          e.hasAttribute("data-cke-widget-drag-handler") ? (g = 1, a.focused != f && b.getSelection().removeAllRanges()) : d.getNestedEditable(f.wrapper, e) ? f = null : (c.data.preventDefault(), CKEDITOR.env.ie || f.focus()))
        });
        c.attachListener(e, "mouseup", function () {
          g && f && f.wrapper && (g = 0, f.focus())
        });
        CKEDITOR.env.ie && c.attachListener(e, "mouseup", function () {
          setTimeout(function () {
    ...
    function y(a) {
      ...
      b.on("selectionChange", function (c) {
        ...
        f ? f === e && f.focusedEditable.equals(c) || (r(a, f, null), e && c && r(a, e, c)) : e && c && r(a, e, c)
      });
    ...
    function B(a) {
      ...
      b.on("toDataFormat", function (b) {
        ...
        b.data.dataValue.forEach(function (b) {
          ...
          if ("data-cke-widget-id" in c) {
            if (c = a.instances[c["data-cke-widget-id"]]) e = b.getFirst(d.isParserWidgetElement), f.push({
              wrapper: b,
              element: e,
              widget: c,
              editables: {}
            }), "1" != e.attributes["data-cke-widget-keep-attr"] && delete e.attributes["data-widget"]
          } else if ("data-cke-widget-editable" in c) return f[f.length -
      ...
      b.on("toDataFormat", function (a) {
        if (a.data.downcastingSessionId) {
          ...
          for (var b, d, e, f, g, k; b = a.shift();) {
            d = b.widget;
            e = b.element;
            f = d._.downcastFn && d._.downcastFn.call(d, e);
            for (k in b.editables) g = b.editables[k], delete g.attributes.contenteditable, g.setHtml(d.editables[k].getData());
            f || (f = e);
    ...
    function G(a) {
      ...
      b.on("toHtml", function (b) {
          var e = n(a), f;
          for (b.data.dataValue.forEach(e.iterator, CKEDITOR.NODE_ELEMENT, !0); f = e.toBeWrapped.pop();) {
            var g = f[0], k = g.parent;
            k.type == CKEDITOR.NODE_ELEMENT && k.attributes["data-cke-widget-wrapper"] && k.replaceWith(g);
        ...
        null, null, 8);
      b.on("dataReady", function () {
        if (e) for (var c = b.editable().find(".cke_widget_wrapper"), f, g, k = 0, h = c.count(); k < h; ++k) f = c.getItem(k), g = f.getFirst(d.isDomWidgetElement), g.type == CKEDITOR.NODE_ELEMENT && g.data("widget") ? (g.replace(f), a.wrapElement(g)) : f.remove();
        e = 0;
        a.destroyAll(!0);
        a.initOnAll()
      });
    ...
    function D(a) {
      ...
      return {
        ...
        commit: function () {
          var f = a.focused !== e, g, k;
          a.editor.fire("lockSnapshot");
          for (f && (g = a.focused) && l(a, g); g = d.pop();) b.splice(CKEDITOR.tools.indexOf(b, g), 1), g.isInited() && (k = g.editor.checkDirty(), g.setSelected(!1), !k && g.editor.resetDirty());
          f && e && (k = a.editor.checkDirty(), a.focused = e, a.fire("widgetFocused", {widget: e}), e.setFocused(!0), !k && a.editor.resetDirty());
    ...
    function H(a, b) {
      ...
      if (!d.getById("cke_copybin")) {
        var f = !c.blockless && !CKEDITOR.env.ie || e ? "div" : "span", e = d.createElement(f), g = d.createElement(f),
        ...
        g.append(e);
        c.editable().append(g);
        var h = c.on("selectionChange", I, null, null, 0), l = a.repository.on("checkSelection", I,
          null, null, 0);
        if (f) var m = d.getDocumentElement().$, n = m.scrollTop;
        k = c.createRange();
    ...
    function S(a) {
      if (a.draggable) {
        var b = a.editor, c = a.wrapper.getLast(d.isDomDragHandlerContainer), e;
        c ? e = c.findOne("img") : (c = new CKEDITOR.dom.element("span", b.document), c.setAttributes({
          "class": "cke_reset cke_widget_drag_handler_container",
          style: "background:rgba(220,220,220,0.5);background-image:url(" + b.plugins.widget.path + "images/handle.png)"
        }), e = new CKEDITOR.dom.element("img", b.document), e.setAttributes({
    ...
    function L(a) {
      function b() {
        var c;
        for (p.reset(); c = k.pop();) c.removeListener();
        var d = h;
        c = a.sender;
        var e = this.repository.finder, f = this.repository.liner, g = this.editor, l = this.editor.editable();
      ...
      if (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT) {
        var c =
            this.repository.finder, d = this.repository.locator, e = this.repository.liner, f = this.editor,
          g = f.editable(), k = [], h = [], l, m;
        this.repository._.draggedWidget = this;
        var n = c.greedySearch(), p = CKEDITOR.tools.eventsBuffer(50, function () {
          l = d.locate(n);
          h = d.sort(m, 1);
          h.length && (e.prepare(n, l), e.placeLine(h[0]), e.cleanup())
        });
        g.addClass("cke_widget_dragging");
        k.push(g.on("mousemove", function (a) {
          m = a.data.$.clientY;
          p.input()
        }));
        f.fire("dragstart", {target: a.sender});
        k.push(f.document.once("mouseup", b, this));
        g.isInline() ||
    ...
    function M() {
      ...
      CKEDITOR.style.addCustomHandler({
        ...
        setup: function (a) {
          ...
          d = a.elementPath();
          if (this.checkApplicable(d, a)) for (var f = 0, g = this.group.length; f < g; f++) {
            b = c[this.widget][this.group[f]];
            for (var k = 0; k < b.length; k++) b[k] !== this && b[k].checkActive(d, a) && (a.widgets.focused.removeStyle(b[k]), e = !0)
          }
          return e
        }, checkActive: function (a, b) {
          ...
          return d.isDomWidgetWrapper(a) ? (a = a.getFirst(d.isDomWidgetElement)) && a.data("widget") == this.widget : !1
        }, buildPreview: function (a) {
    ...
    a.prototype = {
      MIN_SELECTION_CHECK_INTERVAL: 500, add: function (a, b) {
        ...
        var a = this.editor.getSelection(), b = a.getSelectedElement(), c = D(this), e;
        ...
        return e ? e.hasClass("cke_widget_new") ? (a = new d(this, this._.nextId++, a, b, c), a.isInited() ? this.instances[a.id] = a : null) : this.getByElement(a) : null
        ...
        if (a instanceof CKEDITOR.dom.element) {
          ...
          a.data("widget", b);
          (f = v(d, a.getName())) && e(a);
          c = new CKEDITOR.dom.element(f ? "span" : "div");
          c.setAttributes(p(f, b));
          ...
          (f = v(d, a.name)) && e(a);
          c = new CKEDITOR.htmlParser.element(f ? "span" : "div", p(f, b));
    ...
    d.prototype = {
      addClass: function (a) {
        ...
        }), d.filter && d.data("cke-filter", d.filter.id), d.addClass("cke_widget_editable"), d.removeClass("cke_widget_editable_focused"), c.pathName && d.data("cke-display-name", c.pathName), this.editor.focusManager.add(d), d.on("focus", E, this), CKEDITOR.env.ie && d.on("blur", K, this), d._.initialSetData = !0, d.setData(d.getHtml()), !0) : !1
      }, _findOneNotNested: function (a) {
        a = this.wrapper.find(a);
        for (var b, c, e = 0; e < a.count(); e++) if (b =
        ...
        var a =
          this.editor, b = this.element.$, c = this._.dragHandlerOffset, b = {x: b.offsetLeft, y: b.offsetTop - 15};
    ...
    d.getNestedEditable = function (a, b) {
      return !b || b.equals(a) ? null : d.isDomNestedEditable(b) ? b : d.getNestedEditable(a, b.getParent())
    };
    ...
    a.prototype = {
      createTask: function (a) {
        ...
        var a = this.getTaskCount(),
          c = {current: this.getDoneTaskCount(), max: a, percentage: Math.round(100 * this.getPercentage())};
        ...
        -1 !== c && (a._doneWeight && (this._doneWeights -= a._doneWeight), this._totalWeights -= a._weight, this._tasks.splice(c, 1), this.update())
    ...
    CKEDITOR.tools.extend(CKEDITOR.fileTools, {
      addUploadWidget: function (a, d, b) {
        var c = CKEDITOR.fileTools, g = a.uploadRepository, l = b.supportedTypes ? 10 : 20;
        if (b.fileToElement) a.on("paste", function (b) {
          b = b.data;
          var e = a.widgets.registered[d], h = b.dataTransfer, l = h.getFilesCount(),
            f = e.loadMethod || "loadAndUpload", n, p;
          if (!b.dataValue && l) for (p = 0; p < l; p++) if (n = h.getFile(p), !e.supportedTypes || c.isTypeSupported(n, e.supportedTypes)) {
            var q = e.fileToElement(n);
        ...
        CKEDITOR.tools.extend(b, {
          ...
          init: function () {
            var b = this, c = this.wrapper.findOne("[data-cke-upload-id]").data("cke-upload-id"), d = g.loaders[c],
              l = CKEDITOR.tools.capitalize, f, n;
            d.on("update", function (g) {
              if (b.wrapper && b.wrapper.getParent()) {
                a.fire("lockSnapshot");
                g = "on" + l(d.status);
                if ("function" !== typeof b[g] || !1 !== b[g](d)) n = "cke_upload_" + d.status, b.wrapper && n != f && (f && b.wrapper.removeClass(f), b.wrapper.addClass(n), f = n), "error" != d.status && "abort" != d.status || a.widgets.del(b);
                a.fire("unlockSnapshot")
            ...
            if ("" === b.trim()) a.widgets.del(this); else {
              var d = this == a.widgets.focused, g = a.editable(), f = a.createRange(), l, p;
        ...
        d.on("update", function () {
          !g && d.uploadTotal && (b(), g = c.createTask({weight: d.uploadTotal}));
    ...
    CKEDITOR.plugins.add("uploadimage", {
      requires: "uploadwidget", onLoad: function () {
        ...
        if (CKEDITOR.plugins.clipboard.isFileApiSupported) {
          var b =
            CKEDITOR.fileTools, l = b.getUploadUrl(a.config, "image");
          l && (b.addUploadWidget(a, "uploadimage", {
            ...
            if (k.data.dataValue.match(/<img[\s\S]+data:/i)) {
              k = k.data;
              var e = document.implementation.createHTMLDocument(""), e = new CKEDITOR.dom.element(e.body), h, m, f;
              e.data("cke-editable", 1);
              e.appendHtml(k.dataValue);
              h = e.find("img");
              for (f = 0; f < h.count(); f++) {
                m = h.getItem(f);
                var n = m.getAttribute("src"), p = n && "data:" == n.substring(0, 5),
    ...
    parseConfig: function (a) {
      ...
      a.addCommand("checkspell", new CKEDITOR.dialogCommand("checkspell")).modes =
        {wysiwyg: !CKEDITOR.env.opera && !CKEDITOR.env.air && document.domain == window.location.hostname && !(d.ie && (8 > d.version || d.quirks))};
    ...
    function a(a) {
      function b(a) {
        ...
        f.attachListener(f, "keydown", function () {
          var b = e.getBody().getElementsByTag(a);
          if (!c) {
      ...
      var c = this.editor, e = a.document, h = e.body, m = e.getElementById("cke_actscrpt");
      ...
      if (CKEDITOR.env.webkit || CKEDITOR.env.ie && 10 < CKEDITOR.env.version) e.getDocumentElement().on("mousedown", function (a) {
      ...
      CKEDITOR.env.iOS &&
      this.attachListener(e, "touchend", function () {
        a.focus()
      });
    ...
    CKEDITOR.plugins.add("wysiwygarea", {
      init: function (a) {
        ...
        a.addMode("wysiwyg", function (b) {
          ...
          if (m) h.on("load", d);
          var f = a.title, n = a.fire("ariaEditorHelpLabel", {}).label;
    ...
    c = CKEDITOR.tools.createClass({
      $: function () {
        ...
        setData: function (a, c) {
          var d = this.editor;
          if (c) this.setHtml(a), this.fixInitialSelection(), d.fire("dataReady"); else {
            this._.isLoadingData = !0;
            d._.dataStore = {id: 1};
            var e = d.config, h = e.fullPage, m = e.docType,
          ...
          a = this.editor;
          var b = a.config, c = b.fullPage, d = c && a.docType, h = c && a.xmlDeclaration,
            m = this.getDocument(), c = c ? m.getDocumentElement().getOuterHtml() : m.getBody().getHtml();
          ...
          var a = this.editor, b = a.document, d;
          try {
            d = a.window.getFrame()
          } catch (e) {
          }
    ...
    var a = function (a, b) {
      ...
      a = a.split(",");
      for (var g = 0; g < a.length; g++) CKEDITOR.skin.icons[a[g]] = {path: c, offset: -a[++g], bgsize: a[++g]}
    };
